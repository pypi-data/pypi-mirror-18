...
ZEND_NAMED_FUNCTION(_wrap_new_VectorString__SWIG_1) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.10/php/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_Match_getValues__SWIG_0) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.10/php/utils.i,62,CONVERT_STRING_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_new_Provider__SWIG_6) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.10/php/utils.i,2,CONVERT_BOOL_IN@*/
