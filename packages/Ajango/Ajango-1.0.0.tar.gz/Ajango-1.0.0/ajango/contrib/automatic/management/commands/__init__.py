...
###########################################################################
"""
Pakiet polecen apliakacji automatyzujacej Django.
...
Przykladowe wywolanie komendy::

    $ python manage.py makeskeleton --help
...
- L{ajangogui <ajango.contrib.automatic.management.commands.ajangogui>}
"""
