...
###########################################################################
"""
Obiekt sprawdzajacy czy pole ma wartosc wieksza od podanej w parametrze.
...
class Validate(ValidateBase):
    """
    Klasa sprawdzajace czy pole ma wartosc wieksza od podanej w parametrze.
    """
    ...
    def is_valid(self, text):
        ...
        if number_value <= self.number:
            self.messages.append("Value %r must be great then %r" %
