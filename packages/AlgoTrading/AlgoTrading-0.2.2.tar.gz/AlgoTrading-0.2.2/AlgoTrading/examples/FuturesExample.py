...
def run_example():
    ...
    # futures to trade
    ihs = ['ih15%02d.ccfx' % i for i in range(5, 13)] + ['ih16%02d.ccfx' % i for i in range(1, 2)]
    ifs = ['if15%02d.ccfx' % i for i in range(5, 13)] + ['if16%02d.ccfx' % i for i in range(1, 2)]
    ics = ['ic15%02d.ccfx' % i for i in range(5, 13)] + ['ic16%02d.ccfx' % i for i in range(1, 2)]
