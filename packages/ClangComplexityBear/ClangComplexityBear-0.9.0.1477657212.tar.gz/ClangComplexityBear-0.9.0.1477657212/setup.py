...
if __name__ == "__main__":
    try:
        setup(name='ClangComplexityBear',
              version='0.9.0.1477657212',
              description="'ClangComplexityBear' bear for coala (http://coala.rtfd.org/)",
    ...
    user.
    """,
              entry_points={"coalabears": ["ClangComplexityBear = coalaClangComplexityBear"]},
              classifiers=[
