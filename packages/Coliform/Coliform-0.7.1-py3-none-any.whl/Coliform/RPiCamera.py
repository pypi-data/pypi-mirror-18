...
def startPreview(iso=100, timeout=10, exposure='default', resolution=(1024,1008), brightness=50, contrast=0, shutterspeed=0, zoom='0.0, 0.0, 1.0, 1.0', awb_mode='default'):
    capture = 'raspistill --raw'
    if iso != 0: # iso 0 = default
        capture += ' --iso ' + str(iso)
    if exposure != 'default':
