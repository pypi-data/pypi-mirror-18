...
setup(name='Colonyzer2',
      ...
      data_files=[('data',["./data_files/BottomRightLid.png","./data_files/BottomRightNoLid.png","./data_files/CornerLid.png","./data_files/CornerNoLid.png","./data_files/GreenLabLid.png","./data_files/GreenLabNoLid.png"])]
      )
