from .api_base import JsonWrapper, StatusCode
from .utils import RollbarReport


class CommonExceptionHandler(object):
    """
    ...
    def process_exception(self, request, exception):
        ...
        if first_path == 'api':
            if isinstance(exception, Exception):
                dic = {"message": "Something went wrong", "error": exception.message}
                RollbarReport()
