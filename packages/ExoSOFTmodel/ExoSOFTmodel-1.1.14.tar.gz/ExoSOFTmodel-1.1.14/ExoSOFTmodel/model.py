...
class ExoSOFTmodel(object):
    ...
    def __init__(self,sd):
        ...
        self.prior = 0
        self.stored_pars = 0
        self.model_in_pars = 0
        self.model_in_pars_last = 0
        self.stored_pars_last = 0
        self.sd = sd
...
class ExoSOFTparams(object):
    ...
    def __init__(self, omega_offset_di, omega_offset_rv, vary_tc, tc_equal_to, 
        ...
        self.direct_pars_last = np.zeros((9+num_offsets),dtype=np.dtype('d')) #$$$$$$$$$$$$
        ...
        self.model_in_pars_last = np.zeros((14),dtype=np.dtype('d'))#$$$$$$$$$$$$$$$$$$$$$$$
...
def ln_posterior(pars, Model):
    ...
    #if np.array_equal(Model.Params.direct_pars,Model.Params.direct_pars_last):
    #    print('direct same in model')
    #else:
    #    print('direct NOT same in model')
    #Model.Params.direct_pars_last = Model.Params.direct_pars
    #Model.model_in_pars = 
    Model.Params.make_model_in()
    #print('direct_pars = ',Model.Params.direct_pars)
    #print('model_in_pars = ',Model.Params.model_in_pars)
    #print('\nmodel_in_pars_last = ',Model.Params.model_in_pars_last)
    ##if np.array_equal(Model.model_in_pars,Model.model_in_pars_last):
    #   print('model_in same in model')
    #else:
    #    print('model_in NOT same in model')
    #Model.model_in_pars_last = Model.model_in_pars
    ...
    if in_range:         
        ...
        Model.stored_pars = Model.Params.make_stored(chi_sqr_3d)
        #print('stored_pars',Model.stored_pars)
        #if np.array_equal(Model.stored_pars,Model.stored_pars_last):
        #    print('stored same in model')
        #else:
        #    print('stored NOT same in model')
        Model.stored_pars_last = Model.stored_pars
