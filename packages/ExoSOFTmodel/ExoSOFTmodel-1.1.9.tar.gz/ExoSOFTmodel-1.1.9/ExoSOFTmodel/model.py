...
def ln_posterior(pars, Model):
    ...
    if np.array_equal(Model.Params.model_in_pars,Model.Params.model_in_pars_last):
        print('model_in same in model')
    else:
        print('model_inNOT same in model')
    Model.Params.model_in_pars_last = Model.Params.model_in_pars
