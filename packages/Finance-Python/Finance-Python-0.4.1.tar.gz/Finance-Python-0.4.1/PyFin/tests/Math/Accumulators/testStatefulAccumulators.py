...
from PyFin.Math.Accumulators import MovingTsMaxPos
from PyFin.Math.Accumulators import MovingTsMinPos
...
class TestStatefulAccumulators(unittest.TestCase):
    ...
    def testMovingTsMaxPos(self):
        window = 10
        maxPos = MovingTsMaxPos(window, dependency='x')
    ...
    def testMovingTsMinPos(self):
        window = 10
        minPos = MovingTsMinPos(window, dependency='x')
