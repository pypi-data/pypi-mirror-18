...
# -*- coding: utf-8 -*-
################################################################################
#    Grammaticomastix Copyright (C) 2012 Suizokukan
...
from grammaticomastix.grammaticomastix import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    url='https://github.com/suizokukan/grammaticomastix',
    ...
    entry_points={
        'console_scripts': ['grammaticomastix=grammaticomastix.grammaticomastix:entrypoint',
                            'grammaticomastix-qt5=grammaticomastix.grammaticomastix:entrypoint_qt5'],
    },
)
