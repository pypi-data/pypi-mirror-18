...
from grammaticomastix.main import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    entry_points={
        'console_scripts': ['grammaticomastix=grammaticomastix.main:entrypoint',
                            'grammaticomastix-qt5=grammaticomastix.main:entrypoint_qt5'],
    },
)
