...
import configparser
import sys
import grammaticomastix.globalvars as gobalvars
...
def entrypoint():
    ...
    gobalvars.CMDLINEPARSER=CommandLineParser()
    gobalvars.CMDLINEPARSER=gobalvars.CMDLINEPARSER.parse_args()

    configfile_ok = cfgfile.read()

    if gobalvars.CMDLINEPARSER.interface=="qt5":
        main_qt5()
    elif gobalvars.CMDLINEPARSER.interface=="linuxcli":
        main_linuxcli()        
    elif configfile_ok and gobalvars.CFGFILEPARSER["interface"]["interface"]=="qt5":
        main_qt5()
    elif configfile_ok and gobalvars.CFGFILEPARSER["interface"]["interface"]=="linuxcli":
        main_linuxcli()
    else:
        main_linuxcli()
