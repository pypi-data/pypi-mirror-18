...
def run_runapp(application, action, opt=None, arg=None):
    ...
    if action == "build":
        notify(title="LI-Tools", msg=u"A operação de Build foi concluída")
