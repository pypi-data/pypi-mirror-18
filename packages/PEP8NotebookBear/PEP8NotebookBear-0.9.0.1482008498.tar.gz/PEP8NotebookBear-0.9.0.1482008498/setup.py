...
if __name__ == '__main__':
    try:
        setup(name='PEP8NotebookBear',
              version='0.9.0.1482008498',
              description="'PEP8NotebookBear' bear for coala (http://coala.rtfd.org/)",
              ...
              entry_points={'coalabears': ['PEP8NotebookBear = coalaPEP8NotebookBear']},
              classifiers=[
