...
if __name__ == '__main__':
    try:
        setup(name='PHPCodeSnifferBear',
              version='0.9.0.1482008498',
              description="'PHPCodeSnifferBear' bear for coala (http://coala.rtfd.org/)",
    ...
    """,
              entry_points={'coalabears': ['PHPCodeSnifferBear = coalaPHPCodeSnifferBear']},
              classifiers=[
