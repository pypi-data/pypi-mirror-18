...
if __name__ == '__main__':
    try:
        setup(name='PinRequirementsBear',
              version='0.9.0.1482008498',
              description="'PinRequirementsBear' bear for coala (http://coala.rtfd.org/)",
              ...
              entry_points={'coalabears': ['PinRequirementsBear = coalaPinRequirementsBear']},
              classifiers=[
