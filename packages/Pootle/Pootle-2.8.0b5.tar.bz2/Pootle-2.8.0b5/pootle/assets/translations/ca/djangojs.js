...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Tradu\u00eft per %(fullname)s al projecte \u00ab<span title=\"%(path)s\">%(project)s</span>\u00bb", 
    "Try again": "Torneu-hi", 
    "Twitter": "Twitter", 
