...
class UserScheduleAdherence(object):
    ...
    def scheduled_activity_category(self, scheduled_activity_category):
        ...
        :type: str
        """
        allowed_values = ["OnQueueWork", "Break", "Meal", "Meeting", "OffQueueWork", "TimeOff", "Training", "Unavailable", "BLANK"]
        if scheduled_activity_category not in allowed_values:
            raise ValueError(
                "Invalid value for `scheduled_activity_category`, must be one of {0}"
    ...
    def system_presence(self, system_presence):
        ...
        :type: str
        """
        allowed_values = ["Available", "Away", "Busy", "Offline", "Idle", "OnQueue", "Meal", "Training", "Meeting", "Break", "BLANK"]
    ...
    def routing_status(self, routing_status):
        ...
        if routing_status not in allowed_values:
            raise ValueError(
                "Invalid value for `routing_status`, must be one of {0}"
                .format(allowed_values)
            )
    ...
    def actual_activity_category(self, actual_activity_category):
        ...
        """
        allowed_values = ["OnQueueWork", "Break", "Meal", "Meeting", "OffQueueWork", "TimeOff", "Training", "Unavailable", "BLANK"]
        if actual_activity_category not in allowed_values:
            raise ValueError(
                "Invalid value for `actual_activity_category`, must be one of {0}"
                .format(allowed_values)
            )
    ...
    def adherence_state(self, adherence_state):
        ...
        if adherence_state not in allowed_values:
            raise ValueError(
                "Invalid value for `adherence_state`, must be one of {0}"
                .format(allowed_values)
            )
