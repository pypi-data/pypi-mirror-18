...
class TestIters(unittest.TestCase):
    ...
    def test_interdict(self):
        self.assertEqual(iters.interdict(self.d, 17, *"wxyz"), dict(w=22, x=23, y=24, z=25))
        self.assertEqual(iters.interdict(self.d, 17, "w", "x", "y", "ABC"),
                         dict(w=22, x=23, y=24, ABC=17))
