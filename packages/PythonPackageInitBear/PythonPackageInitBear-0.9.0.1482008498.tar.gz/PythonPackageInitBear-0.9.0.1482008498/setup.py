...
if __name__ == '__main__':
    try:
        setup(name='PythonPackageInitBear',
              version='0.9.0.1482008498',
              description="'PythonPackageInitBear' bear for coala (http://coala.rtfd.org/)",
    ...
    """,
              entry_points={'coalabears': ['PythonPackageInitBear = coalaPythonPackageInitBear']},
              classifiers=[
