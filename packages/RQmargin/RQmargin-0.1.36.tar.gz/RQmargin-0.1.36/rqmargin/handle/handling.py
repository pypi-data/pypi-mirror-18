...
def handle_sh_margin_details(start=''):
    ...
    margin_details = []
    if sh_margin_details_df is None:
...
def handle_sz_margin_details(start=''):
    ...
    sz_margin_details = []
    if sz_margin_details_df is None:
...
def handle_sh_margins(start=None):
    ...
    sh_margins = []
    if sh_margins_df is None:
        return sh_margins
    if sh_margins_df.empty:
        return sh_margins
...
def handle_sz_margins(start=None):
    ...
    sz_margins = []
    if sz_margins_df is None:
        return sz_margins
    if sz_margins_df.empty:
        return sz_margins
