...
#
# Generated Thu Nov 24 14:30:07 2016 by generateDS.py version 2.23a.
#
# Command line options:
#   ('-a', 'bc:')
#   ('-o', 'datacontract\\classes.py')
#   ('-s', 'datacontract\\subclasses.py')
#   ('--export', '')
#   ('--member-specs', 'dict')
#
...
#
# Command line:
#   C:\Users\uroshe\AppData\Local\Programs\Python\Python35-32\Scripts\generateDS.py -a "bc:" -o "datacontract\classes.py" -s "datacontract\subclasses.py" --export --member-specs="dict" generate\SdkWebServiceDataContract.xsd
#
...
class CardReminder_22Sub(supermod.CardReminder_22):
    def __init__(self, DueDate=None, Card=None):
        super(CardReminder_22Sub, self).__init__(DueDate, Card, )
supermod.CardReminder_22.subclass = CardReminder_22Sub
# end class CardReminder_22Sub
...
class Reminder_22Sub(supermod.Reminder_22):
    def __init__(self, ReminderType=None, Timeframe=None, Date=None, DisableDefaultActions=None):
        super(Reminder_22Sub, self).__init__(ReminderType, Timeframe, Date, DisableDefaultActions, )
...
class Appointment_22Sub(supermod.Appointment_22):
    def __init__(self, CalendarUId=None, AppointmentTime=None, Location=None, LocationImage=None, LocationLat=None, LocationLng=None, Attendees=None, Recurrence=None, Reminder=None, IsCanceled=None):
        super(Appointment_22Sub, self).__init__(CalendarUId, AppointmentTime, Location, LocationImage, LocationLat, LocationLng, Attendees, Recurrence, Reminder, IsCanceled, )
