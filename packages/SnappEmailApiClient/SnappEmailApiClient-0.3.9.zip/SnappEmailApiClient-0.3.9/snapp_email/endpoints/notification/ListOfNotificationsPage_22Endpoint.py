...
class ListOfNotificationsPage_22Endpoint:
    ...
    def get(self, size, offset, sinceId=None, notificationType=None, sortDirection=None, returnFullResource=None, skipOlderThan=None, accept_type=None):
        """
    ...
    def get_2(self, size, offset, dateRangeStart=None, dateRangeEnd=None, returnFullResource=None, accept_type=None):
        """
        Get notification list.
        ...
        :param dateRangeStart: Specify start of requested/observed date range. String presentation of date that complies with ISO 8601 format.
        :type dateRangeStart: String
        
        :param dateRangeEnd: Specify end of requested/observed date range. String presentation of date that complies with ISO 8601 format.
        :type dateRangeEnd: String
    ...
    def get_3(self, sinceId, size, offset, longPolling, returnFullResource=None, skipOlderThan=None, accept_type=None):
        """
