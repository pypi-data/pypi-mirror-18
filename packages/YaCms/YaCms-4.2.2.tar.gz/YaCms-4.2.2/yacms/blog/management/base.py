...
from yacms.blog.models import BlogPost, BlogCategory
...
class BaseImporterCommand(BaseCommand):
    ...
    commands to subclass when importing blog posts into yacms.
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "-m", "--yacms-user", dest="yacms_user",
            help="yacms username to assign the imported blog posts to.")
        parser.add_argument(
