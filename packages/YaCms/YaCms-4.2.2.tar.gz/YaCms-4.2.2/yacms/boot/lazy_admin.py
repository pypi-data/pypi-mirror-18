...
class LazyAdminSite(AdminSite):
    ...
    def urls(self):
        ...
        # Misc yacms urlpatterns that should reside under /admin/ url,
        # specifically for compatibility with SSLRedirectMiddleware.
        from yacms.core.views import displayable_links_js, static_proxy
        from yacms.generic.views import admin_keywords_submit
        urls += [
        ...
        if "yacms.pages" in settings.INSTALLED_APPS:
            from yacms.pages.views import admin_page_ordering
