...
from yacms.core.forms import DynamicInlineAdminForm
from yacms.core.models import (
    Orderable, ContentTyped, SitePermission, CONTENT_STATUS_PUBLISHED)
from yacms.utils.models import base_concrete_model
    ...
    class BaseTranslationModelAdmin(TranslationAdmin):
        ...
        class Media:
            js = (
                ...
                static("yacms/js/%s" % settings.JQUERY_UI_FILENAME),
                static("yacms/js/admin/tabbed_translation_fields.js"),
            )
            css = {
                "all": (static(
                    "yacms/css/admin/tabbed_translation_fields.css"),),
            }
