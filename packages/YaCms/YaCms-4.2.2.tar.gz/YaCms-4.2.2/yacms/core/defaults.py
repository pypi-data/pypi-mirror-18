"""
Default settings for the ``yacms.core`` app. Each of these can be
...
register_setting(
    ...
    description=_("A sequence of Python dotted paths to models "
        "(eg: ``['yacms.blog.models.BlogPost',]``) that should be "
...
register_setting(
    ...
    description=_("YaCms's caching uses a technique know as mint "
...
if "yacms.blog" in settings.INSTALLED_APPS:
    dashboard_tags = (
...
register_setting(
    ...
    description=_("A sequence of fields that will be injected into "
        "YaCms's (or any library's) models. Each item in the sequence is "
...
register_setting(
    ...
    description=_("Sequence of models that will be provided by default as "
        ...
        "``yacms.core.models.Displayable`` should be used."),
    editable=False,
...
register_setting(
    ...
    description=_("Dotted Python path to the callable for converting "
        ...
        "``yacms.utils.urls.slugify_unicode`` which allows for non-ascii "
...
register_setting(
    ...
    description=_("Sequence of dotted Python paths to callable functions "
        ...
        "Defaults to ``yacms.utils.views.is_spam_akismet`` which will "
...
# available settings. They are YaCms specific, but their values
...
register_setting(
    ...
    description=_("Unique random string like ``SECRET_KEY``, but used for "
        ...
        "automatically generated by the ``yacms-project`` command."),
    editable=False,
    default="",
)
