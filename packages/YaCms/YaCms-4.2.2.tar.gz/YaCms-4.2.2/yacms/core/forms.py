...
class TinyMceWidget(forms.Textarea):
    ...
    class Media:
        js = [static("yacms/tinymce/tinymce.min.js"),
              static("yacms/tinymce/jquery.tinymce.min.js"),
              static(settings.TINYMCE_SETUP_JS)]
        css = {'all': [static("yacms/tinymce/tinymce.css")]}
...
class DynamicInlineAdminForm(forms.ModelForm):
    ...
    class Media:
        js = [static("yacms/js/%s" % settings.JQUERY_UI_FILENAME),
              static("yacms/js/admin/dynamic_inline.js")]
