...
from yacms.utils.tests import copy_test_to_media
...
class Command(BaseCommand):
    ...
    help = "Performs initial YaCms database setup."
    ...
    def handle(self, **options):
        ...
        mapping = [
            ...
            [self.create_pages, ["yacms.pages", "yacms.forms",
                                 "yacms.blog", "yacms.galleries"]],
    ...
    def create_pages(self):
        call_command("loaddata", "yacms_required.json")
        ...
        if install_optional:
            if self.verbosity >= 1:
                print("\nCreating demo pages: About us, Contact form, "
                        "Gallery ...\n")
            from yacms.galleries.models import Gallery
            call_command("loaddata", "yacms_optional.json")
            zip_name = "gallery.zip"
            copy_test_to_media("yacms.core", zip_name)
