...
def banner():
    ...
    lines = ("""
     ...
     .p'                `q.
    .d'                   `b.
   .d'                     `b.   * yacms %(yacms_version)s
   ::                       ::   * Django %(django_version)s
   ::       Y A C M S       ::   * Python %(python_version)s
...
""" % {
        "yacms_version": yacms.__version__,
...
class Command(runserver.Command):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            default=True,
            help='Tells YaCms not to show a banner at startup.',
        )

    def inner_run(self, show_banner, *args, **kwargs):
        if show_banner:
            # Show YaCms's own cool banner in the terminal. There
