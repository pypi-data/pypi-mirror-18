...
from yacms.core.fields import RichTextField
from yacms.core.forms import get_edit_form
from yacms.utils.cache import nevercache_token, cache_installed
from yacms.utils.html import decode_entities
from yacms.utils.importing import import_dotted_path
from yacms.utils.sites import current_site_id, has_site_permission
from yacms.utils.urls import admin_url
from yacms.utils.views import is_editable
...
if "compressor" in settings.INSTALLED_APPS:
    ...
    def compress(parser, token):
        ...
        loaded from ``yacms_tags``, allowing us to provide
...
def initialize_nevercache():
    if cache_installed():
        ...
        def nevercache(parser, token):
            ...
            in ``yacms.core.middleware.UpdateCacheMiddleware``.
