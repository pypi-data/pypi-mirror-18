...
from yacms.forms.forms import EntriesForm
from yacms.forms.models import Form, Field, FormEntry, FieldEntry
from yacms.pages.admin import PageAdmin
from yacms.utils.static import static_lazy as static
from yacms.utils.urls import admin_url, slugify
...
class FormAdmin(PageAdmin):
    ...
    class Media:
        css = {"all": (static("yacms/css/admin/form.css"),)}
