...
from yacms.galleries.models import Gallery, GALLERIES_UPLOAD_DIR
from yacms.utils.tests import TestCase, copy_test_to_media
...
class GalleriesTests(TestCase):
    ...
    def test_thumbnail_generation(self):
        ...
        size = (24, 24)
        copy_test_to_media("yacms.core", image_name)
