...
from yacms.generic.forms import RatingForm
from yacms.generic.models import AssignedKeyword, Keyword, ThreadedComment
from yacms.generic.views import comment
from yacms.pages.models import RichTextPage
from yacms.utils.tests import TestCase


class GenericTests(TestCase):

    @skipUnless("yacms.blog" in settings.INSTALLED_APPS,
                "blog app required")
    def test_rating(self):
        ...
        for value in settings.RATINGS_RANGE:
            ...
            response.delete_cookie(native_str("yacms-rating"))
    ...
    def test_comment_ratings(self):
        """
        Test that a generic relation defined on one of yacms's generic
