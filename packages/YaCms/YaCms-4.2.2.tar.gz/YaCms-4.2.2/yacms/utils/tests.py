...
class TestCase(BaseTestCase):
    ...
    across the different apps in yacms.
    """
...
def copy_test_to_media(module, name):
    """
    Copies a file from yacms's test data path to MEDIA_ROOT.
    Used in tests and demo fixtures.
    """
    yacms_path = path_for_import(module)
    test_path = os.path.join(yacms_path, "static", "test", name)
