...
class PixivAPIv5(BaseAPI):
    ...
    async def search_works(self, query, *, page=1, per_page=30, mode='text',
        ...
        :param types: What types can be returned. Valid items are: ('illustration', 'manga', 'ugoira')
        :param image_sizes: What sizes of images should be returned.
        :param include_stats: Should the request include statistics?
        :param include_sanity_level: Should the request include a sanity level?
