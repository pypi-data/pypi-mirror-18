...
class CampaignPreventionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'jaq', '2016-08-01', 'CampaignPrevention')
	...
	def get_ActivityDescription(self):
		return self.get_query_params().get('ActivityDescription')

	def set_ActivityDescription(self,ActivityDescription):
		self.add_query_param('ActivityDescription',ActivityDescription)
	...
	def get_Prize(self):
		return self.get_query_params().get('Prize')

	def set_Prize(self,Prize):
		self.add_query_param('Prize',Prize)

	def get_PrizeType(self):
		return self.get_query_params().get('PrizeType')

	def set_PrizeType(self,PrizeType):
		self.add_query_param('PrizeType',PrizeType)
