...
class ModifyInfoPreventionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'jaq', '2016-08-01', 'ModifyInfoPrevention')
	...
	def get_ModifyInfoList(self):
		return self.get_query_params().get('ModifyInfoList')

	def set_ModifyInfoList(self,ModifyInfoList):
		self.add_query_param('ModifyInfoList',ModifyInfoList)
