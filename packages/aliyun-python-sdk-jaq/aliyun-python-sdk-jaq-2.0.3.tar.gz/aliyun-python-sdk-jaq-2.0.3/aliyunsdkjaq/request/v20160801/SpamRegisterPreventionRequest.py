...
class SpamRegisterPreventionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'jaq', '2016-08-01', 'SpamRegisterPrevention')
	...
	def get_RegisterUrl(self):
		return self.get_query_params().get('RegisterUrl')

	def set_RegisterUrl(self,RegisterUrl):
		self.add_query_param('RegisterUrl',RegisterUrl)
