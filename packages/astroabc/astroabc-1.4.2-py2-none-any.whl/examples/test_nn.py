...
param_file = os.path.join(ROOT_dir,'test_nn_params.ini')
...
def main():
	...
	#make some fake data
	data = Model(model_type,nsamples).make_mock(param, var = np.array([0.02,0.1]))#var=np.array([0.02,0.01,0.01,0.1]))
...
if __name__ == "__main__":
	...
	#########
        ...
        prop={'tol_type':pconfig.tol_type,"verbose":pconfig.verbose,'adapt_t':pconfig.adapt_t,'threshold':pconfig.threshold, 'k_near':pconfig.k_near,
