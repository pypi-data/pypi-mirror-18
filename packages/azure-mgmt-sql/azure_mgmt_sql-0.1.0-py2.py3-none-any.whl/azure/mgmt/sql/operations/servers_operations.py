...
class ServersOperations(object):
    ...
    def create_or_update_firewall_rule(
        ...
        :param parameters: The required parameters for createing or updating
         a firewall rule.
        :type parameters: :class:`ServerFirewallRule
         <azure.mgmt.sql.models.ServerFirewallRule>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ServerFirewallRule
         <azure.mgmt.sql.models.ServerFirewallRule>`
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ServerFirewallRule')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServerFirewallRule', response)
    ...
    def list_firewall_rules(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ServerFirewallRulePaged
         <azure.mgmt.sql.models.ServerFirewallRulePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        deserialized = models.ServerFirewallRulePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServerFirewallRulePaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def cancel_upgrade(
        ...
        """
        # Construct URL
        url = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/operationResults/versionUpgrade'
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serverName': self._serialize.url("server_name", server_name, 'str')
    ...
    def get_upgrade(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ServerUpgradeGetResult
         <azure.mgmt.sql.models.ServerUpgradeGetResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServerUpgradeGetResult', response)
    ...
    def start_upgrade(
        ...
        :param server_name: The name of the Azure SQL Server
        :type server_name: str
        :param parameters: The required parameters for the Azure SQL Server
         Upgrade.
        :type parameters: :class:`ServerUpgradeStartParameters
         <azure.mgmt.sql.models.ServerUpgradeStartParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
        ...
        """
        # Construct URL
        url = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/upgrade'
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serverName': self._serialize.url("server_name", server_name, 'str')
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ServerUpgradeStartParameters')
    ...
    def list_usages(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ServerMetricPaged
         <azure.mgmt.sql.models.ServerMetricPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
        ...
        # Deserialize response
        deserialized = models.ServerMetricPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServerMetricPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
