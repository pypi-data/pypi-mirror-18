...
class Tasks():
    ...
    def dynamics_accounts_dump_to_bookingbug_clients(self):
        ...
        messages.append('Dymamics accounts dump to BookingBug clients ended for: ' + self.bbug_company_id)
        return messages
    ...
    def delete_old_data(self):
        ...
        if appointments_deleted > 0:
            messages.append(str(appointments_deleted) + ' old booking events registers have been deleted in: ' + self.bbug_company_id )

        if accounts_deleted > 0 :
            messages.append(str(accounts_deleted) + ' old accounts registers have been deleted in: ' + self.bbug_company_id)
