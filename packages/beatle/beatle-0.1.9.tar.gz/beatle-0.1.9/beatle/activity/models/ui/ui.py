...
class NewArgument ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_const = wx.CheckBox( self, wx.ID_ANY, u"c&onst", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class SelectContexts ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Select contexts", pos = wx.DefaultPosition, size = wx.Size( 521,413 ), style = wx.DEFAULT_DIALOG_STYLE )
