...
class WebPreferences ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_radioBtn4 = wx.RadioButton( self, wx.ID_ANY, u"Automatic network configuration", wx.DefaultPosition, wx.DefaultSize, 0 )
		connection.Add( self.m_radioBtn4, 0, wx.ALL, 5 )
		
		self.m_radioBtn5 = wx.RadioButton( self, wx.ID_ANY, u"Manual proxy settings", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.st_http_proxy = wx.StaticText( self, wx.ID_ANY, u"http proxy:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_http_proxy = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0|wx.STATIC_BORDER )
		...
		self.m_checkBox6 = wx.CheckBox( self, wx.ID_ANY, u"use same proxy for all protocols", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.st_https_proxy = wx.StaticText( self, wx.ID_ANY, u"https proxy:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_https_proxy = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0|wx.STATIC_BORDER )
		self.m_https_proxy.Enable( False )
		
		fgSizer631.Add( self.m_https_proxy, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.st_ftp_proxy = wx.StaticText( self, wx.ID_ANY, u"ftp proxy:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.st_ftp_proxy.Wrap( -1 )
		self.st_ftp_proxy.Enable( False )
		
		fgSizer631.Add( self.st_ftp_proxy, 0, wx.ALL, 5 )
		
		self.m_ftp_proxy = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0|wx.STATIC_BORDER )
...
class HelpPreferences ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_help_items = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_AUTOARRANGE|wx.LC_NO_HEADER|wx.LC_REPORT|wx.LC_SINGLE_SEL )
		...
		self.m_new_btn = wx.Button( self, wx.ID_ANY, u"New", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer66.Add( self.m_new_btn, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_edit_btn = wx.Button( self, wx.ID_ANY, u"Edit", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_edit_btn.Enable( False )
		
		fgSizer66.Add( self.m_edit_btn, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_del_btn = wx.Button( self, wx.ID_ANY, u"Delete", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class MainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.menuFile.AppendSubMenu( self.menuMRU, u"MyMenu" )
