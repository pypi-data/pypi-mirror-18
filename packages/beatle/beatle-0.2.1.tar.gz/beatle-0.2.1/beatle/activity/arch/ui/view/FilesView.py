...
from beatle import app, deco, ostools, tran
...
class FilesView(BaseView, ui.FilesView):
    ...
    _open = IdentifiersHandler.register("ID_EDIT_OPEN")
    _refreshFiles = IdentifiersHandler.register("ID_REFRESH_FILES")
    _addProjectFile = IdentifiersHandler.register("ID_ADD_PROJECT_FILE")
    _addProjectDir = IdentifiersHandler.register("ID_ADD_PROJECT_DIR")
    ...
    def _create_menus(self):
        ...
        menuItem.SetBitmap(wx.Bitmap(u"app/res/refresh.xpm", wx.BITMAP_TYPE_ANY))
        self._menu.AppendItem(menuItem)
