...
class ConstructorPane(beatle.app.ui.pane.BasePane,ui.ConstructorPane):
    ...
    def Refresh(self):
        ...
        text = self.m_init.GetText()
        if text == self._object._init:  # This is a temporally patch for self updates            
        ...
        if text == self._object._content:  # This is a temporally patch for self updates            
    ...
    def OnFullScreen(self, event):
        ...
        if self._fullScreen:
            ...
            self._fullScreen = beatle.app.pane.FullScreen(self)
        wx.SafeYield()
        if curs:
            curs.SetFocus()
