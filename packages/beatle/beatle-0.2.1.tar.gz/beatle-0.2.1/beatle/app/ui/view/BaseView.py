...
class BaseView(object):
    ...
    _saveWorkspace = IdentifiersHandler.register("ID_SAVE_WORKSPACE")
    _closeWorkspace = IdentifiersHandler.register("ID_CLOSE_WORKSPACE")
    _closeProject = IdentifiersHandler.register("ID_CLOSE_PROJECT")
    _saveProject = IdentifiersHandler.register("ID_SAVE_PROJECT")
    _editProperties = IdentifiersHandler.register("ID_EDIT_PROPERTIES")
    _editDelete = IdentifiersHandler.register("ID_DELETE")
    _newProject = IdentifiersHandler.register("ID_NEW_PROJECT")
    _openProject = IdentifiersHandler.register("ID_OPEN_PROJECT")
    _importProject = IdentifiersHandler.register("ID_IMPORT_PROJECT")
    _editCopy = IdentifiersHandler.register("ID_COPY")
    _editCut = IdentifiersHandler.register("ID_CUT")
    _editPaste = IdentifiersHandler.register("ID_PASTE")
