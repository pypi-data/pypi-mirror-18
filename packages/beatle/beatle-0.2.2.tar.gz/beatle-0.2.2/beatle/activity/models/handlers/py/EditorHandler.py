...
class EditorHandler(EditorHandlerBase):
    ...
    style = {
        ...
        'comment block': "fore:#7F7F7F,back:#FFFFFF",
        'comment line': "fore:#7F7F7F,back:#FFFFFF",
        'decorator': "fore:#640064",
        'function name': "fore:#28003C",
        'identifier': "fore:#3C0028",
        "number": "fore:#7F5F5F,back:#FFFFFF",
