...
class TasksView(BaseView, ui.TasksView):
    ...
    _addFolderId = IdentifiersHandler.register('add-folder')  # add folder
    _newTaskId = IdentifiersHandler.register('add-task')      # add task
    _taskList = IdentifiersHandler.register('task-list')      # task list (pending and current)
