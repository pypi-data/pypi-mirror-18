...
from beatle.app import resources, MainWindow
from beatle import ostools
#from beatle.plugin import tools
...
class mainWindow(MainWindow):
    ...
    def __init__(self, app):
        ...
        # fix globals
        from beatle import activity
        from beatle import plugin
    ...
    def _import_views(self):
        ...
        for cls in self._views:
            ...
            code = eval('lambda x, event: x.OnUpdateToggleView(beatle.activity.INDEX["{name}"], event)'.format(
                name=name))
            ...
            code = eval('lambda x, event: x.OnToggleView(beatle.activity.INDEX["{name}"], event)'.format(
                name=name))
