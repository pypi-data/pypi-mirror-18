    ...
    def __pull(self, branch, path=False):
        ...
        try:
            ...
            if repo_index >= 0:
                ...
                _logger.error("fatal: Could not read from remote repository %s",
                              repo.remotes[repo_index])
                res = utils.set_message(branch, "fatal: Could not read from remote repository")
        except git.exc.GitCommandError as error:
