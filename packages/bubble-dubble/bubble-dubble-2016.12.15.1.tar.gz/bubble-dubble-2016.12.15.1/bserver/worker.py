...
from ..bcommon.default import PICKLE_HEADER_STRUCT, PICKLE_MAGIC_NUMBER, PICKLE_HEADER_SIZE
...
class BubbleWorker:
    ...
    def parse(self, request):
        ...
        return self.pack_state(request, state)

    def pack_state(self, request, state):
        if 'pickle' in request:
