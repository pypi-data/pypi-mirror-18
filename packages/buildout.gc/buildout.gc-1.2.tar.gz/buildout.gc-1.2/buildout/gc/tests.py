...
def buildout_setup(test_env):
    zc.buildout.testing.buildoutSetUp(test_env)
    zc.buildout.testing.install_develop('buildout.gc', test_env)


def doc_suite(test_dir, setUp=buildout_setup,
              tearDown=zc.buildout.testing.buildoutTearDown, globs=None):
