...
from numpy import sin as npsin, cos as npcos, minimum, maximum, ravel_multi_index, hstack, empty
...
class PolarRebin:
	...
	def rebin(self, folded):

		return self.overlap_values.dot(folded.reshape(self.cbins**2, -1)).squeeze()
