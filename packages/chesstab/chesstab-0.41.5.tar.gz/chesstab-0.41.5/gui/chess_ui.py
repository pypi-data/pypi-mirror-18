...
from .partialrow import make_ChessDBrowPartial
...
from .partialgrid import PartialGrid
...
from .selectiongrid import SelectionGrid
from .selectionrow import make_ChessDBrowSelection
...
class ChessUI(ChessException):
    ...
    def __init__(self, panel, statusbar=None, uci=None, toolbarframe=None):
        ...
        self.base_partials = PartialGrid(self)
        self.base_selections = SelectionGrid(self)
            ...
            if was_active:
                ...
                ap.after(
                    ...
                    func=self.try_command(
                        views.active_item.set_game_list, ap))
                ap.after(
    ...
    def show_game_grid(self, database):
        ...
        if self.partial_items.count_items_in_stack():
            self.set_partial_position_data_source()
            self.partial_items.active_item.set_game_list()
