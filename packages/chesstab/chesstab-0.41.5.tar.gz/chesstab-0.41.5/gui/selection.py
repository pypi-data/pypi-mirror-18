...
The Selection class displays a game selection rule.
...
The selectionedit module provides a subclass which allows editing in the main
application window.

The selectiondbshow and selectiondbedit modules provide subclasses used in a
new toplevel widget to display or edit game selection rules.

The selectiondbdelete module provides a subclass used in a new toplevel widget
...
from .selectiontext import SelectionText
    

class Selection(SelectionText):
    ...
    def __init__(
        ...
        **ka):
        ...
        # The popup menus specific to Selection (placed same as Game equivalent)
