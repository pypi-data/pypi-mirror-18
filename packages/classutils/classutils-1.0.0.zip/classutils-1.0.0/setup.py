...
setup(
    ...
    url=u'https://bitbucket.org/daycoder/classutils.git',  # Use the url to the git repo
    download_url=u'https://bitbucket.org/daycoder/'
                 u'classutils/get/{version}.tar'.format(version=VERSION),
    ...
    description=u"A collection of utilites to enhance Python classes.",
