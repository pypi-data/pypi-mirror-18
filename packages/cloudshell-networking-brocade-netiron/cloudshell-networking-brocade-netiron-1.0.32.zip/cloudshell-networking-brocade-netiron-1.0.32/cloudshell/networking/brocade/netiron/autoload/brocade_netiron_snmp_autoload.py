...
class NetIronSnmpAutoload(BrocadeSnmpAutoload):
    IF_ENTITY = "ifName"
    ...
    def __init__(self, snmp_handler=None, logger=None, config=None, cli_service=None, snmp_community=None):
        ...
        overridden_config = override_attributes_from_config(NetIronSnmpAutoload, config=self.config)
    ...
    def _get_autoload_details(self):
        ...
        self.snmp.load_mib(['BROCADE-ENTITY-OID-MIB'])
