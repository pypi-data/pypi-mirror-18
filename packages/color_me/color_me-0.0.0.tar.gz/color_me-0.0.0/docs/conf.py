# -*- coding: utf-8 -*-
#
# Color Me documentation build configuration file, created by
...
version = color_me.__version__
# The full version, including alpha/beta/rc tags.
release = color_me.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'Color Me Documentation',
     [u'Kale Kundert'], 1)
]
