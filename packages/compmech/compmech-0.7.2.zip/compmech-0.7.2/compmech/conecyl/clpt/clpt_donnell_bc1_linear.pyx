                    ...
                    for j2 in range(j0, n2+j0):
                        ...
                        for l2 in range(j0, n2+j0):
                            ...
                            if k2 == i2 and l2 == j2:
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+2
                                k0v[c] += (-cosk2xa*k2*sini2xa*((pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina))) + cosk2xb*k2*sini2xb*((pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina))) + sink2xa*(pi*A66*L*r*sina*sini2xa*(i2 - k2)*(i2 + k2) + cosi2xa*i2*((pi*pi)*A66*(k2*k2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina)))) - sink2xb*(pi*A66*L*r*sina*sini2xb*(i2 - k2)*(i2 + k2) + cosi2xb*i2*((pi*pi)*A66*(k2*k2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina)))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+3
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+4
                                k0v[c] += (-L*cosk2xb*k2*sina*sini2xb*(A26*(L*L)*cosa + (pi*pi)*r*(B16*(k2*k2) + B26*(i2*i2))) + cosi2xa*i2*(-L*sina*sink2xa*(A26*(L*L)*cosa + (pi*pi)*(k2*k2)*r*(B16 + B26)) - pi*cosk2xa*k2*(B26*(L*L)*(3*(j2*j2) - (sina*sina)) + r*(A26*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r))) + cosi2xb*i2*(L*sina*sink2xb*(A26*(L*L)*cosa + (pi*pi)*(k2*k2)*r*(B16 + B26)) + pi*cosk2xb*k2*(B26*(L*L)*(3*(j2*j2) - (sina*sina)) + r*(A26*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r))) + sini2xa*(L*cosk2xa*k2*sina*(A26*(L*L)*cosa + (pi*pi)*r*(B16*(k2*k2) + B26*(i2*i2))) - pi*sink2xa*(B26*(L*L)*((j2*j2)*((i2*i2) + 2*(k2*k2)) - (k2*k2)*(sina*sina)) + (i2*i2)*r*(A26*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r))) + pi*sini2xb*sink2xb*(B26*(L*L)*((j2*j2)*((i2*i2) + 2*(k2*k2)) - (k2*k2)*(sina*sina)) + (i2*i2)*r*(A26*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r)))/((L*L)*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+5
                                k0v[c] += j2*(pi*L*r*sina*sini2xb*sink2xb*(-B66*(i2*i2) + (k2*k2)*(B22 + 2*B66)) + cosi2xa*i2*(-pi*L*cosk2xa*k2*r*sina*(B22 + B66) + sink2xa*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*(k2*k2)*r*(B12 + 2*B66)))) + cosi2xb*i2*(pi*L*cosk2xb*k2*r*sina*(B22 + B66) - sink2xb*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*(k2*k2)*r*(B12 + 2*B66)))) + cosk2xb*k2*sini2xb*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*r*(B12*(k2*k2) + 2*B66*(i2*i2)))) + sini2xa*(pi*L*r*sina*sink2xa*(B66*(i2*i2) - (k2*k2)*(B22 + 2*B66)) - cosk2xa*k2*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*r*(B12*(k2*k2) + 2*B66*(i2*i2))))))/(L*(r*r)*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+3
                                k0c[c] = col+0
                                k0v[c] += j2*(-L*cosk2xb*k2*sina*sini2xb*(A22 + A66) + cosi2xa*i2*(-L*sina*sink2xa*(A22 + A66) - pi*cosk2xa*k2*r*(A12 + A66)) + cosi2xb*i2*(L*sina*sink2xb*(A22 + A66) + pi*cosk2xb*k2*r*(A12 + A66)) + pi*r*sini2xb*sink2xb*(A12*(k2*k2) + A66*(i2*i2)) + sini2xa*(L*cosk2xa*k2*sina*(A22 + A66) - pi*r*sink2xa*(A12*(k2*k2) + A66*(i2*i2))))/(r*(i2 - k2)*(i2 + k2))
                                ...
                                k0r[c] = row+4
                                k0c[c] = col+2
                                k0v[c] += (-L*cosk2xb*k2*sina*sini2xb*(A26*(L*L)*cosa + (pi*pi)*(i2*i2)*r*(B16 + B26)) + cosi2xa*i2*(-L*sina*sink2xa*(A26*(L*L)*cosa + (pi*pi)*r*(B16*(i2*i2) + B26*(k2*k2))) + pi*cosk2xa*k2*(B26*(L*L)*(3*(j2*j2) - (sina*sina)) + r*(A26*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) + cosi2xb*i2*(L*sina*sink2xb*(A26*(L*L)*cosa + (pi*pi)*r*(B16*(i2*i2) + B26*(k2*k2))) - pi*cosk2xb*k2*(B26*(L*L)*(3*(j2*j2) - (sina*sina)) + r*(A26*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) + sini2xa*(L*cosk2xa*k2*sina*(A26*(L*L)*cosa + (pi*pi)*(i2*i2)*r*(B16 + B26)) + pi*sink2xa*(B26*(L*L)*(-(i2*i2)*(sina*sina) + (j2*j2)*(2*(i2*i2) + (k2*k2))) + (k2*k2)*r*(A26*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) - pi*sini2xb*sink2xb*(B26*(L*L)*(-(i2*i2)*(sina*sina) + (j2*j2)*(2*(i2*i2) + (k2*k2))) + (k2*k2)*r*(A26*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r)))/((L*L)*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+3
                                k0v[c] += j2*(pi*L*r*sina*sini2xb*sink2xb*(-B66*(k2*k2) + (i2*i2)*(B22 + 2*B66)) + cosi2xa*i2*(-pi*L*cosk2xa*k2*r*sina*(B22 + B66) - sink2xa*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*r*(B12*(i2*i2) + 2*B66*(k2*k2))))) + cosi2xb*i2*(pi*L*cosk2xb*k2*r*sina*(B22 + B66) + sink2xb*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*r*(B12*(i2*i2) + 2*B66*(k2*k2))))) - cosk2xb*k2*sini2xb*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*(i2*i2)*r*(B12 + 2*B66))) + sini2xa*(pi*L*r*sina*sink2xa*(B66*(k2*k2) - (i2*i2)*(B22 + 2*B66)) + cosk2xa*k2*(B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + r*(A22*(L*L)*cosa + (pi*pi)*(i2*i2)*r*(B12 + 2*B66)))))/(L*(r*r)*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+4
            ...
            for k2 in range(i0, m2+i0):
                for l2 in range(j0, n2+j0):
                    ...
                    if k2 == i2 and l2 == j2:
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+4
                        k0v[c] += pi*i2*k2*((-1)**(i2 + k2) - 1)*(A26*(L*L)*r + (pi*pi)*B16*(k2*k2)*(r*r) + 3*B26*(L*L)*(j2*j2))/((L*L)*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += pi*i2*j2*k2*((-1)**(i2 + k2) - 1)*(A12 + A66)/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+4
                        k0c[c] = col+2
                        k0v[c] += -pi*i2*k2*((-1)**(i2 + k2) - 1)*(A26*(L*L)*r + (pi*pi)*B16*(i2*i2)*(r*r) + 3*B26*(L*L)*(j2*j2))/((L*L)*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+5
