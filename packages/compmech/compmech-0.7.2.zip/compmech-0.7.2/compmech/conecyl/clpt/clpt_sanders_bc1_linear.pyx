                        ...
                        for l2 in range(j0, n2+j0):
                            ...
                            if k2==i2 and l2==j2:
                                if i2!=0:
                                    ...
                                    k0r[c] = row+0
                                    k0c[c] = col+2
                                    k0v[c] += 0.5*pi*((L*L)*(r*sina*sini2xa_xb*sini2xaxb*(B16*cosa - B26*cosa + r*(A16 - A26)) + (j2 - sina)*(j2 + sina)*(A26*r + B26*cosa)*(L*cosi2xaxb*sini2xa_xb + pi*i2*(-xa + xb))/(pi*i2)) + 0.5*pi*i2*(r*r)*(A16*r + B16*cosa)*(-L*sin2i2xa + L*sin2i2xb + 2*pi*i2*(-xa + xb)))/((L*L)*(r*r))
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+3
                                    ...
                                    k0r[c] = row+1
                                    k0c[c] = col+3
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(pi*L*i2*r*sina*sini2xaxb*(A16*r - A26*r + B16*cosa - B26*cosa) + cosi2xaxb*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) - r*(A26*(L*L)*(-(j2*j2) + (sina*sina)) + (pi*pi)*(i2*i2)*r*(A16*r + B16*cosa)))) - 2*pi*i2*(xa - xb)*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) + r*(A26*(L*L)*(j2 - sina)*(j2 + sina) + (pi*pi)*(i2*i2)*r*(A16*r + B16*cosa))))/((L*L)*i2*(r*r))
                                    c += 1
                                    k0r[c] = row+1
                                    k0c[c] = col+4
                                    ...
                                    k0r[c] = row+3
                                    k0c[c] = col+3
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(2*pi*L*i2*r*sina*sini2xaxb*(A66*(r*r) + 2*B66*cosa*r + D66*(cosa*cosa)) + cosi2xaxb*((cosa*cosa)*(-(pi*pi)*D66*(i2*i2)*(r*r) + (L*L)*(D22*(j2*j2) + D66*(sina*sina))) + 2*cosa*r*(-(pi*pi)*B66*(i2*i2)*(r*r) + (L*L)*(B22*(j2*j2) + B66*(sina*sina))) + (r*r)*(-(pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina))))) - 2*pi*i2*(xa - xb)*((cosa*cosa)*((pi*pi)*D66*(i2*i2)*(r*r) + (L*L)*(D22*(j2*j2) + D66*(sina*sina))) + 2*cosa*r*((pi*pi)*B66*(i2*i2)*(r*r) + (L*L)*(B22*(j2*j2) + B66*(sina*sina))) + (r*r)*((pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A66*(sina*sina)))))/((L*L)*i2*(r*r*r))
                                    c += 1
                                    k0r[c] = row+3
                                    k0c[c] = col+4
                                    k0v[c] += 0.25*j2*(2*L*sini2xa_xb*(-pi*L*i2*r*sina*sini2xaxb*(cosa*(D22 + 3*D66) + r*(B22 + 3*B66)) - cosi2xaxb*(B22*(L*L)*(cosa*cosa)*r + cosa*(D22*(L*L)*(j2*j2) + D66*(L*L)*(sina*sina) + (r*r)*(A22*(L*L) + (pi*pi)*(i2*i2)*(D12 - 2*D66))) + r*((L*L)*(B22*(j2*j2) + B66*(sina*sina)) + (pi*pi)*(i2*i2)*(r*r)*(B12 - 2*B66)))) + 2*pi*i2*(xa - xb)*(B22*(L*L)*(cosa*cosa)*r + cosa*(D22*(L*L)*(j2*j2) + D66*(L*L)*(sina*sina) + (r*r)*(A22*(L*L) + (pi*pi)*(i2*i2)*(D12 + 2*D66))) + r*((L*L)*(B22*(j2*j2) + B66*(sina*sina)) + (pi*pi)*(i2*i2)*(r*r)*(B12 + 2*B66))))/((L*L)*i2*(r*r*r))
                                ...
                                k0r[c] = row+0
                                k0c[c] = col+2
                                k0v[c] += pi*(L*(A26*r + B26*cosa)*(cosi2xa*i2*(L*sink2xa*(j2 - sina)*(j2 + sina) + pi*cosk2xa*k2*r*sina) - cosi2xb*i2*(L*sink2xb*(j2 - sina)*(j2 + sina) + pi*cosk2xb*k2*r*sina) + k2*sini2xa*(L*cosk2xa*(-(j2*j2) + (sina*sina)) + pi*k2*r*sina*sink2xa) - k2*sini2xb*(L*cosk2xb*(-(j2*j2) + (sina*sina)) + pi*k2*r*sina*sink2xb))/pi + i2*r*(A16*r + B16*cosa)*(cosi2xa*k2*(L*cosk2xa*sina + pi*k2*r*sink2xa) - cosi2xb*k2*(L*cosk2xb*sina + pi*k2*r*sink2xb) + i2*(sini2xa*(L*sina*sink2xa - pi*cosk2xa*k2*r) + sini2xb*(-L*sina*sink2xb + pi*cosk2xb*k2*r))))/(L*(r*r)*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+3
                                k0v[c] += j2*(L*cosk2xb*k2*sina*sini2xb*(cosa*(B22 + B66) + r*(A22 + A66)) + cosi2xa*i2*(L*sina*sink2xa*(cosa*(B22 + B66) + r*(A22 + A66)) - pi*cosk2xa*k2*r*(cosa*(B12 + B66) + r*(A12 + A66))) + cosi2xb*i2*(-L*sina*sink2xb*(cosa*(B22 + B66) + r*(A22 + A66)) + pi*cosk2xb*k2*r*(cosa*(B12 + B66) + r*(A12 + A66))) + pi*r*sini2xb*sink2xb*(A12*(i2*i2)*r + B12*cosa*(i2*i2) + (k2*k2)*(A66*r + B66*cosa)) + sini2xa*(-L*cosk2xa*k2*sina*(cosa*(B22 + B66) + r*(A22 + A66)) - pi*r*sink2xa*(A12*(i2*i2)*r + B12*cosa*(i2*i2) + (k2*k2)*(A66*r + B66*cosa))))/((r*r)*(-i2 + k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+4
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+0
                                k0v[c] += (pi*L*r*sina*sini2xb*sink2xb*(A26*(i2*i2)*r + B26*cosa*(i2*i2) + (k2*k2)*(A16*r + B16*cosa)) + cosi2xa*i2*(-pi*L*cosk2xa*k2*r*sina*(cosa*(B16 + B26) + r*(A16 + A26)) + sink2xa*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) + r*(A26*(L*L)*(j2 - sina)*(j2 + sina) + (pi*pi)*(k2*k2)*r*(A16*r + B16*cosa)))) + cosi2xb*i2*(pi*L*cosk2xb*k2*r*sina*(cosa*(B16 + B26) + r*(A16 + A26)) - sink2xb*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) + r*(A26*(L*L)*(j2 - sina)*(j2 + sina) + (pi*pi)*(k2*k2)*r*(A16*r + B16*cosa)))) + cosk2xb*k2*sini2xb*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) + r*(A26*(L*L)*(j2 - sina)*(j2 + sina) + (pi*pi)*(i2*i2)*r*(A16*r + B16*cosa))) + sini2xa*(-pi*L*r*sina*sink2xa*(A26*(i2*i2)*r + B26*cosa*(i2*i2) + (k2*k2)*(A16*r + B16*cosa)) - cosk2xa*k2*(B26*(L*L)*cosa*(j2 - sina)*(j2 + sina) + r*(A26*(L*L)*(j2 - sina)*(j2 + sina) + (pi*pi)*(i2*i2)*r*(A16*r + B16*cosa)))))/(L*(r*r)*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+1
                                k0v[c] += j2*(-L*cosk2xb*k2*sina*sini2xb*(cosa*(B22 + B66) + r*(A22 + A66)) + cosi2xa*i2*(-L*sina*sink2xa*(cosa*(B22 + B66) + r*(A22 + A66)) - pi*cosk2xa*k2*r*(cosa*(B12 + B66) + r*(A12 + A66))) + cosi2xb*i2*(L*sina*sink2xb*(cosa*(B22 + B66) + r*(A22 + A66)) + pi*cosk2xb*k2*r*(cosa*(B12 + B66) + r*(A12 + A66))) + pi*r*sini2xb*sink2xb*(A66*(i2*i2)*r + B66*cosa*(i2*i2) + (k2*k2)*(A12*r + B12*cosa)) + sini2xa*(L*cosk2xa*k2*sina*(cosa*(B22 + B66) + r*(A22 + A66)) - pi*r*sink2xa*(A66*(i2*i2)*r + B66*cosa*(i2*i2) + (k2*k2)*(A12*r + B12*cosa))))/((r*r)*(-i2 + k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+2
            ...
            for k2 in range(i0, m2+i0):
                for l2 in range(j0, n2+j0):
                    ...
                    if k2==i2 and l2==j2:
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+3
                        k0v[c] += -pi*i2*j2*k2*((-1)**(i2 + k2) - 1)*(B12 + B66 + r*(A12 + A66))/(r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+4
                        ...
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += pi*i2*j2*k2*((-1)**(i2 + k2) - 1)*(B12 + B66 + r*(A12 + A66))/(r*(i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+2
                        k0v[c] += pi*i2*j2*k2*(2*(-1)**(i2 + k2) - 2)*(A26*(r*r) + 2*B26*r + D26)/((r*r)*((i2*i2) - (k2*k2)))
