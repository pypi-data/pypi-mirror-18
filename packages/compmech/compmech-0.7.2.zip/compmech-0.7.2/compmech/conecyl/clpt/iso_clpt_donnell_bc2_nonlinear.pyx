...
cdef void cfk0L(int npts, double *xs, double *ts, double *out,
    ...
    for i in range(npts):
        ...
        # p_0
        p00 = E11*h*(nu*sina*(-L + x) + r)/(L*cosa*((nu*nu) - 1))
        p01 = E11*h*(nu*r + sina*(-L + x))/(L*cosa*((nu*nu) - 1))
        p12 = -0.5*E11*h*r2*(r + sina*(L - x))/(L*(nu + 1))
        p20 = E11*h*(nu*sina*(-L + x) + r)*cos(t - tLA)/(L*cosa*((nu*nu) - 1))
        p21 = E11*h*(nu*r + sina*(-L + x))*cos(t - tLA)/(L*cosa*((nu*nu) - 1))
        ...
        for i1 in range(i0, m1+i0):
            ...
            # p_1
            p00 = E11*h*(L*nu*sina*sini1x + pi*cosi1x*i1*r)/(-L*(nu*nu) + L)
            p01 = E11*h*(L*sina*sini1x + pi*cosi1x*i1*nu*r)/(-L*(nu*nu) + L)
            p12 = (-E11*L*h*sina*sini1x + pi*E11*cosi1x*h*i1*r)/(2*L*nu + 2*L)
            p20 = E11*cosa*h*nu*sini1x/(-(nu*nu) + 1)
            p21 = E11*cosa*h*sini1x/(-(nu*nu) + 1)
        ...
        for i2 in range(i0, m2+i0):
            ...
            for j2 in range(j0, n2+j0):
                ...
                # p_2
                p00 = E11*h*sinj2t*(-L*cosi2x*nu*sina + pi*i2*r*sini2x)/(L*((nu*nu) - 1))
                p01 = E11*h*sinj2t*(-L*cosi2x*sina + pi*i2*nu*r*sini2x)/(L*((nu*nu) - 1))
                p02 = E11*cosi2x*cosj2t*h*j2/(2*nu + 2)
                p10 = E11*cosj2t*h*(-L*cosi2x*nu*sina + pi*i2*r*sini2x)/(L*((nu*nu) - 1))
                p11 = E11*cosj2t*h*(-L*cosi2x*sina + pi*i2*nu*r*sini2x)/(L*((nu*nu) - 1))
                p12 = -E11*cosi2x*h*j2*sinj2t/(2.0*nu + 2.0)
                p20 = E11*cosj2t*h*j2*nu*sini2x/(-(nu*nu) + 1)
                p21 = E11*cosj2t*h*j2*sini2x/(-(nu*nu) + 1)
                p22 = 0.5*E11*h*sinj2t*(-L*sina*sini2x + pi*cosi2x*i2*r)/(L*(nu + 1))
                p30 = E11*h*j2*nu*sini2x*sinj2t/((nu*nu) - 1)
                p31 = E11*h*j2*sini2x*sinj2t/((nu*nu) - 1)
                p32 = 0.5*E11*cosj2t*h*(-L*sina*sini2x + pi*cosi2x*i2*r)/(L*(nu + 1))
                p40 = E11*cosa*h*nu*sini2x*sinj2t/(-(nu*nu) + 1)
                p41 = E11*cosa*h*sini2x*sinj2t/(-(nu*nu) + 1)
                p50 = E11*cosa*cosj2t*h*nu*sini2x/(-(nu*nu) + 1)
                p51 = E11*cosa*cosj2t*h*sini2x/(-(nu*nu) + 1)
...
cdef void cfkLL(int npts, double *xs, double *ts, double *out,
    ...
    for i in range(npts):
        ...
        for i1 in range(i0, m1+i0):
            ...
            cosi1x = vcosi1x[i1-i0]
            # p_1
            p20 = -pi*E11*cosi1x*h*i1*r*(w0x + wx)/(L*((nu*nu) - 1))
            p21 = -pi*E11*cosi1x*h*i1*nu*r*(w0x + wx)/(L*((nu*nu) - 1))
        ...
        for i2 in range(i0, m2+i0):
            ...
            for j2 in range(j0, n2+j0):
                ...
                # p_2
                p40 = -E11*h*(L*cosj2t*j2*nu*sini2x*(w0t + wt) + pi*cosi2x*i2*(r*r)*sinj2t*(w0x + wx))/(L*r*((nu*nu) - 1))
                p41 = -E11*h*(L*cosj2t*j2*sini2x*(w0t + wt) + pi*cosi2x*i2*nu*(r*r)*sinj2t*(w0x + wx))/(L*r*((nu*nu) - 1))
                p42 = 0.5*E11*h*(L*cosj2t*j2*sini2x*(w0x + wx) + pi*cosi2x*i2*sinj2t*(w0t + wt))/(L*(nu + 1))
                p50 = E11*h*(L*j2*nu*sini2x*sinj2t*(w0t + wt) - pi*cosi2x*cosj2t*i2*(r*r)*(w0x + wx))/(L*r*((nu*nu) - 1))
                p51 = E11*h*(L*j2*sini2x*sinj2t*(w0t + wt) - pi*cosi2x*cosj2t*i2*nu*(r*r)*(w0x + wx))/(L*r*((nu*nu) - 1))
