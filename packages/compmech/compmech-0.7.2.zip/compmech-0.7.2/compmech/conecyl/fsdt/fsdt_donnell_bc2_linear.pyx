                    ...
                    for j2 in range(j0, n2+j0):
                        ...
                        for l2 in range(j0, n2+j0):
                            ...
                            if k2==i2 and l2==j2:
                                ...
                                k0r[c] = row+0
                                k0c[c] = col+2
                                k0v[c] += (cosi2xa*(pi*L*r*sina*sink2xa*(A16*(i2*i2) + A26*(k2*k2)) - cosk2xa*k2*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*(-pi*L*r*sina*sink2xb*(A16*(i2*i2) + A26*(k2*k2)) + cosk2xb*k2*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + i2*(pi*L*cosk2xb*k2*r*sina*sini2xb*(A16 + A26) + sini2xa*(-pi*L*cosk2xa*k2*r*sina*(A16 + A26) - sink2xa*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + sini2xb*sink2xb*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+3
                                k0v[c] += j2*(cosi2xa*(L*cosk2xa*k2*sina*(A22 + A66) + pi*r*sink2xa*(A12*(i2*i2) + A66*(k2*k2))) - cosi2xb*(L*cosk2xb*k2*sina*(A22 + A66) + pi*r*sink2xb*(A12*(i2*i2) + A66*(k2*k2))) + i2*(L*sina*sini2xa*sink2xa*(A22 + A66) - pi*cosk2xa*k2*r*sini2xa*(A12 + A66) + sini2xb*(-L*sina*sink2xb*(A22 + A66) + pi*cosk2xb*k2*r*(A12 + A66))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+4
                                ...
                                k0r[c] = row+1
                                k0c[c] = col+2
                                k0v[c] += j2*(cosi2xa*(-L*cosk2xa*k2*sina*(A22 + A66) - pi*r*sink2xa*(A12*(i2*i2) + A66*(k2*k2))) + cosk2xb*k2*(L*cosi2xb*sina*(A22 + A66) - pi*i2*r*sini2xb*(A12 + A66)) + i2*sini2xa*(-L*sina*sink2xa*(A22 + A66) + pi*cosk2xa*k2*r*(A12 + A66)) + sink2xb*(L*i2*sina*sini2xb*(A22 + A66) + pi*cosi2xb*r*(A12*(i2*i2) + A66*(k2*k2))))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+1
                                k0c[c] = col+3
                                k0v[c] += (cosi2xa*(pi*L*r*sina*sink2xa*(A16*(i2*i2) + A26*(k2*k2)) - cosk2xa*k2*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*(-pi*L*r*sina*sink2xb*(A16*(i2*i2) + A26*(k2*k2)) + cosk2xb*k2*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + i2*(pi*L*cosk2xb*k2*r*sina*sini2xb*(A16 + A26) + sini2xa*(-pi*L*cosk2xa*k2*r*sina*(A16 + A26) - sink2xa*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + sini2xb*sink2xb*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+0
                                k0v[c] += (pi*L*cosk2xb*r*sina*sini2xb*(A16*(k2*k2) + A26*(i2*i2)) + cosi2xa*i2*(pi*L*k2*r*sina*sink2xa*(A16 + A26) + cosk2xa*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*i2*(-pi*L*k2*r*sina*sink2xb*(A16 + A26) - cosk2xb*((pi*pi)*A16*(k2*k2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))) - k2*sini2xb*sink2xb*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina)) + sini2xa*(-pi*L*cosk2xa*r*sina*(A16*(k2*k2) + A26*(i2*i2)) + k2*sink2xa*((pi*pi)*A16*(i2*i2)*(r*r) + A26*(L*L)*(j2 - sina)*(j2 + sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+1
                                k0v[c] += j2*(-L*k2*sina*sini2xb*sink2xb*(A22 + A66) + cosi2xa*i2*(L*cosk2xa*sina*(A22 + A66) - pi*k2*r*sink2xa*(A12 + A66)) + cosi2xb*i2*(-L*cosk2xb*sina*(A22 + A66) + pi*k2*r*sink2xb*(A12 + A66)) - pi*cosk2xb*r*sini2xb*(A12*(k2*k2) + A66*(i2*i2)) + sini2xa*(L*k2*sina*sink2xa*(A22 + A66) + pi*cosk2xa*r*(A12*(k2*k2) + A66*(i2*i2))))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+2
            ...
            for k2 in range(i0, m2+i0):
                for l2 in range(j0, n2+j0):
                    ...
                    if k2==i2 and l2==j2:
                        ...
                        k0r[c] = row+6
                        k0c[c] = col+2
                        k0v[c] += k2*((-1)**(i2 + k2) - 1)*(B26*(L*L)*(j2*j2) + r*(-A45*(L*L) + (pi*pi)*B16*(i2*i2)*r))/(L*r*(i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+6
                        k0c[c] = col+5
