                        ...
                        for l2 in range(j0, n2+j0):
                            ...
                            if k2==i2 and l2==j2:
                                if i2!=0:
                                    ...
                                    k0r[c] = row+0
                                    k0c[c] = col+4
                                    k0v[c] += 0.25*cosa*(pi*A12*(-L*sin2i2xa + L*sin2i2xb + 2*pi*i2*(xa - xb)) + A22*(L*L)*sina*(cos2i2xa - cos2i2xb)/(i2*r))/L
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+5
                                    k0v[c] += 0.25*A26*L*cosa*j2*(cos2i2xa - cos2i2xb)/(i2*r)
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+6
                                    ...
                                    k0r[c] = row+0
                                    k0c[c] = col+8
                                    k0v[c] += 0.25*((pi*pi)*(i2*i2)*r*sina*(-2*B16 - 2*B26)*(xa - xb) + 2*sini2xa_xb*(pi*L*cosi2xaxb*i2*r*sina*(B16 - B26) + sini2xaxb*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(-(j2*j2) + (sina*sina)))))/(L*i2*r)
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+9
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+4
                                    k0v[c] += 0.25*cosa*(-A26*(L*L)*cos2i2xa*sina + A26*(L*L)*cos2i2xb*sina + pi*i2*r*(L*(A26 - A45)*(-sin2i2xa + sin2i2xb) + pi*i2*(2*A26 + 2*A45)*(xa - xb)))/(L*i2*r)
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+5
                                    k0v[c] += 0.25*L*cosa*j2*(A22 + A44)*(cos2i2xa - cos2i2xb)/(i2*r)
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+6
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+8
                                    k0v[c] += 0.5*sini2xa_xb*(2*pi*B66*L*cosi2xaxb*i2*r*sina + sini2xaxb*(A44*(L*L)*cosa*r - B22*(L*L)*(j2*j2) + B66*(-L*sina + pi*i2*r)*(L*sina + pi*i2*r)))/(L*i2*r)
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+9
                                    k0v[c] += (pi*pi)*B26*i2*j2*(-xa + xb)/L
                                    c += 1
                                    k0r[c] = row+3
                                    k0c[c] = col+0
                                    k0v[c] += 0.25*j2*(pi*cos2i2xa*i2*r*(A12 - A66) + pi*cos2i2xb*i2*r*(-A12 + A66) + sina*(A22 + A66)*(L*(sin2i2xa - sin2i2xb) + 2*pi*i2*(xa - xb)))/(i2*r)
                                ...
                                k0r[c] = row+0
                                k0c[c] = col+4
                                k0v[c] += (cosa*i2*sink2xb*(pi*A12*cosi2xb*i2*r + A22*L*sina*sini2xb) - cosa*(cosi2xa*(pi*A12*(i2*i2)*r*sink2xa + A22*L*cosk2xa*k2*sina) + cosk2xb*k2*(pi*A12*i2*r*sini2xb - A22*L*cosi2xb*sina) + i2*sini2xa*(-pi*A12*cosk2xa*k2*r + A22*L*sina*sink2xa)))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+5
                                k0v[c] += A26*L*cosa*j2*(-cosi2xa*cosk2xa*k2 + cosi2xb*cosk2xb*k2 - i2*sini2xa*sink2xa + i2*sini2xb*sink2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+6
                                ...
                                k0r[c] = row+0
                                k0c[c] = col+8
                                k0v[c] += (cosi2xa*(pi*L*r*sina*sink2xa*(B16*(i2*i2) + B26*(k2*k2)) - cosk2xa*k2*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*(-pi*L*r*sina*sink2xb*(B16*(i2*i2) + B26*(k2*k2)) + cosk2xb*k2*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + i2*(pi*L*cosk2xb*k2*r*sina*sini2xb*(B16 + B26) + sini2xa*(-pi*L*cosk2xa*k2*r*sina*(B16 + B26) - sink2xa*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + sini2xb*sink2xb*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+9
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+4
                                k0v[c] += cosa*(cosi2xa*(A26*L*cosk2xa*k2*sina - pi*r*sink2xa*(A26*(i2*i2) + A45*(k2*k2))) + cosi2xb*(-A26*L*cosk2xb*k2*sina + pi*r*sink2xb*(A26*(i2*i2) + A45*(k2*k2))) + i2*(A26*L*sina*sini2xa*sink2xa + pi*cosk2xa*k2*r*sini2xa*(A26 + A45) - sini2xb*(A26*L*sina*sink2xb + pi*cosk2xb*k2*r*(A26 + A45))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+5
                                k0v[c] += L*cosa*j2*(A22 + A44)*(-cosi2xa*cosk2xa*k2 + cosi2xb*cosk2xb*k2 - i2*sini2xa*sink2xa + i2*sini2xb*sink2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+6
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+8
                                k0v[c] += (-cosi2xa*(pi*B66*L*r*sina*sink2xa*(-(i2*i2) + (k2*k2)) + cosk2xa*k2*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r))) + cosi2xb*(pi*B66*L*r*sina*sink2xb*(-(i2*i2) + (k2*k2)) + cosk2xb*k2*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r))) - i2*(sini2xa*sink2xa - sini2xb*sink2xb)*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(k2*k2)*(r*r)))/(L*r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+9
                                k0v[c] += pi*B26*j2*(cosi2xa*sink2xa*((i2*i2) + (k2*k2)) - cosi2xb*sink2xb*((i2*i2) + (k2*k2)) - 2*cosk2xa*i2*k2*sini2xa + 2*cosk2xb*i2*k2*sini2xb)/((i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+3
                                k0c[c] = col+0
                                k0v[c] += j2*(-cosi2xa*(L*k2*sina*sink2xa*(A22 + A66) + pi*cosk2xa*r*(A12*(k2*k2) + A66*(i2*i2))) + cosi2xb*(L*k2*sina*sink2xb*(A22 + A66) + pi*cosk2xb*r*(A12*(k2*k2) + A66*(i2*i2))) + i2*(L*cosk2xa*sina*sini2xa*(A22 + A66) - pi*k2*r*sini2xa*sink2xa*(A12 + A66) + sini2xb*(-L*cosk2xb*sina*(A22 + A66) + pi*k2*r*sink2xb*(A12 + A66))))/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+4
                                k0c[c] = col+0
                                k0v[c] += cosa*(cosi2xa*i2*(-pi*A12*k2*r*sink2xa + A22*L*cosk2xa*sina) + cosi2xb*i2*(pi*A12*k2*r*sink2xb - A22*L*cosk2xb*sina) + k2*sini2xa*(pi*A12*cosk2xa*k2*r + A22*L*sina*sink2xa) - k2*sini2xb*(pi*A12*cosk2xb*k2*r + A22*L*sina*sink2xb))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+1
                                k0v[c] += A26*L*cosa*j2*(-cosi2xa*cosk2xa*i2 + cosi2xb*cosk2xb*i2 - k2*sini2xa*sink2xa + k2*sini2xb*sink2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+2
                                k0v[c] += cosa*(A26*L*k2*sina*sini2xb*sink2xb + cosi2xa*i2*(-A26*L*cosk2xa*sina - pi*k2*r*sink2xa*(A26 + A45)) + cosi2xb*i2*(A26*L*cosk2xb*sina + pi*k2*r*sink2xb*(A26 + A45)) - pi*cosk2xb*r*sini2xb*(A26*(k2*k2) + A45*(i2*i2)) + sini2xa*(-A26*L*k2*sina*sink2xa + pi*cosk2xa*r*(A26*(k2*k2) + A45*(i2*i2))))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+3
                                k0v[c] += -L*cosa*j2*(A22 + A44)*(cosi2xa*cosk2xa*i2 - cosi2xb*cosk2xb*i2 + k2*sini2xa*sink2xa - k2*sini2xb*sink2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+4
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+0
                                k0v[c] += (pi*L*cosk2xb*r*sina*sini2xb*(B16*(k2*k2) + B26*(i2*i2)) + cosi2xa*i2*(pi*L*k2*r*sina*sink2xa*(B16 + B26) + cosk2xa*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*i2*(-pi*L*k2*r*sina*sink2xb*(B16 + B26) - cosk2xb*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) - k2*sini2xb*sink2xb*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)) + sini2xa*(-pi*L*cosk2xa*r*sina*(B16*(k2*k2) + B26*(i2*i2)) + k2*sink2xa*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+1
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+2
                                k0v[c] += (pi*B66*L*cosk2xb*r*sina*sini2xb*(-(i2*i2) + (k2*k2)) + cosi2xa*cosk2xa*i2*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(k2*k2)*(r*r)) - cosi2xb*cosk2xb*i2*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(k2*k2)*(r*r)) - k2*sini2xb*sink2xb*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r)) + sini2xa*(pi*B66*L*cosk2xa*r*sina*(i2 - k2)*(i2 + k2) + k2*sink2xa*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+3
                                k0v[c] += pi*B26*j2*(-2*cosi2xa*i2*k2*sink2xa + 2*cosi2xb*i2*k2*sink2xb + cosk2xa*sini2xa*((i2*i2) + (k2*k2)) - cosk2xb*sini2xb*((i2*i2) + (k2*k2)))/((i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+4
            ...
            for k2 in range(i0, m2+i0):
                for l2 in range(j0, n2+j0):
                    ...
                    if k2==i2 and l2==j2:
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+5
                        k0v[c] += -A26*L*j2*k2*((-1)**(i2 + k2) - 1)/(r*(-(i2*i2) + (k2*k2)))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+7
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+8
                        k0v[c] += k2*((-1)**(i2 + k2) - 1)*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2*j2))/(L*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+0
                        k0v[c] += pi*A16*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+5
                        k0v[c] += -L*j2*k2*((-1)**(i2 + k2) - 1)*(A22 + A44)/(r*(-(i2*i2) + (k2*k2)))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+7
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+8
                        k0v[c] += k2*((-1)**(i2 + k2) - 1)*(B22*(L*L)*(j2*j2) + r*(-A44*(L*L) + (pi*pi)*B66*(i2*i2)*r))/(L*r*(i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += pi*j2*((-1)**(i2 + k2) - 1)*(A12*(k2*k2) + A66*(i2*i2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+3
                        k0c[c] = col+9
                        k0v[c] += k2*((-1)**(i2 + k2) - 1)*(B22*(L*L)*(j2*j2) + r*(-A44*(L*L) + (pi*pi)*B66*(i2*i2)*r))/(L*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+1
                        k0v[c] += A26*L*i2*j2*((-1)**(i2 + k2) - 1)/(r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+3
                        k0v[c] += L*i2*j2*((-1)**(i2 + k2) - 1)*(A22 + A44)/(r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+5
                        ...
                        k0r[c] = row+5
                        k0c[c] = col+9
                        k0v[c] += -pi*i2*k2*((-1)**(i2 + k2) - 1)*(-A45*r + B26)/((i2*i2) - (k2*k2))
                        c += 1
                        k0r[c] = row+6
                        k0c[c] = col+1
                        k0v[c] += -pi*B16*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+8
                        k0c[c] = col+0
                        k0v[c] += -i2*((-1)**(i2 + k2) - 1)*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2*j2))/(L*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+8
                        k0c[c] = col+2
                        k0v[c] += -i2*((-1)**(i2 + k2) - 1)*(-A44*(L*L)*r + B22*(L*L)*(j2*j2) + (pi*pi)*B66*(k2*k2)*(r*r))/(L*r*((i2*i2) - (k2*k2)))
                        c += 1
                        k0r[c] = row+8
                        k0c[c] = col+4
                        k0v[c] += pi*i2*k2*((-1)**(i2 + k2) - 1)*(-A45*r + B26)/((i2 - k2)*(i2 + k2))
