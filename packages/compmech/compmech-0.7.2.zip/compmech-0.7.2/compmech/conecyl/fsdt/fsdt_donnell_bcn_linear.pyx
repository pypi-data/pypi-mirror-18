                        ...
                        for l2 in range(j0, n2+j0):
                            ...
                            if k2==i2 and l2==j2:
                                if i2!=0:
                                    ...
                                    k0r[c] = row+0
                                    k0c[c] = col+6
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(2*pi*B12*L*i2*r*sina*sini2xaxb - cosi2xaxb*(-(pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2)))) - 2*pi*i2*(xa - xb)*((pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2))))/((L*L)*i2*r)
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+8
                                    k0v[c] += 0.5*(L*sini2xa_xb*(pi*L*i2*r*sina*sini2xaxb*(-B16 + B26) + cosi2xaxb*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(-(j2*j2) + (sina*sina)))) - pi*i2*(xa - xb)*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)))/((L*L)*i2*r)
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+9
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+4
                                    k0v[c] += 0.5*(pi*A26*cosa*i2*sina*(xa - xb) + cosa*sini2xa_xb*(A26*L*cosi2xaxb*sina + pi*i2*r*sini2xaxb*(A26 - A45)))/(i2*r)
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+5
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+6
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(pi*L*i2*r*sina*sini2xaxb*(-B16 + B26) + cosi2xaxb*(B26*(L*L)*(-(j2*j2) + (sina*sina)) + r*(A45*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) - 2*pi*i2*(xa - xb)*(B26*(L*L)*(j2 - sina)*(j2 + sina) + r*(-A45*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r)))/((L*L)*i2*r)
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+7
                                    k0v[c] += 0.25*j2*(pi*cos2i2xa*i2*r*(-B12 + B66) + pi*cos2i2xb*i2*r*(B12 - B66) + sina*(B22 + B66)*(L*(-sin2i2xa + sin2i2xb) + 2*pi*i2*(-xa + xb)))/(i2*r)
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+8
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(-2*pi*B66*L*i2*r*sina*sini2xaxb + cosi2xaxb*(A44*(L*L)*cosa*r - B22*(L*L)*(j2*j2) + B66*(-L*sina + pi*i2*r)*(L*sina + pi*i2*r))) - 2*pi*i2*(xa - xb)*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r)))/((L*L)*i2*r)
                                    c += 1
                                    k0r[c] = row+3
                                    k0c[c] = col+0
                                    k0v[c] += 0.25*j2*(pi*cos2i2xa*i2*r*(A12 - A66) + pi*cos2i2xb*i2*r*(-A12 + A66) + sina*(A22 + A66)*(L*(sin2i2xa - sin2i2xb) + 2*pi*i2*(xa - xb)))/(i2*r)
                                    ...
                                    k0r[c] = row+4
                                    k0c[c] = col+6
                                    k0v[c] += 0.5*(pi*B22*cosa*i2*sina*(-xa + xb) + sini2xa_xb*(-B22*L*cosa*cosi2xaxb*sina + pi*i2*r*sini2xaxb*(A55*r + B12*cosa)))/(i2*r)
                                    c += 1
                                    k0r[c] = row+4
                                    k0c[c] = col+7
                                    k0v[c] += 0.25*j2*(-A45*r + B26*cosa)*(L*sin2i2xa - L*sin2i2xb + 2*pi*i2*(xa - xb))/(i2*r)
                                    c += 1
                                    k0r[c] = row+4
                                    k0c[c] = col+8
                                    ...
                                    k0r[c] = row+6
                                    k0c[c] = col+8
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(pi*L*i2*r*sina*sini2xaxb*(-D16 + D26) + cosi2xaxb*(D26*(L*L)*(-(j2*j2) + (sina*sina)) + (r*r)*(-A45*(L*L) + (pi*pi)*D16*(i2*i2)))) - 2*pi*i2*(xa - xb)*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(i2*i2))))/((L*L)*i2*r)
                                    c += 1
                                    k0r[c] = row+6
                                    k0c[c] = col+9
                                    k0v[c] += 0.25*j2*(pi*cos2i2xa*i2*r*(D12 - D66) + pi*cos2i2xb*i2*r*(-D12 + D66) + sina*(D22 + D66)*(L*(sin2i2xa - sin2i2xb) + 2*pi*i2*(xa - xb)))/(i2*r)
                                    c += 1
                                    k0r[c] = row+7
                                    k0c[c] = col+1
                                    k0v[c] += 0.25*(2*L*sini2xa_xb*(2*pi*B12*L*i2*r*sina*sini2xaxb - cosi2xaxb*(-(pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2)))) - 2*pi*i2*(xa - xb)*((pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2))))/((L*L)*i2*r)
                                    ...
                                    k0r[c] = row+0
                                    k0c[c] = col+6
                                    k0v[c] += pi*(-xa + xb)*(B22*(sina*sina) + B66*(j2*j2))/r
                                    c += 1
                                    k0r[c] = row+0
                                    k0c[c] = col+8
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+2
                                    k0v[c] += pi*(-xa + xb)*(A22*(j2*j2) + A44*(cosa*cosa) + A66*(sina*sina))/r
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+4
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+5
                                    k0v[c] += pi*cosa*j2*(A22 + A44)*(-xa + xb)/r
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+6
                                    k0v[c] += pi*(xa - xb)*(A45*cosa*r + B26*(-(j2*j2) + (sina*sina)))/r
                                    c += 1
                                    k0r[c] = row+2
                                    k0c[c] = col+7
                                    k0v[c] += pi*j2*sina*(B22 + B66)*(-xa + xb)/r
                                    ...
                                    k0r[c] = row+2
                                    k0c[c] = col+8
                                    k0v[c] += pi*(-xa + xb)*(-A44*cosa*r + B22*(j2*j2) + B66*(sina*sina))/r
                                    c += 1
                                    k0r[c] = row+3
                                    k0c[c] = col+0
                                    k0v[c] += pi*j2*sina*(A22 + A66)*(xa - xb)/r
                                    ...
                                    k0r[c] = row+4
                                    k0c[c] = col+4
                                    k0v[c] += pi*(-xa + xb)*(A22*(cosa*cosa) + A44*(j2*j2))/r
                                    c += 1
                                    k0r[c] = row+4
                                    k0c[c] = col+6
                                    ...
                                    k0r[c] = row+6
                                    k0c[c] = col+8
                                    k0v[c] += pi*(-xa + xb)*(A45*(r*r) + D26*(j2 - sina)*(j2 + sina))/r
                                    c += 1
                                    k0r[c] = row+6
                                    k0c[c] = col+9
                                    ...
                                    k0r[c] = row+8
                                    k0c[c] = col+8
                                    k0v[c] += pi*(-xa + xb)*(A44*(r*r) + D22*(j2*j2) + D66*(sina*sina))/r
                                    c += 1
                                    k0r[c] = row+9
                                    k0c[c] = col+0
                                    k0v[c] += pi*j2*sina*(B22 + B66)*(xa - xb)/r
                                ...
                                k0r[c] = row+0
                                k0c[c] = col+4
                                k0v[c] += cosa*(cosi2xa*(-pi*A12*cosk2xa*(i2*i2)*r + A22*L*k2*sina*sink2xa) + cosk2xb*i2*(pi*A12*cosi2xb*i2*r + A22*L*sina*sini2xb) - i2*sini2xa*(pi*A12*k2*r*sink2xa + A22*L*cosk2xa*sina) + k2*sink2xb*(pi*A12*i2*r*sini2xb - A22*L*cosi2xb*sina))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+5
                                k0v[c] += A26*L*cosa*j2*(cosi2xa*k2*sink2xa - cosi2xb*k2*sink2xb - cosk2xa*i2*sini2xa + cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+6
                                k0v[c] += (cosi2xa*(pi*B12*L*cosk2xa*r*sina*(-(i2*i2) + (k2*k2)) + k2*sink2xa*((pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2)))) + cosi2xb*(pi*B12*L*cosk2xb*r*sina*(i2 - k2)*(i2 + k2) - k2*sink2xb*((pi*pi)*B11*(i2*i2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2)))) + i2*(-cosk2xa*sini2xa + cosk2xb*sini2xb)*((pi*pi)*B11*(k2*k2)*(r*r) + (L*L)*(B22*(sina*sina) + B66*(j2*j2))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+7
                                k0v[c] += pi*B16*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+8
                                k0v[c] += (cosi2xa*(pi*L*cosk2xa*r*sina*(B16*(i2*i2) + B26*(k2*k2)) + k2*sink2xa*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) - cosi2xb*(pi*L*cosk2xb*r*sina*(B16*(i2*i2) + B26*(k2*k2)) + k2*sink2xb*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + i2*(pi*L*k2*r*sina*sini2xa*sink2xa*(B16 + B26) - cosk2xa*sini2xa*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)) + sini2xb*(-pi*L*k2*r*sina*sink2xb*(B16 + B26) + cosk2xb*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+0
                                k0c[c] = col+9
                                k0v[c] += j2*(cosi2xa*(-L*k2*sina*sink2xa*(B22 + B66) + pi*cosk2xa*r*(B12*(i2*i2) + B66*(k2*k2))) + cosi2xb*(L*k2*sina*sink2xb*(B22 + B66) - pi*cosk2xb*r*(B12*(i2*i2) + B66*(k2*k2))) + i2*(L*cosk2xa*sina*sini2xa*(B22 + B66) + pi*k2*r*sini2xa*sink2xa*(B12 + B66) - sini2xb*(L*cosk2xb*sina*(B22 + B66) + pi*k2*r*sink2xb*(B12 + B66))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+1
                                k0c[c] = col+0
                                k0v[c] += -pi*A16*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+2
                                k0v[c] += (cosi2xa*(pi*A66*L*cosk2xa*r*sina*(i2 - k2)*(i2 + k2) + k2*sink2xa*((pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A44*(cosa*cosa) + A66*(sina*sina)))) - cosi2xb*(pi*A66*L*cosk2xb*r*sina*(i2 - k2)*(i2 + k2) + k2*sink2xb*((pi*pi)*A66*(i2*i2)*(r*r) + (L*L)*(A22*(j2*j2) + A44*(cosa*cosa) + A66*(sina*sina)))) - i2*(cosk2xa*sini2xa - cosk2xb*sini2xb)*((pi*pi)*A66*(k2*k2)*(r*r) + (L*L)*(A22*(j2*j2) + A44*(cosa*cosa) + A66*(sina*sina))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+3
                                ...
                                k0r[c] = row+2
                                k0c[c] = col+4
                                k0v[c] += -cosa*(cosi2xa*(A26*L*k2*sina*sink2xa + pi*cosk2xa*r*(A26*(i2*i2) + A45*(k2*k2))) - cosi2xb*(A26*L*k2*sina*sink2xb + pi*cosk2xb*r*(A26*(i2*i2) + A45*(k2*k2))) + i2*(-A26*L*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(A26 + A45) + sini2xb*(A26*L*cosk2xb*sina - pi*k2*r*sink2xb*(A26 + A45))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+5
                                k0v[c] += L*cosa*j2*(A22 + A44)*(cosi2xa*k2*sink2xa - cosi2xb*k2*sink2xb - cosk2xa*i2*sini2xa + cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+6
                                k0v[c] += (cosi2xa*(-pi*L*cosk2xa*r*sina*(B16*(k2*k2) + B26*(i2*i2)) + k2*sink2xa*(B26*(L*L)*(j2 - sina)*(j2 + sina) + r*(-A45*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) + cosi2xb*(pi*L*cosk2xb*r*sina*(B16*(k2*k2) + B26*(i2*i2)) + k2*sink2xb*(B26*(L*L)*(-(j2*j2) + (sina*sina)) + r*(A45*(L*L)*cosa - (pi*pi)*B16*(i2*i2)*r))) + i2*(pi*L*k2*r*sina*sini2xb*sink2xb*(B16 + B26) + cosk2xb*sini2xb*(B26*(L*L)*(j2 - sina)*(j2 + sina) + r*(-A45*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r)) + sini2xa*(-pi*L*k2*r*sina*sink2xa*(B16 + B26) + cosk2xa*(B26*(L*L)*(-(j2*j2) + (sina*sina)) + r*(A45*(L*L)*cosa - (pi*pi)*B16*(k2*k2)*r)))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+7
                                k0v[c] += j2*(cosi2xa*(L*k2*sina*sink2xa*(B22 + B66) + pi*cosk2xa*r*(B12*(k2*k2) + B66*(i2*i2))) - cosi2xb*(L*k2*sina*sink2xb*(B22 + B66) + pi*cosk2xb*r*(B12*(k2*k2) + B66*(i2*i2))) + i2*(-L*cosk2xa*sina*sini2xa*(B22 + B66) + pi*k2*r*sini2xa*sink2xa*(B12 + B66) + sini2xb*(L*cosk2xb*sina*(B22 + B66) - pi*k2*r*sink2xb*(B12 + B66))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+8
                                k0v[c] += (cosi2xa*(pi*B66*L*cosk2xa*r*sina*(i2 - k2)*(i2 + k2) + k2*sink2xa*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r))) + cosi2xb*(pi*B66*L*cosk2xb*r*sina*(-(i2*i2) + (k2*k2)) - k2*sink2xb*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(i2*i2)*(r*r))) + i2*(-cosk2xa*sini2xa + cosk2xb*sini2xb)*(-A44*(L*L)*cosa*r + B22*(L*L)*(j2*j2) + B66*(L*L)*(sina*sina) + (pi*pi)*B66*(k2*k2)*(r*r)))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+2
                                k0c[c] = col+9
                                k0v[c] += pi*B26*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                c += 1
                                k0r[c] = row+3
                                k0c[c] = col+0
                                k0v[c] += j2*(-cosi2xa*(L*k2*sina*sink2xa*(A22 + A66) + pi*cosk2xa*r*(A12*(k2*k2) + A66*(i2*i2))) + cosi2xb*(L*k2*sina*sink2xb*(A22 + A66) + pi*cosk2xb*r*(A12*(k2*k2) + A66*(i2*i2))) + i2*(L*cosk2xa*sina*sini2xa*(A22 + A66) - pi*k2*r*sini2xa*sink2xa*(A12 + A66) + sini2xb*(-L*cosk2xb*sina*(A22 + A66) + pi*k2*r*sink2xb*(A12 + A66))))/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+4
                                k0c[c] = col+0
                                k0v[c] += cosa*(cosi2xa*k2*(pi*A12*cosk2xa*k2*r + A22*L*sina*sink2xa) - cosi2xb*k2*(pi*A12*cosk2xb*k2*r + A22*L*sina*sink2xb) + i2*(sini2xa*(pi*A12*k2*r*sink2xa - A22*L*cosk2xa*sina) + sini2xb*(-pi*A12*k2*r*sink2xb + A22*L*cosk2xb*sina)))/(r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+1
                                k0v[c] += A26*L*cosa*j2*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+4
                                k0c[c] = col+2
                                k0v[c] += cosa*(cosi2xa*(-A26*L*k2*sina*sink2xa + pi*cosk2xa*r*(A26*(k2*k2) + A45*(i2*i2))) - cosi2xb*(-A26*L*k2*sina*sink2xb + pi*cosk2xb*r*(A26*(k2*k2) + A45*(i2*i2))) + i2*(A26*L*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(A26 + A45) - sini2xb*(A26*L*cosk2xb*sina + pi*k2*r*sink2xb*(A26 + A45))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+3
                                k0v[c] += L*cosa*j2*(A22 + A44)*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+4
                                k0c[c] = col+4
                                k0v[c] += (cosi2xa*k2*sink2xa*((pi*pi)*A55*(i2*i2)*(r*r) + (L*L)*(A22*(cosa*cosa) + A44*(j2*j2))) - cosi2xb*k2*sink2xb*((pi*pi)*A55*(i2*i2)*(r*r) + (L*L)*(A22*(cosa*cosa) + A44*(j2*j2))) - cosk2xa*i2*sini2xa*((pi*pi)*A55*(k2*k2)*(r*r) + (L*L)*(A22*(cosa*cosa) + A44*(j2*j2))) + cosk2xb*i2*sini2xb*((pi*pi)*A55*(k2*k2)*(r*r) + (L*L)*(A22*(cosa*cosa) + A44*(j2*j2))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+5
                                k0v[c] += pi*A45*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+6
                                k0v[c] += (cosi2xa*(B22*L*cosa*k2*sina*sink2xa + pi*cosk2xa*r*(-A55*(i2*i2)*r + B12*cosa*(k2*k2))) - cosi2xb*(B22*L*cosa*k2*sina*sink2xb + pi*cosk2xb*r*(-A55*(i2*i2)*r + B12*cosa*(k2*k2))) + i2*(-B22*L*cosa*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(-A55*r + B12*cosa) + sini2xb*(B22*L*cosa*cosk2xb*sina + pi*k2*r*sink2xb*(A55*r - B12*cosa))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+7
                                k0v[c] += L*j2*(-A45*r + B26*cosa)*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+8
                                k0v[c] += (cosi2xa*(-B26*L*cosa*k2*sina*sink2xa + pi*cosk2xa*r*(-A45*(i2*i2)*r + B26*cosa*(k2*k2))) + cosi2xb*(B26*L*cosa*k2*sina*sink2xb + pi*cosk2xb*r*(A45*(i2*i2)*r - B26*cosa*(k2*k2))) + i2*(B26*L*cosa*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(-A45*r + B26*cosa) - sini2xb*(B26*L*cosa*cosk2xb*sina + pi*k2*r*sink2xb*(-A45*r + B26*cosa))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+4
                                k0c[c] = col+9
                                k0v[c] += L*j2*(-A44*r + B22*cosa)*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+5
                                k0c[c] = col+0
                                k0v[c] += A26*L*cosa*j2*(cosi2xa*k2*sink2xa - cosi2xb*k2*sink2xb - cosk2xa*i2*sini2xa + cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+6
                                k0c[c] = col+2
                                k0v[c] += (cosi2xa*(pi*L*cosk2xa*r*sina*(B16*(i2*i2) + B26*(k2*k2)) + k2*sink2xa*(B26*(L*L)*(j2 - sina)*(j2 + sina) + r*(-A45*(L*L)*cosa + (pi*pi)*B16*(i2*i2)*r))) + cosi2xb*(-pi*L*cosk2xb*r*sina*(B16*(i2*i2) + B26*(k2*k2)) + k2*sink2xb*(B26*(L*L)*(-(j2*j2) + (sina*sina)) + r*(A45*(L*L)*cosa - (pi*pi)*B16*(i2*i2)*r))) + i2*(-pi*L*k2*r*sina*sini2xb*sink2xb*(B16 + B26) + cosk2xb*sini2xb*(B26*(L*L)*(j2 - sina)*(j2 + sina) + r*(-A45*(L*L)*cosa + (pi*pi)*B16*(k2*k2)*r)) + sini2xa*(pi*L*k2*r*sina*sink2xa*(B16 + B26) + cosk2xa*(B26*(L*L)*(-(j2*j2) + (sina*sina)) + r*(A45*(L*L)*cosa - (pi*pi)*B16*(k2*k2)*r)))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+6
                                k0c[c] = col+3
                                k0v[c] += j2*(cosi2xa*(-L*k2*sina*sink2xa*(B22 + B66) + pi*cosk2xa*r*(B12*(i2*i2) + B66*(k2*k2))) + cosi2xb*(L*k2*sina*sink2xb*(B22 + B66) - pi*cosk2xb*r*(B12*(i2*i2) + B66*(k2*k2))) + i2*(L*cosk2xa*sina*sini2xa*(B22 + B66) + pi*k2*r*sini2xa*sink2xa*(B12 + B66) - sini2xb*(L*cosk2xb*sina*(B22 + B66) + pi*k2*r*sink2xb*(B12 + B66))))/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+6
                                k0c[c] = col+4
                                k0v[c] += (cosi2xa*(B22*L*cosa*k2*sina*sink2xa + pi*cosk2xa*r*(A55*(k2*k2)*r - B12*cosa*(i2*i2))) + cosi2xb*(-B22*L*cosa*k2*sina*sink2xb + pi*cosk2xb*r*(-A55*(k2*k2)*r + B12*cosa*(i2*i2))) + i2*(-B22*L*cosa*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(A55*r - B12*cosa) + sini2xb*(B22*L*cosa*cosk2xb*sina + pi*k2*r*sink2xb*(-A55*r + B12*cosa))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+6
                                k0c[c] = col+5
                                k0v[c] += L*j2*(A45*r - B26*cosa)*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+6
                                k0c[c] = col+8
                                k0v[c] += (cosi2xa*(pi*L*cosk2xa*r*sina*(D16*(i2*i2) + D26*(k2*k2)) + k2*sink2xa*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(i2*i2)))) - cosi2xb*(pi*L*cosk2xb*r*sina*(D16*(i2*i2) + D26*(k2*k2)) + k2*sink2xb*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(i2*i2)))) + i2*(pi*L*k2*r*sina*sini2xa*sink2xa*(D16 + D26) - cosk2xa*sini2xa*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(k2*k2))) + sini2xb*(-pi*L*k2*r*sina*sink2xb*(D16 + D26) + cosk2xb*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(k2*k2))))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+6
                                k0c[c] = col+9
                                k0v[c] += j2*(cosi2xa*(-L*k2*sina*sink2xa*(D22 + D66) + pi*cosk2xa*r*(D12*(i2*i2) + D66*(k2*k2))) + cosi2xb*(L*k2*sina*sink2xb*(D22 + D66) - pi*cosk2xb*r*(D12*(i2*i2) + D66*(k2*k2))) + i2*(L*cosk2xa*sina*sini2xa*(D22 + D66) + pi*k2*r*sini2xa*sink2xa*(D12 + D66) - sini2xb*(L*cosk2xb*sina*(D22 + D66) + pi*k2*r*sink2xb*(D12 + D66))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+7
                                k0c[c] = col+0
                                k0v[c] += -pi*B16*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+0
                                k0v[c] += (cosi2xa*(-pi*L*cosk2xa*r*sina*(B16*(k2*k2) + B26*(i2*i2)) + k2*sink2xa*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + cosi2xb*(pi*L*cosk2xb*r*sina*(B16*(k2*k2) + B26*(i2*i2)) - k2*sink2xb*((pi*pi)*B16*(i2*i2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina))) + i2*(pi*L*k2*r*sina*sini2xb*sink2xb*(B16 + B26) + cosk2xb*sini2xb*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)) + sini2xa*(-pi*L*k2*r*sina*sink2xa*(B16 + B26) - cosk2xa*((pi*pi)*B16*(k2*k2)*(r*r) + B26*(L*L)*(j2 - sina)*(j2 + sina)))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+1
                                k0v[c] += j2*(cosi2xa*(L*k2*sina*sink2xa*(B22 + B66) + pi*cosk2xa*r*(B12*(k2*k2) + B66*(i2*i2))) - cosi2xb*(L*k2*sina*sink2xb*(B22 + B66) + pi*cosk2xb*r*(B12*(k2*k2) + B66*(i2*i2))) + i2*(-L*cosk2xa*sina*sini2xa*(B22 + B66) + pi*k2*r*sini2xa*sink2xa*(B12 + B66) + sini2xb*(L*cosk2xb*sina*(B22 + B66) - pi*k2*r*sink2xb*(B12 + B66))))/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+4
                                k0v[c] += (-cosi2xa*(B26*L*cosa*k2*sina*sink2xa + pi*cosk2xa*r*(-A45*(k2*k2)*r + B26*cosa*(i2*i2))) + cosi2xb*(B26*L*cosa*k2*sina*sink2xb + pi*cosk2xb*r*(-A45*(k2*k2)*r + B26*cosa*(i2*i2))) + i2*(B26*L*cosa*cosk2xa*sina*sini2xa + pi*k2*r*sini2xa*sink2xa*(A45*r - B26*cosa) - sini2xb*(B26*L*cosa*cosk2xb*sina + pi*k2*r*sink2xb*(A45*r - B26*cosa))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+5
                                k0v[c] += L*j2*(A44*r - B22*cosa)*(-cosi2xa*k2*sink2xa + cosi2xb*k2*sink2xb + cosk2xa*i2*sini2xa - cosk2xb*i2*sini2xb)/(r*((i2*i2) - (k2*k2)))
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+6
                                k0v[c] += (cosi2xa*(-pi*L*cosk2xa*r*sina*(D16*(k2*k2) + D26*(i2*i2)) + k2*sink2xa*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(i2*i2)))) + cosi2xb*(pi*L*cosk2xb*r*sina*(D16*(k2*k2) + D26*(i2*i2)) - k2*sink2xb*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(i2*i2)))) + i2*(pi*L*k2*r*sina*sini2xb*sink2xb*(D16 + D26) + cosk2xb*sini2xb*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(k2*k2))) + sini2xa*(-pi*L*k2*r*sina*sink2xa*(D16 + D26) - cosk2xa*(D26*(L*L)*(j2 - sina)*(j2 + sina) + (r*r)*(A45*(L*L) + (pi*pi)*D16*(k2*k2))))))/(L*r*(i2 - k2)*(i2 + k2))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+7
                                k0v[c] += j2*(cosi2xa*(L*k2*sina*sink2xa*(D22 + D66) + pi*cosk2xa*r*(D12*(k2*k2) + D66*(i2*i2))) - cosi2xb*(L*k2*sina*sink2xb*(D22 + D66) + pi*cosk2xb*r*(D12*(k2*k2) + D66*(i2*i2))) + i2*(-L*cosk2xa*sina*sini2xa*(D22 + D66) + pi*k2*r*sini2xa*sink2xa*(D12 + D66) + sini2xb*(L*cosk2xb*sina*(D22 + D66) - pi*k2*r*sink2xb*(D12 + D66))))/(r*((i2*i2) - (k2*k2)))
                                c += 1
                                k0r[c] = row+8
                                k0c[c] = col+8
                                ...
                                k0r[c] = row+8
                                k0c[c] = col+9
                                k0v[c] += pi*D26*j2*(cosi2xa*cosk2xa*((i2*i2) + (k2*k2)) - cosi2xb*cosk2xb*((i2*i2) + (k2*k2)) + 2*i2*k2*(sini2xa*sink2xa - sini2xb*sink2xb))/((i2*i2) - (k2*k2))
                                c += 1
                                k0r[c] = row+9
                                k0c[c] = col+0
                                k0v[c] += j2*(-cosi2xa*(L*k2*sina*sink2xa*(B22 + B66) + pi*cosk2xa*r*(B12*(k2*k2) + B66*(i2*i2))) + cosi2xb*(L*k2*sina*sink2xb*(B22 + B66) + pi*cosk2xb*r*(B12*(k2*k2) + B66*(i2*i2))) + i2*(L*cosk2xa*sina*sini2xa*(B22 + B66) - pi*k2*r*sini2xa*sink2xa*(B12 + B66) + sini2xb*(-L*cosk2xb*sina*(B22 + B66) + pi*k2*r*sink2xb*(B12 + B66))))/(r*((i2*i2) - (k2*k2)))
                ...
                for l2 in range(j0, n2+j0):
                    ...
                    if k2==i2 and l2==j2:
                        if i2!=0:
                            ...
                            k0r[c] = row+0
                            k0c[c] = col+6
                            k0v[c] += 0.5*(pi*pi*pi)*B11*(i2*i2)*r/L + 0.5*pi*B66*L*(j2*j2)/r
                            c += 1
                            k0r[c] = row+0
                            k0c[c] = col+8
                            k0v[c] += 0.5*(pi*pi*pi)*B16*(i2*i2)*r/L + 0.5*pi*B26*L*(j2*j2)/r
                            c += 1
                            k0r[c] = row+1
                            k0c[c] = col+1
                            k0v[c] += 0.5*(pi*pi*pi)*A11*(i2*i2)*r/L + 0.5*pi*A66*L*(j2*j2)/r
                            ...
                            k0r[c] = row+2
                            k0c[c] = col+2
                            k0v[c] += 0.5*(pi*pi*pi)*A66*(i2*i2)*r/L + 0.5*pi*L*(A22*(j2*j2) + A44)/r
                            c += 1
                            k0r[c] = row+2
                            k0c[c] = col+5
                            ...
                            k0r[c] = row+2
                            k0c[c] = col+6
                            k0v[c] += 0.5*pi*(-A45*(L*L) + (pi*pi)*B16*(i2*i2)*r + B26*(L*L)*(j2*j2)/r)/L
                            c += 1
                            k0r[c] = row+2
                            k0c[c] = col+8
                            k0v[c] += 0.5*pi*(-A44*(L*L) + B22*(L*L)*(j2*j2)/r + (pi*pi)*B66*(i2*i2)*r)/L
                            c += 1
                            k0r[c] = row+3
                            k0c[c] = col+1
                            k0v[c] += 0.5*(pi*pi*pi)*A16*(i2*i2)*r/L + 0.5*pi*A26*L*(j2*j2)/r
                            ...
                            k0r[c] = row+4
                            k0c[c] = col+4
                            k0v[c] += 0.5*(pi*pi*pi)*A55*(i2*i2)*r/L + 0.5*pi*L*(A22 + A44*(j2*j2))/r
                            c += 1
                            k0r[c] = row+4
                            k0c[c] = col+7
                            ...
                            k0r[c] = row+6
                            k0c[c] = col+6
                            k0v[c] += 0.5*pi*D66*L*(j2*j2)/r + 0.5*pi*r*(A55*(L*L) + (pi*pi)*D11*(i2*i2))/L
                            c += 1
                            k0r[c] = row+6
                            k0c[c] = col+8
                            k0v[c] += 0.5*pi*D26*L*(j2*j2)/r + 0.5*pi*r*(A45*(L*L) + (pi*pi)*D16*(i2*i2))/L
                            c += 1
                            k0r[c] = row+7
                            k0c[c] = col+1
                            k0v[c] += 0.5*(pi*pi*pi)*B11*(i2*i2)*r/L + 0.5*pi*B66*L*(j2*j2)/r
                            ...
                            k0r[c] = row+8
                            k0c[c] = col+8
                            k0v[c] += 0.5*pi*D22*L*(j2*j2)/r + 0.5*pi*r*(A44*(L*L) + (pi*pi)*D66*(i2*i2))/L
                            c += 1
                            k0r[c] = row+9
                            k0c[c] = col+1
                            k0v[c] += 0.5*(pi*pi*pi)*B16*(i2*i2)*r/L + 0.5*pi*B26*L*(j2*j2)/r
                            ...
                            k0r[c] = row+0
                            k0c[c] = col+6
                            k0v[c] += pi*B66*L*(j2*j2)/r
                            c += 1
                            k0r[c] = row+0
                            k0c[c] = col+8
                            k0v[c] += pi*B26*L*(j2*j2)/r
                            c += 1
                            k0r[c] = row+1
                            k0c[c] = col+1
                            k0v[c] += pi*A66*L*(j2*j2)/r
                            ...
                            k0r[c] = row+2
                            k0c[c] = col+2
                            k0v[c] += pi*L*(A22*(j2*j2) + A44)/r
                            c += 1
                            k0r[c] = row+2
                            k0c[c] = col+5
                            k0v[c] += pi*L*j2*(A22 + A44)/r
                            c += 1
                            k0r[c] = row+2
                            k0c[c] = col+6
                            k0v[c] += pi*L*(-A45 + B26*(j2*j2)/r)
                            c += 1
                            k0r[c] = row+2
                            k0c[c] = col+8
                            k0v[c] += pi*L*(-A44 + B22*(j2*j2)/r)
                            c += 1
                            k0r[c] = row+3
                            k0c[c] = col+1
                            k0v[c] += pi*A26*L*(j2*j2)/r
                            ...
                            k0r[c] = row+4
                            k0c[c] = col+4
                            k0v[c] += pi*L*(A22 + A44*(j2*j2))/r
                            c += 1
                            k0r[c] = row+4
                            k0c[c] = col+7
                            k0v[c] += pi*L*j2*(A45*r - B26)/r
                            c += 1
                            k0r[c] = row+4
                            k0c[c] = col+9
                            k0v[c] += pi*L*j2*(A44*r - B22)/r
                            c += 1
                            k0r[c] = row+5
                            k0c[c] = col+0
                            k0v[c] += pi*A26*L*j2/r
                            ...
                            k0r[c] = row+6
                            k0c[c] = col+8
                            k0v[c] += L*(pi*A45*r + pi*D26*(j2*j2)/r)
                            c += 1
                            k0r[c] = row+7
                            k0c[c] = col+1
                            k0v[c] += pi*B66*L*(j2*j2)/r
                            ...
                            k0r[c] = row+8
                            k0c[c] = col+8
                            k0v[c] += L*(pi*A44*r + pi*D22*(j2*j2)/r)
                            c += 1
                            k0r[c] = row+9
                            k0c[c] = col+1
                            k0v[c] += pi*B26*L*(j2*j2)/r
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+4
                        k0v[c] += pi*A12*(i2*i2)*((-1)**(i2 + k2) - 1)/((i2*i2) - (k2*k2))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+7
                        k0v[c] += -pi*B16*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+9
                        k0v[c] += -pi*j2*((-1)**(i2 + k2) - 1)*(B12*(i2*i2) + B66*(k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+0
                        k0v[c] += pi*A16*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+4
                        k0v[c] += pi*((-1)**(i2 + k2) - 1)*(A26*(i2*i2) + A45*(k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+7
                        k0v[c] += -pi*j2*((-1)**(i2 + k2) - 1)*(B12*(k2*k2) + B66*(i2*i2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+9
                        k0v[c] += -pi*B26*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += pi*j2*((-1)**(i2 + k2) - 1)*(A12*(k2*k2) + A66*(i2*i2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+4
                        k0c[c] = col+0
                        k0v[c] += pi*A12*(k2*k2)*((-1)**(i2 + k2) - 1)/(-(i2*i2) + (k2*k2))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+2
                        k0v[c] += -pi*((-1)**(i2 + k2) - 1)*(A26*(k2*k2) + A45*(i2*i2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+5
                        k0v[c] += -pi*A45*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+6
                        k0v[c] += pi*((-1)**(i2 + k2) - 1)*(A55*(i2*i2)*r - B12*(k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+8
                        k0v[c] += pi*((-1)**(i2 + k2) - 1)*(A45*(i2*i2)*r - B26*(k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+5
                        k0c[c] = col+1
                        k0v[c] += pi*A12*(k2*k2)*((-1)**(i2 + k2) - 1)/(-(i2*i2) + (k2*k2))
                        ...
                        k0r[c] = row+6
                        k0c[c] = col+4
                        k0v[c] += pi*((-1)**(i2 + k2) - 1)*(-A55*(k2*k2)*r + B12*(i2*i2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+6
                        k0c[c] = col+7
                        ...
                        k0r[c] = row+6
                        k0c[c] = col+9
                        k0v[c] += -pi*j2*((-1)**(i2 + k2) - 1)*(D12*(i2*i2) + D66*(k2*k2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+7
                        k0c[c] = col+0
                        k0v[c] += pi*B16*j2*((-1)**(i2 + k2) - 1)*((i2*i2) + (k2*k2))/((i2 - k2)*(i2 + k2))
                        ...
                        k0r[c] = row+8
                        k0c[c] = col+4
                        k0v[c] += pi*((-1)**(i2 + k2) - 1)*(-A45*(k2*k2)*r + B26*(i2*i2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+8
                        k0c[c] = col+7
                        k0v[c] += -pi*j2*((-1)**(i2 + k2) - 1)*(D12*(k2*k2) + D66*(i2*i2))/((i2 - k2)*(i2 + k2))
                        c += 1
                        k0r[c] = row+8
                        k0c[c] = col+9
