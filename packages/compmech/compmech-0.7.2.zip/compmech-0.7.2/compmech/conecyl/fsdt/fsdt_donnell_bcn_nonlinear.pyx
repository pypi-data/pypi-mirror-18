...
from compmech.conecyl.fsdt.fsdt_commons_bcn cimport cfwx, cfwt, cfN
    ...
    for i in range(npts):
        ...
        for k2 in range(i0, m2+i0):
            ...
            for l2 in range(j0, n2+j0):
                ...
                # q_2
                q0004 = -pi*k2*sink2x*sinl2t*(w0x + wx)/L
                q0005 = -pi*cosl2t*k2*sink2x*(w0x + wx)/L
                q0104 = cosk2x*cosl2t*l2*(w0t + wt)/(r*r)
                q0105 = -cosk2x*l2*sinl2t*(w0t + wt)/(r*r)
                q0204 = (L*cosk2x*cosl2t*l2*(w0x + wx) - pi*k2*sink2x*sinl2t*(w0t + wt))/(L*r)
                q0205 = -(L*cosk2x*l2*sinl2t*(w0x + wx) + pi*cosl2t*k2*sink2x*(w0t + wt))/(L*r)
        ...
        for i2 in range(i0, m2+i0):
            ...
            for j2 in range(j0, n2+j0):
                ...
                # p_2
                p0000 = -pi*A11*i2*r*sini2x*sinj2t/L + cosi2x*(A12*sina*sinj2t + A16*cosj2t*j2)
                p0001 = -pi*A12*i2*r*sini2x*sinj2t/L + cosi2x*(A22*sina*sinj2t + A26*cosj2t*j2)
                p0002 = -pi*A16*i2*r*sini2x*sinj2t/L + cosi2x*(A26*sina*sinj2t + A66*cosj2t*j2)
                p0100 = -pi*A11*cosj2t*i2*r*sini2x/L + cosi2x*(A12*cosj2t*sina - A16*j2*sinj2t)
                p0101 = -pi*A12*cosj2t*i2*r*sini2x/L + cosi2x*(A22*cosj2t*sina - A26*j2*sinj2t)
                p0102 = -pi*A16*cosj2t*i2*r*sini2x/L + cosi2x*(A26*cosj2t*sina - A66*j2*sinj2t)
                ...
                p0400 = A12*cosa*cosi2x*sinj2t
                p0401 = A22*cosa*cosi2x*sinj2t
                p0402 = A26*cosa*cosi2x*sinj2t
                p0500 = A12*cosa*cosi2x*cosj2t
                p0501 = A22*cosa*cosi2x*cosj2t
                p0502 = A26*cosa*cosi2x*cosj2t
                ...
                p0800 = -pi*B16*i2*r*sini2x*sinj2t/L + cosi2x*(B12*cosj2t*j2 - B16*sina*sinj2t)
                p0801 = -pi*B26*i2*r*sini2x*sinj2t/L + cosi2x*(B22*cosj2t*j2 - B26*sina*sinj2t)
                p0802 = -pi*B66*i2*r*sini2x*sinj2t/L + cosi2x*(B26*cosj2t*j2 - B66*sina*sinj2t)
                p0900 = -pi*B16*cosj2t*i2*r*sini2x/L - cosi2x*(B12*j2*sinj2t + B16*cosj2t*sina)
                p0901 = -pi*B26*cosj2t*i2*r*sini2x/L - cosi2x*(B22*j2*sinj2t + B26*cosj2t*sina)
                p0902 = -pi*B66*cosj2t*i2*r*sini2x/L - cosi2x*(B26*j2*sinj2t + B66*cosj2t*sina)
    ...
    for i in range(npts):
        ...
        for k2 in range(i0, m2+i0):
            ...
            for l2 in range(j0, n2+j0):
                ...
                # q_2
                q0004 = -pi*k2*sink2x*sinl2t/L
                q0005 = -pi*cosl2t*k2*sink2x/L
                q0104 = cosk2x*cosl2t*l2/r
                q0105 = -cosk2x*l2*sinl2t/r
        ...
        for i2 in range(i0, m2+i0):
            ...
            for j2 in range(j0, n2+j0):
                ...
                # p_2
                p0400 = Nxt*cosi2x*cosj2t*j2 - pi*Nxx*i2*r*sini2x*sinj2t/L
                p0401 = Ntt*cosi2x*cosj2t*j2 - pi*Nxt*i2*r*sini2x*sinj2t/L
    ...
    for i in range(npts):
        ...
        for i2 in range(i0, m2+i0):
            ...
            for j2 in range(j0, n2+j0):
                ...
                # p_2
                p0400 = cosi2x*cosj2t*j2*(A12*(w0t + wt) + A16*r*(w0x + wx))/r - pi*i2*sini2x*sinj2t*(A11*r*(w0x + wx) + A16*(w0t + wt))/L
                p0401 = cosi2x*cosj2t*j2*(A22*(w0t + wt) + A26*r*(w0x + wx))/r - pi*i2*sini2x*sinj2t*(A12*r*(w0x + wx) + A26*(w0t + wt))/L
                p0402 = cosi2x*cosj2t*j2*(A26*(w0t + wt) + A66*r*(w0x + wx))/r - pi*i2*sini2x*sinj2t*(A16*r*(w0x + wx) + A66*(w0t + wt))/L
                p0500 = -(L*cosi2x*j2*sinj2t*(A12*(w0t + wt) + A16*r*(w0x + wx)) + pi*cosj2t*i2*r*sini2x*(A11*r*(w0x + wx) + A16*(w0t + wt)))/(L*r)
    ...
    for i in range(npts):
        ...
        for j2 in range(j0, n2+j0):
            ...
            for i2 in range(i0, m2+i0):
                ...
                exxL += (c[col+4]*(-pi*i2*sini2x*sinj2t*w0x/L - 0.5*pi*i2*sini2x*sinj2t*wx/L)
                         +c[col+5]*(-pi*cosj2t*i2*sini2x*w0x/L - 0.5*pi*cosj2t*i2*sini2x*wx/L))

                ett0 += (c[col+0]*cosi2x*sina*sinj2t/r
                         +c[col+1]*cosi2x*cosj2t*sina/r
                         +c[col+2]*cosi2x*cosj2t*j2/r
                         -c[col+3]*cosi2x*j2*sinj2t/r
                         +c[col+4]*cosa*cosi2x*sinj2t/r
                         +c[col+5]*cosa*cosi2x*cosj2t/r)
                ettL += (c[col+4]*(cosi2x*cosj2t*j2*w0t/(r*r) + 0.5*cosi2x*cosj2t*j2*wt/(r*r))
                         +c[col+5]*(-cosi2x*j2*sinj2t*w0t/(r*r) - 0.5*cosi2x*j2*sinj2t*wt/(r*r)))
                ...
                gxtL += (c[col+4]*(cosi2x*cosj2t*j2*w0x/r + 0.5*cosi2x*cosj2t*j2*wx/r - pi*i2*sini2x*sinj2t*w0t/(L*r) - 0.5*pi*i2*sini2x*sinj2t*wt/(L*r))
                         +c[col+5]*(-cosi2x*j2*sinj2t*w0x/r - 0.5*cosi2x*j2*sinj2t*wx/r - pi*cosj2t*i2*sini2x*w0t/(L*r) - 0.5*pi*cosj2t*i2*sini2x*wt/(L*r)))
                ...
                gxz0 += (-pi*c[col+4]*i2*sini2x*sinj2t/L
        ...
        for j2 in range(j0, n2+j0):
            ...
            for i2 in range(i0, m2+i0):
                ...
                fint[col+4] = beta*(fint[col+4]) + alpha*((L*cosi2x*cosj2t*j2*(Ntt0*(w0t + wt) + NttL*w0t + NttL*wt + Nxt0*r*w0x + Nxt0*r*wx + NxtL*r*w0x + NxtL*r*wx + QtL*r) - r*sinj2t*(-L*NttL*cosa*cosi2x + pi*i2*sini2x*(Nxt0*(w0t + wt) + NxtL*w0t + NxtL*wt + Nxx0*r*w0x + Nxx0*r*wx + NxxL*r*w0x + NxxL*r*wx + QxL*r)))/(L*r))
                fint[col+5] = beta*(fint[col+5]) + alpha*(-(L*cosi2x*j2*sinj2t*(Ntt0*(w0t + wt) + NttL*w0t + NttL*wt + Nxt0*r*w0x + Nxt0*r*wx + NxtL*r*w0x + NxtL*r*wx + QtL*r) + cosj2t*r*(-L*NttL*cosa*cosi2x + pi*i2*sini2x*(Nxt0*(w0t + wt) + NxtL*w0t + NxtL*wt + Nxx0*r*w0x + Nxx0*r*wx + NxxL*r*w0x + NxxL*r*wx + QxL*r)))/(L*r))
                ...
                fint[col+8] = beta*(fint[col+8]) + alpha*((L*MttL*cosi2x*cosj2t*j2 + sinj2t*(L*cosi2x*(-MxtL*sina + QtL*r) - pi*MxtL*i2*r*sini2x))/L)
                fint[col+9] = beta*(fint[col+9]) + alpha*((-L*MttL*cosi2x*j2*sinj2t + cosj2t*(L*cosi2x*(-MxtL*sina + QtL*r) - pi*MxtL*i2*r*sini2x))/L)
