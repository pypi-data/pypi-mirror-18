...
# Upload to PyPI by running setup.py build_py sdist bdist upload with a correctly set up ~/.pypirc (need HOME variable set correctly on Windows)

with open("lib" + os.sep + "version.py", "w") as fd:
