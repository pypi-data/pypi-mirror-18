...
setup(
    ...
    url=u'https://bitbucket.org/davisowb/configurationutil.git',  # Use the url to the git repo
    download_url=u'https://bitbucket.org/davisowb/'
                 u'configurationutil.git/get/{version}.tar'.format(version=VERSION),
    ...
    description=u"An easy to use config manager.",
