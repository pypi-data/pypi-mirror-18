...
class PropState(object):
  ...
  def slot(self, value):
    self._slot = msgbuffers.validate_integer(
      'PropState.slot', value, 0, 255)

  @property
  def x(self):
    "int_8 x struct property."
    return self._x

  @x.setter
  def x(self, value):
    self._x = msgbuffers.validate_integer(
      'PropState.x', value, -128, 127)

  @property
  def y(self):
    "int_8 y struct property."
    return self._y

  @y.setter
  def y(self, value):
    self._y = msgbuffers.validate_integer(
      'PropState.y', value, -128, 127)

  @property
  def z(self):
    "int_8 z struct property."
    return self._z

  @z.setter
  def z(self, value):
    self._z = msgbuffers.validate_integer(
      'PropState.z', value, -128, 127)

  @property
  def shockCount(self):
    "uint_8 shockCount struct property."
    return self._shockCount

  @shockCount.setter
  def shockCount(self, value):
    self._shockCount = msgbuffers.validate_integer(
      'PropState.shockCount', value, 0, 255)
  ...
  def tapNeg(self, value):
    self._tapNeg = msgbuffers.validate_integer(
      'PropState.tapNeg', value, -128, 127)
  ...
  def tapPos(self, value):
    self._tapPos = msgbuffers.validate_integer(
      'PropState.tapPos', value, -128, 127)

  def __init__(self, slot=0, x=0, y=0, z=0, shockCount=0, tapTime=0, tapNeg=0, tapPos=0):
    self.slot = slot
    self.x = x
    self.y = y
    self.z = z
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new PropState from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('PropState.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new PropState from the given BinaryReader."
    _slot = reader.read('B')
    _x = reader.read('b')
    _y = reader.read('b')
    _z = reader.read('b')
    _shockCount = reader.read('B')
    _tapTime = reader.read('B')
    _tapNeg = reader.read('b')
    _tapPos = reader.read('b')
    return cls(_slot, _x, _y, _z, _shockCount, _tapTime, _tapNeg, _tapPos)

  def pack(self):
    "Writes the current PropState, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current PropState to the given BinaryWriter."
    writer.write(self._slot, 'B')
    writer.write(self._x, 'b')
    writer.write(self._y, 'b')
    writer.write(self._z, 'b')
    writer.write(self._shockCount, 'B')
    writer.write(self._tapTime, 'B')
    writer.write(self._tapNeg, 'b')
    writer.write(self._tapPos, 'b')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._slot == other._slot and
        self._x == other._x and
        self._y == other._y and
        self._z == other._z and
        self._shockCount == other._shockCount and
        self._tapTime == other._tapTime and
        self._tapNeg == other._tapNeg and
        self._tapPos == other._tapPos)
    else:
  ...
  def __len__(self):
    return (msgbuffers.size(self._slot, 'B') +
      msgbuffers.size(self._x, 'b') +
      msgbuffers.size(self._y, 'b') +
      msgbuffers.size(self._z, 'b') +
      msgbuffers.size(self._shockCount, 'B') +
      msgbuffers.size(self._tapTime, 'B') +
      msgbuffers.size(self._tapNeg, 'b') +
      msgbuffers.size(self._tapPos, 'b'))

  def __str__(self):
    return '{type}(slot={slot}, x={x}, y={y}, z={z}, shockCount={shockCount}, tapTime={tapTime}, tapNeg={tapNeg}, tapPos={tapPos})'.format(
      type=type(self).__name__,
      slot=self._slot,
      x=self._x,
      y=self._y,
      z=self._z,
      shockCount=self._shockCount,
      tapTime=self._tapTime,
      tapNeg=self._tapNeg,
      tapPos=self._tapPos)
  ...
  def __repr__(self):
    return '{type}(slot={slot}, x={x}, y={y}, z={z}, shockCount={shockCount}, tapTime={tapTime}, tapNeg={tapNeg}, tapPos={tapPos})'.format(
      ...
      y=repr(self._y),
      z=repr(self._z),
      shockCount=repr(self._shockCount),
      tapTime=repr(self._tapTime),
      tapNeg=repr(self._tapNeg),
      tapPos=repr(self._tapPos))

Anki.Cozmo.PropState = PropState
del PropState
