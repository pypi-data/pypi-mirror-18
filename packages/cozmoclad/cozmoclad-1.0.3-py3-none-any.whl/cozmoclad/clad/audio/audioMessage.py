...
class PostAudioSwitchState(object):
  ...
  def __init__(self, switchStateGroup=Anki.Cozmo.Audio.SwitchState.SwitchGroupType.External, switchStateValue=Anki.Cozmo.Audio.SwitchState.GenericSwitch.Invalid, gameObject=Anki.Cozmo.Audio.GameObjectType.Invalid):
