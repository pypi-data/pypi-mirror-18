...
class PlayAnimationTrigger(object):
  ...
  def __init__(self, robotID=0, numLoops=0, trigger=Anki.Cozmo.AnimationTrigger.AcknowledgeFaceInitPause, useLiftSafe=False):
    self.robotID = robotID
    self.numLoops = numLoops
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_robotID, _numLoops, _trigger, _useLiftSafe)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._robotID == other._robotID and
        ...
        self._useLiftSafe == other._useLiftSafe)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, numLoops={numLoops}, trigger={trigger}, useLiftSafe={useLiftSafe})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
      numLoops=self._numLoops,
...
class RollObject(object):
  ...
  def __init__(self, objectID=0, motionProf=Anki.Cozmo.PathMotionProfile(), approachAngle_rad=0.0, doDeepRoll=False, useApproachAngle=False, usePreDockPose=False, useManualSpeed=False):
    self.objectID = objectID
    self.motionProf = motionProf
    self.approachAngle_rad = approachAngle_rad
  ...
  def unpack_from(cls, reader):
    ...
    _usePreDockPose = bool(reader.read('b'))
    _useManualSpeed = bool(reader.read('b'))
    return cls(_objectID, _motionProf, _approachAngle_rad, _doDeepRoll, _useApproachAngle, _usePreDockPose, _useManualSpeed)
  ...
  def __str__(self):
    return '{type}(objectID={objectID}, motionProf={motionProf}, approachAngle_rad={approachAngle_rad}, doDeepRoll={doDeepRoll}, useApproachAngle={useApproachAngle}, usePreDockPose={usePreDockPose}, useManualSpeed={useManualSpeed})'.format(
      type=type(self).__name__,
      objectID=self._objectID,
      motionProf=self._motionProf,
      approachAngle_rad=self._approachAngle_rad,
...
class SayText(object):
  ...
  def __init__(self, text='', playEvent=Anki.Cozmo.AnimationTrigger.AcknowledgeFaceInitPause, voiceStyle=Anki.Cozmo.SayTextVoiceStyle.UnProcessed, durationScalar=1.0, voicePitch=0.0):
    self.text = text
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_text, _playEvent, _voiceStyle, _durationScalar, _voicePitch)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._text == other._text and
        ...
        self._voicePitch == other._voicePitch)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(text={text}, playEvent={playEvent}, voiceStyle={voiceStyle}, durationScalar={durationScalar}, voicePitch={voicePitch})'.format(
      type=type(self).__name__,
...
class SayTextWithIntent(object):
  ...
  def __init__(self, text='', playEvent=Anki.Cozmo.AnimationTrigger.AcknowledgeFaceInitPause, intent=Anki.Cozmo.SayTextIntent.UnProcessed):
    self.text = text
    self.playEvent = playEvent
    self.intent = intent
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_text, _playEvent, _intent)
  ...
  def __str__(self):
    return '{type}(text={text}, playEvent={playEvent}, intent={intent})'.format(
      type=type(self).__name__,
      text=msgbuffers.shorten_string(self._text),
      playEvent=self._playEvent,
      intent=self._intent)
...
class SearchForNearbyObject(object):
  ...
  def __init__(self, desiredObjectID=-1):
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return self._desiredObjectID == other._desiredObjectID
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(desiredObjectID={desiredObjectID})'.format(
      type=type(self).__name__,
...
class TurnTowardsFace(object):
  ...
  def __init__(self, faceID=0, maxTurnAngle_rad=0.0, maxPanSpeed_radPerSec=0.0, panAccel_radPerSec2=0.0, panTolerance_rad=0.0, maxTiltSpeed_radPerSec=0.0, tiltAccel_radPerSec2=0.0, tiltTolerance_rad=0.0, sayName=False, robotID=0):
    self.faceID = faceID
  ...
  def unpack_from(cls, reader):
    ...
    _robotID = reader.read('B')
    return cls(_faceID, _maxTurnAngle_rad, _maxPanSpeed_radPerSec, _panAccel_radPerSec2, _panTolerance_rad, _maxTiltSpeed_radPerSec, _tiltAccel_radPerSec2, _tiltTolerance_rad, _sayName, _robotID)
  ...
  def __str__(self):
    return '{type}(faceID={faceID}, maxTurnAngle_rad={maxTurnAngle_rad}, maxPanSpeed_radPerSec={maxPanSpeed_radPerSec}, panAccel_radPerSec2={panAccel_radPerSec2}, panTolerance_rad={panTolerance_rad}, maxTiltSpeed_radPerSec={maxTiltSpeed_radPerSec}, tiltAccel_radPerSec2={tiltAccel_radPerSec2}, tiltTolerance_rad={tiltTolerance_rad}, sayName={sayName}, robotID={robotID})'.format(
      type=type(self).__name__,
      faceID=self._faceID,
...
class TurnTowardsLastFacePose(object):
  ...
  def __init__(self, maxTurnAngle_rad=0.0, maxPanSpeed_radPerSec=0.0, panAccel_radPerSec2=0.0, panTolerance_rad=0.0, maxTiltSpeed_radPerSec=0.0, tiltAccel_radPerSec2=0.0, tiltTolerance_rad=0.0, sayName=False, robotID=0):
    self.maxTurnAngle_rad = maxTurnAngle_rad
    self.maxPanSpeed_radPerSec = maxPanSpeed_radPerSec
    self.panAccel_radPerSec2 = panAccel_radPerSec2
    self.panTolerance_rad = panTolerance_rad
  ...
  def unpack_from(cls, reader):
    ...
    _sayName = bool(reader.read('b'))
    _robotID = reader.read('B')
    return cls(_maxTurnAngle_rad, _maxPanSpeed_radPerSec, _panAccel_radPerSec2, _panTolerance_rad, _maxTiltSpeed_radPerSec, _tiltAccel_radPerSec2, _tiltTolerance_rad, _sayName, _robotID)
  ...
  def __str__(self):
    return '{type}(maxTurnAngle_rad={maxTurnAngle_rad}, maxPanSpeed_radPerSec={maxPanSpeed_radPerSec}, panAccel_radPerSec2={panAccel_radPerSec2}, panTolerance_rad={panTolerance_rad}, maxTiltSpeed_radPerSec={maxTiltSpeed_radPerSec}, tiltAccel_radPerSec2={tiltAccel_radPerSec2}, tiltTolerance_rad={tiltTolerance_rad}, sayName={sayName}, robotID={robotID})'.format(
      type=type(self).__name__,
      maxTurnAngle_rad=self._maxTurnAngle_rad,
      maxPanSpeed_radPerSec=self._maxPanSpeed_radPerSec,
      panAccel_radPerSec2=self._panAccel_radPerSec2,
...
class RobotActionUnion(object):
  ...
  class Tag(object):
    ...
    displayFaceImage        = 1  # Anki.Cozmo.ExternalInterface.DisplayFaceImage
    displayProceduralFace   = 2  # Anki.Cozmo.ExternalInterface.DisplayProceduralFace
    driveOffChargerContacts = 3  # Anki.Cozmo.ExternalInterface.DriveOffChargerContacts
    driveStraight           = 4  # Anki.Cozmo.ExternalInterface.DriveStraight
    enrollNamedFace         = 5  # Anki.Cozmo.ExternalInterface.EnrollNamedFace
    flipBlock               = 6  # Anki.Cozmo.ExternalInterface.FlipBlock
    gotoObject              = 7  # Anki.Cozmo.ExternalInterface.GotoObject
    gotoPose                = 8  # Anki.Cozmo.ExternalInterface.GotoPose
    mountCharger            = 9  # Anki.Cozmo.ExternalInterface.MountCharger
    panAndTilt              = 10 # Anki.Cozmo.ExternalInterface.PanAndTilt
    pickupObject            = 11 # Anki.Cozmo.ExternalInterface.PickupObject
    placeObjectOnGround     = 12 # Anki.Cozmo.ExternalInterface.PlaceObjectOnGround
    placeObjectOnGroundHere = 13 # Anki.Cozmo.ExternalInterface.PlaceObjectOnGroundHere
    placeOnObject           = 14 # Anki.Cozmo.ExternalInterface.PlaceOnObject
    placeRelObject          = 15 # Anki.Cozmo.ExternalInterface.PlaceRelObject
    playAnimation           = 16 # Anki.Cozmo.ExternalInterface.PlayAnimation
    playAnimationTrigger    = 17 # Anki.Cozmo.ExternalInterface.PlayAnimationTrigger
    popAWheelie             = 18 # Anki.Cozmo.ExternalInterface.PopAWheelie
    readToolCode            = 19 # Anki.Cozmo.ExternalInterface.ReadToolCode
    realignWithObject       = 20 # Anki.Cozmo.ExternalInterface.RealignWithObject
    rollObject              = 21 # Anki.Cozmo.ExternalInterface.RollObject
    sayText                 = 22 # Anki.Cozmo.ExternalInterface.SayText
    sayTextWithIntent       = 23 # Anki.Cozmo.ExternalInterface.SayTextWithIntent
    searchForNearbyObject   = 24 # Anki.Cozmo.ExternalInterface.SearchForNearbyObject
    setHeadAngle            = 25 # Anki.Cozmo.ExternalInterface.SetHeadAngle
    setLiftHeight           = 26 # Anki.Cozmo.ExternalInterface.SetLiftHeight
    trackFace               = 27 # Anki.Cozmo.ExternalInterface.TrackToFace
    trackObject             = 28 # Anki.Cozmo.ExternalInterface.TrackToObject
    traverseObject          = 29 # Anki.Cozmo.ExternalInterface.TraverseObject
    turnInPlace             = 30 # Anki.Cozmo.ExternalInterface.TurnInPlace
    turnTowardsFace         = 31 # Anki.Cozmo.ExternalInterface.TurnTowardsFace
    turnTowardsLastFacePose = 32 # Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose
    turnTowardsObject       = 33 # Anki.Cozmo.ExternalInterface.TurnTowardsObject
    turnTowardsPose         = 34 # Anki.Cozmo.ExternalInterface.TurnTowardsPose
    visuallyVerifyFace      = 35 # Anki.Cozmo.ExternalInterface.VisuallyVerifyFace
    visuallyVerifyObject    = 36 # Anki.Cozmo.ExternalInterface.VisuallyVerifyObject
    wait                    = 37 # Anki.Cozmo.ExternalInterface.Wait
    waitForImages           = 38 # Anki.Cozmo.ExternalInterface.WaitForImages
    count                   = 39 # uint_8
  ...
  _tags_by_name = dict(
    alignWithObject=0,
    displayFaceImage=1,
    displayProceduralFace=2,
    driveOffChargerContacts=3,
    driveStraight=4,
    enrollNamedFace=5,
    flipBlock=6,
    gotoObject=7,
    ...
    panAndTilt=10,
    pickupObject=11,
    placeObjectOnGround=12,
    placeObjectOnGroundHere=13,
    placeOnObject=14,
    placeRelObject=15,
    playAnimation=16,
    ...
    popAWheelie=18,
    readToolCode=19,
    realignWithObject=20,
    rollObject=21,
    sayText=22,
    sayTextWithIntent=23,
    searchForNearbyObject=24,
    setHeadAngle=25,
    setLiftHeight=26,
    trackFace=27,
    trackObject=28,
    ...
    turnInPlace=30,
    turnTowardsFace=31,
    turnTowardsLastFacePose=32,
    turnTowardsObject=33,
    turnTowardsPose=34,
    visuallyVerifyFace=35,
    visuallyVerifyObject=36,
    wait=37,
    waitForImages=38,
    count=39,
  )
  ...
  _tags_by_value[1] = 'displayFaceImage'
  _tags_by_value[2] = 'displayProceduralFace'
  _tags_by_value[3] = 'driveOffChargerContacts'
  _tags_by_value[4] = 'driveStraight'
  _tags_by_value[5] = 'enrollNamedFace'
  _tags_by_value[6] = 'flipBlock'
  _tags_by_value[7] = 'gotoObject'
  _tags_by_value[8] = 'gotoPose'
  _tags_by_value[9] = 'mountCharger'
  _tags_by_value[10] = 'panAndTilt'
  _tags_by_value[11] = 'pickupObject'
  _tags_by_value[12] = 'placeObjectOnGround'
  _tags_by_value[13] = 'placeObjectOnGroundHere'
  _tags_by_value[14] = 'placeOnObject'
  _tags_by_value[15] = 'placeRelObject'
  _tags_by_value[16] = 'playAnimation'
  _tags_by_value[17] = 'playAnimationTrigger'
  _tags_by_value[18] = 'popAWheelie'
  _tags_by_value[19] = 'readToolCode'
  _tags_by_value[20] = 'realignWithObject'
  _tags_by_value[21] = 'rollObject'
  _tags_by_value[22] = 'sayText'
  _tags_by_value[23] = 'sayTextWithIntent'
  _tags_by_value[24] = 'searchForNearbyObject'
  _tags_by_value[25] = 'setHeadAngle'
  _tags_by_value[26] = 'setLiftHeight'
  _tags_by_value[27] = 'trackFace'
  _tags_by_value[28] = 'trackObject'
  _tags_by_value[29] = 'traverseObject'
  _tags_by_value[30] = 'turnInPlace'
  _tags_by_value[31] = 'turnTowardsFace'
  _tags_by_value[32] = 'turnTowardsLastFacePose'
  _tags_by_value[33] = 'turnTowardsObject'
  _tags_by_value[34] = 'turnTowardsPose'
  _tags_by_value[35] = 'visuallyVerifyFace'
  _tags_by_value[36] = 'visuallyVerifyObject'
  _tags_by_value[37] = 'wait'
  _tags_by_value[38] = 'waitForImages'
  _tags_by_value[39] = 'count'
  ...
  _tag_unpack_methods[1] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisplayFaceImage.unpack_from)
  _tag_unpack_methods[2] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisplayProceduralFace.unpack_from)
  _tag_unpack_methods[3] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveOffChargerContacts.unpack_from)
  _tag_unpack_methods[4] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveStraight.unpack_from)
  _tag_unpack_methods[5] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnrollNamedFace.unpack_from)
  _tag_unpack_methods[6] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlipBlock.unpack_from)
  _tag_unpack_methods[7] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GotoObject.unpack_from)
  _tag_unpack_methods[8] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GotoPose.unpack_from)
  _tag_unpack_methods[9] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MountCharger.unpack_from)
  _tag_unpack_methods[10] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PanAndTilt.unpack_from)
  _tag_unpack_methods[11] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PickupObject.unpack_from)
  _tag_unpack_methods[12] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlaceObjectOnGround.unpack_from)
  _tag_unpack_methods[13] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlaceObjectOnGroundHere.unpack_from)
  _tag_unpack_methods[14] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlaceOnObject.unpack_from)
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlaceRelObject.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayAnimation.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayAnimationTrigger.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopAWheelie.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadToolCode.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RealignWithObject.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RollObject.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SayText.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SayTextWithIntent.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SearchForNearbyObject.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadAngle.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftHeight.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TrackToFace.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TrackToObject.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TraverseObject.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnInPlace.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsFace.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsObject.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsPose.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisuallyVerifyFace.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisuallyVerifyObject.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.Wait.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WaitForImages.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read('B')
  ...
  _tag_pack_methods[39] = lambda writer, value: writer.write(value, 'B')
  ...
  _tag_size_methods[39] = lambda value: msgbuffers.size(value, 'B')
  

  _type_by_tag_value = dict()
  _type_by_tag_value[0] = lambda : Anki.Cozmo.ExternalInterface.AlignWithObject
  _type_by_tag_value[1] = lambda : Anki.Cozmo.ExternalInterface.DisplayFaceImage
  _type_by_tag_value[2] = lambda : Anki.Cozmo.ExternalInterface.DisplayProceduralFace
  _type_by_tag_value[3] = lambda : Anki.Cozmo.ExternalInterface.DriveOffChargerContacts
  _type_by_tag_value[4] = lambda : Anki.Cozmo.ExternalInterface.DriveStraight
  _type_by_tag_value[5] = lambda : Anki.Cozmo.ExternalInterface.EnrollNamedFace
  _type_by_tag_value[6] = lambda : Anki.Cozmo.ExternalInterface.FlipBlock
  _type_by_tag_value[7] = lambda : Anki.Cozmo.ExternalInterface.GotoObject
  _type_by_tag_value[8] = lambda : Anki.Cozmo.ExternalInterface.GotoPose
  _type_by_tag_value[9] = lambda : Anki.Cozmo.ExternalInterface.MountCharger
  _type_by_tag_value[10] = lambda : Anki.Cozmo.ExternalInterface.PanAndTilt
  _type_by_tag_value[11] = lambda : Anki.Cozmo.ExternalInterface.PickupObject
  _type_by_tag_value[12] = lambda : Anki.Cozmo.ExternalInterface.PlaceObjectOnGround
  _type_by_tag_value[13] = lambda : Anki.Cozmo.ExternalInterface.PlaceObjectOnGroundHere
  _type_by_tag_value[14] = lambda : Anki.Cozmo.ExternalInterface.PlaceOnObject
  _type_by_tag_value[15] = lambda : Anki.Cozmo.ExternalInterface.PlaceRelObject
  _type_by_tag_value[16] = lambda : Anki.Cozmo.ExternalInterface.PlayAnimation
  _type_by_tag_value[17] = lambda : Anki.Cozmo.ExternalInterface.PlayAnimationTrigger
  _type_by_tag_value[18] = lambda : Anki.Cozmo.ExternalInterface.PopAWheelie
  _type_by_tag_value[19] = lambda : Anki.Cozmo.ExternalInterface.ReadToolCode
  _type_by_tag_value[20] = lambda : Anki.Cozmo.ExternalInterface.RealignWithObject
  _type_by_tag_value[21] = lambda : Anki.Cozmo.ExternalInterface.RollObject
  _type_by_tag_value[22] = lambda : Anki.Cozmo.ExternalInterface.SayText
  _type_by_tag_value[23] = lambda : Anki.Cozmo.ExternalInterface.SayTextWithIntent
  _type_by_tag_value[24] = lambda : Anki.Cozmo.ExternalInterface.SearchForNearbyObject
  _type_by_tag_value[25] = lambda : Anki.Cozmo.ExternalInterface.SetHeadAngle
  _type_by_tag_value[26] = lambda : Anki.Cozmo.ExternalInterface.SetLiftHeight
  _type_by_tag_value[27] = lambda : Anki.Cozmo.ExternalInterface.TrackToFace
  _type_by_tag_value[28] = lambda : Anki.Cozmo.ExternalInterface.TrackToObject
  _type_by_tag_value[29] = lambda : Anki.Cozmo.ExternalInterface.TraverseObject
  _type_by_tag_value[30] = lambda : Anki.Cozmo.ExternalInterface.TurnInPlace
  _type_by_tag_value[31] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsFace
  _type_by_tag_value[32] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose
  _type_by_tag_value[33] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsObject
  _type_by_tag_value[34] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsPose
  _type_by_tag_value[35] = lambda : Anki.Cozmo.ExternalInterface.VisuallyVerifyFace
  _type_by_tag_value[36] = lambda : Anki.Cozmo.ExternalInterface.VisuallyVerifyObject
  _type_by_tag_value[37] = lambda : Anki.Cozmo.ExternalInterface.Wait
  _type_by_tag_value[38] = lambda : Anki.Cozmo.ExternalInterface.WaitForImages
  _type_by_tag_value[39] = lambda : int
