...
class RobotState(object):
  ...
  @property
  def rawGyroZ(self):
    "float_32 rawGyroZ struct property."
    return self._rawGyroZ

  @rawGyroZ.setter
  def rawGyroZ(self, value):
    self._rawGyroZ = msgbuffers.validate_float(
      'RobotState.rawGyroZ', value, 'f')

  @property
  def rawAccelY(self):
    "float_32 rawAccelY struct property."
    return self._rawAccelY

  @rawAccelY.setter
  def rawAccelY(self, value):
    self._rawAccelY = msgbuffers.validate_float(
      'RobotState.rawAccelY', value, 'f')
  ...
  def __init__(self, timestamp=0, pose_frame_id=0, pose_origin_id=0, pose=Anki.Cozmo.RobotPose(), lwheel_speed_mmps=0.0, rwheel_speed_mmps=0.0, headAngle=0.0, liftAngle=0.0, liftHeight=0.0, rawGyroZ=0.0, rawAccelY=0.0, batteryVoltage=0.0, status=0, lastPathID=0, cliffDataRaw=0, currPathSegment=0, numFreeSegmentSlots=0):
  ...
  def unpack_from(cls, reader):
    ...
    _rawGyroZ = reader.read('f')
    _rawAccelY = reader.read('f')
    ...
    return cls(_timestamp, _pose_frame_id, _pose_origin_id, _pose, _lwheel_speed_mmps, _rwheel_speed_mmps, _headAngle, _liftAngle, _liftHeight, _rawGyroZ, _rawAccelY, _batteryVoltage, _status, _lastPathID, _cliffDataRaw, _currPathSegment, _numFreeSegmentSlots)
  ...
  def pack_to(self, writer):
    ...
    writer.write(self._rawGyroZ, 'f')
    writer.write(self._rawAccelY, 'f')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._timestamp == other._timestamp and
        ...
        self._rawGyroZ == other._rawGyroZ and
        self._rawAccelY == other._rawAccelY and
  ...
  def __len__(self):
    return (msgbuffers.size(self._timestamp, 'I') +
      ...
      msgbuffers.size(self._rawGyroZ, 'f') +
      msgbuffers.size(self._rawAccelY, 'f') +
  ...
  def __str__(self):
    return '{type}(timestamp={timestamp}, pose_frame_id={pose_frame_id}, pose_origin_id={pose_origin_id}, pose={pose}, lwheel_speed_mmps={lwheel_speed_mmps}, rwheel_speed_mmps={rwheel_speed_mmps}, headAngle={headAngle}, liftAngle={liftAngle}, liftHeight={liftHeight}, rawGyroZ={rawGyroZ}, rawAccelY={rawAccelY}, batteryVoltage={batteryVoltage}, status={status}, lastPathID={lastPathID}, cliffDataRaw={cliffDataRaw}, currPathSegment={currPathSegment}, numFreeSegmentSlots={numFreeSegmentSlots})'.format(
      type=type(self).__name__,
      ...
      rawGyroZ=self._rawGyroZ,
      rawAccelY=self._rawAccelY,
  ...
  def __repr__(self):
    return '{type}(timestamp={timestamp}, pose_frame_id={pose_frame_id}, pose_origin_id={pose_origin_id}, pose={pose}, lwheel_speed_mmps={lwheel_speed_mmps}, rwheel_speed_mmps={rwheel_speed_mmps}, headAngle={headAngle}, liftAngle={liftAngle}, liftHeight={liftHeight}, rawGyroZ={rawGyroZ}, rawAccelY={rawAccelY}, batteryVoltage={batteryVoltage}, status={status}, lastPathID={lastPathID}, cliffDataRaw={cliffDataRaw}, currPathSegment={currPathSegment}, numFreeSegmentSlots={numFreeSegmentSlots})'.format(
      ...
      rawGyroZ=repr(self._rawGyroZ),
      rawAccelY=repr(self._rawAccelY),
