...
class MessageViz(object):
  ...
  class Tag(object):
    ...
    CarryStateUpdate             = 0  # Anki.Cozmo.CarryStateUpdate
    SetBodyRadioMode             = 1  # Anki.Cozmo.SetBodyRadioMode
    AnimationState               = 2  # Anki.Cozmo.RobotInterface.AnimationState
    ImageChunk                   = 3  # Anki.Cozmo.ImageChunk
    ImageImuData                 = 4  # Anki.Cozmo.ImageImuData
    CameraCalibration            = 5  # Anki.Cozmo.CameraCalibration
    SetVizOrigin                 = 6  # Anki.Cozmo.SetVizOrigin
    RobotStateMessage            = 7  # Anki.Cozmo.VizInterface.RobotStateMessage
    Object                       = 8  # Anki.Cozmo.VizInterface.Object
    SegmentPrimitive             = 9  # Anki.Cozmo.VizInterface.SegmentPrimitive
    Quad                         = 10 # Anki.Cozmo.VizInterface.Quad
    SimpleQuadVectorMessageBegin = 11 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin
    SimpleQuadVectorMessage      = 12 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessage
    SimpleQuadVectorMessageEnd   = 13 # Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd
    CameraQuad                   = 14 # Anki.Cozmo.VizInterface.CameraQuad
    CameraLine                   = 15 # Anki.Cozmo.VizInterface.CameraLine
    CameraOval                   = 16 # Anki.Cozmo.VizInterface.CameraOval
    CameraText                   = 17 # Anki.Cozmo.VizInterface.CameraText
    EraseObject                  = 18 # Anki.Cozmo.VizInterface.EraseObject
    EraseSegmentPrimitives       = 19 # Anki.Cozmo.VizInterface.EraseSegmentPrimitives
    EraseQuad                    = 20 # Anki.Cozmo.VizInterface.EraseQuad
    SetRobot                     = 21 # Anki.Cozmo.VizInterface.SetRobot
    AppendPathSegmentLine        = 22 # Anki.Cozmo.VizInterface.AppendPathSegmentLine
    AppendPathSegmentArc         = 23 # Anki.Cozmo.VizInterface.AppendPathSegmentArc
    SetPathColor                 = 24 # Anki.Cozmo.VizInterface.SetPathColor
    ErasePath                    = 25 # Anki.Cozmo.VizInterface.ErasePath
    DefineColor                  = 26 # Anki.Cozmo.VizInterface.DefineColor
    SetLabel                     = 27 # Anki.Cozmo.VizInterface.SetLabel
    DockingErrorSignal           = 28 # Anki.Cozmo.VizInterface.DockingErrorSignal
    VisionMarker                 = 29 # Anki.Cozmo.VizInterface.VisionMarker
    ShowObjects                  = 30 # Anki.Cozmo.VizInterface.ShowObjects
    TrackerQuad                  = 31 # Anki.Cozmo.VizInterface.TrackerQuad
    FaceDetection                = 32 # Anki.Cozmo.VizInterface.FaceDetection
    RobotMood                    = 33 # Anki.Cozmo.VizInterface.RobotMood
    RobotBehaviorSelectData      = 34 # Anki.Cozmo.VizInterface.RobotBehaviorSelectData
    NewBehaviorSelected          = 35 # Anki.Cozmo.VizInterface.NewBehaviorSelected
    StartRobotUpdate             = 36 # Anki.Cozmo.VizInterface.StartRobotUpdate
    EndRobotUpdate               = 37 # Anki.Cozmo.VizInterface.EndRobotUpdate
    SaveImages                   = 38 # Anki.Cozmo.VizInterface.SaveImages
    SaveState                    = 39 # Anki.Cozmo.VizInterface.SaveState
  ...
  _tags_by_name = dict(
    ...
    SegmentPrimitive=9,
    Quad=10,
    SimpleQuadVectorMessageBegin=11,
    SimpleQuadVectorMessage=12,
    SimpleQuadVectorMessageEnd=13,
    CameraQuad=14,
    CameraLine=15,
    CameraOval=16,
    CameraText=17,
    EraseObject=18,
    EraseSegmentPrimitives=19,
    EraseQuad=20,
    SetRobot=21,
    AppendPathSegmentLine=22,
    AppendPathSegmentArc=23,
    SetPathColor=24,
    ErasePath=25,
    DefineColor=26,
    SetLabel=27,
    DockingErrorSignal=28,
    VisionMarker=29,
    ShowObjects=30,
    TrackerQuad=31,
    FaceDetection=32,
    RobotMood=33,
    RobotBehaviorSelectData=34,
    NewBehaviorSelected=35,
    StartRobotUpdate=36,
    EndRobotUpdate=37,
    SaveImages=38,
    SaveState=39,
  ...
  _tags_by_value = dict()
  _tags_by_value[0] = 'CarryStateUpdate'
  _tags_by_value[1] = 'SetBodyRadioMode'
  _tags_by_value[2] = 'AnimationState'
  _tags_by_value[3] = 'ImageChunk'
  _tags_by_value[4] = 'ImageImuData'
  _tags_by_value[5] = 'CameraCalibration'
  _tags_by_value[6] = 'SetVizOrigin'
  _tags_by_value[7] = 'RobotStateMessage'
  _tags_by_value[8] = 'Object'
  _tags_by_value[9] = 'SegmentPrimitive'
  _tags_by_value[10] = 'Quad'
  _tags_by_value[11] = 'SimpleQuadVectorMessageBegin'
  _tags_by_value[12] = 'SimpleQuadVectorMessage'
  _tags_by_value[13] = 'SimpleQuadVectorMessageEnd'
  _tags_by_value[14] = 'CameraQuad'
  _tags_by_value[15] = 'CameraLine'
  _tags_by_value[16] = 'CameraOval'
  _tags_by_value[17] = 'CameraText'
  _tags_by_value[18] = 'EraseObject'
  _tags_by_value[19] = 'EraseSegmentPrimitives'
  _tags_by_value[20] = 'EraseQuad'
  _tags_by_value[21] = 'SetRobot'
  _tags_by_value[22] = 'AppendPathSegmentLine'
  _tags_by_value[23] = 'AppendPathSegmentArc'
  _tags_by_value[24] = 'SetPathColor'
  _tags_by_value[25] = 'ErasePath'
  _tags_by_value[26] = 'DefineColor'
  _tags_by_value[27] = 'SetLabel'
  _tags_by_value[28] = 'DockingErrorSignal'
  _tags_by_value[29] = 'VisionMarker'
  _tags_by_value[30] = 'ShowObjects'
  _tags_by_value[31] = 'TrackerQuad'
  _tags_by_value[32] = 'FaceDetection'
  _tags_by_value[33] = 'RobotMood'
  _tags_by_value[34] = 'RobotBehaviorSelectData'
  _tags_by_value[35] = 'NewBehaviorSelected'
  _tags_by_value[36] = 'StartRobotUpdate'
  _tags_by_value[37] = 'EndRobotUpdate'
  _tags_by_value[38] = 'SaveImages'
  _tags_by_value[39] = 'SaveState'
  

  _tag_unpack_methods = dict()
  _tag_unpack_methods[0] = lambda reader: reader.read_object(Anki.Cozmo.CarryStateUpdate.unpack_from)
  _tag_unpack_methods[1] = lambda reader: reader.read_object(Anki.Cozmo.SetBodyRadioMode.unpack_from)
  _tag_unpack_methods[2] = lambda reader: reader.read_object(Anki.Cozmo.RobotInterface.AnimationState.unpack_from)
  _tag_unpack_methods[3] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[4] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[5] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[6] = lambda reader: reader.read_object(Anki.Cozmo.SetVizOrigin.unpack_from)
  _tag_unpack_methods[7] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotStateMessage.unpack_from)
  _tag_unpack_methods[8] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.Object.unpack_from)
  _tag_unpack_methods[9] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SegmentPrimitive.unpack_from)
  _tag_unpack_methods[10] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.Quad.unpack_from)
  _tag_unpack_methods[11] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin.unpack_from)
  _tag_unpack_methods[12] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessage.unpack_from)
  _tag_unpack_methods[13] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd.unpack_from)
  _tag_unpack_methods[14] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraQuad.unpack_from)
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraLine.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraOval.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraText.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseObject.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseSegmentPrimitives.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetRobot.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentLine.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentArc.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetPathColor.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ErasePath.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DefineColor.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetLabel.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DockingErrorSignal.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.VisionMarker.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ShowObjects.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.TrackerQuad.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.FaceDetection.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotMood.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotBehaviorSelectData.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewBehaviorSelected.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.StartRobotUpdate.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EndRobotUpdate.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveImages.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveState.unpack_from)
  ...
  _type_by_tag_value[0] = lambda : Anki.Cozmo.CarryStateUpdate
  _type_by_tag_value[1] = lambda : Anki.Cozmo.SetBodyRadioMode
  _type_by_tag_value[2] = lambda : Anki.Cozmo.RobotInterface.AnimationState
  _type_by_tag_value[3] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[4] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[5] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[6] = lambda : Anki.Cozmo.SetVizOrigin
  _type_by_tag_value[7] = lambda : Anki.Cozmo.VizInterface.RobotStateMessage
  _type_by_tag_value[8] = lambda : Anki.Cozmo.VizInterface.Object
  _type_by_tag_value[9] = lambda : Anki.Cozmo.VizInterface.SegmentPrimitive
  _type_by_tag_value[10] = lambda : Anki.Cozmo.VizInterface.Quad
  _type_by_tag_value[11] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessageBegin
  _type_by_tag_value[12] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessage
  _type_by_tag_value[13] = lambda : Anki.Cozmo.VizInterface.SimpleQuadVectorMessageEnd
  _type_by_tag_value[14] = lambda : Anki.Cozmo.VizInterface.CameraQuad
  _type_by_tag_value[15] = lambda : Anki.Cozmo.VizInterface.CameraLine
  _type_by_tag_value[16] = lambda : Anki.Cozmo.VizInterface.CameraOval
  _type_by_tag_value[17] = lambda : Anki.Cozmo.VizInterface.CameraText
  _type_by_tag_value[18] = lambda : Anki.Cozmo.VizInterface.EraseObject
  _type_by_tag_value[19] = lambda : Anki.Cozmo.VizInterface.EraseSegmentPrimitives
  _type_by_tag_value[20] = lambda : Anki.Cozmo.VizInterface.EraseQuad
  _type_by_tag_value[21] = lambda : Anki.Cozmo.VizInterface.SetRobot
  _type_by_tag_value[22] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentLine
  _type_by_tag_value[23] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentArc
  _type_by_tag_value[24] = lambda : Anki.Cozmo.VizInterface.SetPathColor
  _type_by_tag_value[25] = lambda : Anki.Cozmo.VizInterface.ErasePath
  _type_by_tag_value[26] = lambda : Anki.Cozmo.VizInterface.DefineColor
  _type_by_tag_value[27] = lambda : Anki.Cozmo.VizInterface.SetLabel
  _type_by_tag_value[28] = lambda : Anki.Cozmo.VizInterface.DockingErrorSignal
  _type_by_tag_value[29] = lambda : Anki.Cozmo.VizInterface.VisionMarker
  _type_by_tag_value[30] = lambda : Anki.Cozmo.VizInterface.ShowObjects
  _type_by_tag_value[31] = lambda : Anki.Cozmo.VizInterface.TrackerQuad
  _type_by_tag_value[32] = lambda : Anki.Cozmo.VizInterface.FaceDetection
  _type_by_tag_value[33] = lambda : Anki.Cozmo.VizInterface.RobotMood
  _type_by_tag_value[34] = lambda : Anki.Cozmo.VizInterface.RobotBehaviorSelectData
  _type_by_tag_value[35] = lambda : Anki.Cozmo.VizInterface.NewBehaviorSelected
  _type_by_tag_value[36] = lambda : Anki.Cozmo.VizInterface.StartRobotUpdate
  _type_by_tag_value[37] = lambda : Anki.Cozmo.VizInterface.EndRobotUpdate
  _type_by_tag_value[38] = lambda : Anki.Cozmo.VizInterface.SaveImages
  _type_by_tag_value[39] = lambda : Anki.Cozmo.VizInterface.SaveState
