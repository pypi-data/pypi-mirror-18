...
class CPABuilder():
    ...
    def unify(self, acpp, bcpp,
        ...
        if handle_defaults:
            ...
            acpp = self.default_handler(acpp.getroot())
            bcpp = self.default_handler(bcpp.getroot())
    ...
    def unify_payload_parts(self, acppid, appid, app, bcppid, bppid,
                            bpp, abpp):
        ...
        if alen != blen:
            ...
            for c in range(0,alen):
                ...
                self.unify_payload_part(acppid,
                                        appid,
                                        appart,
                                        bcppid,
                                        bppid,
    ...
    def unify_payload_part(self, acppid, appid, appart, bcppid,
                           bppid, bppart, c, abpp):
