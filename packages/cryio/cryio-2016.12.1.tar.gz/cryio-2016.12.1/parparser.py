...
class ParParser:
    ...
    @property
    def dQ(self):
        return self._parstruct.dQ

    @dQ.setter
    def dQ(self, dQ):
        self._parstruct.dQ = dQ

    @property
    def x(self):
        return self._parstruct.x
    ...
    @property
    def lorentz(self):
        return self._parstruct.lorentz

    @lorentz.setter
    def lorentz(self, lorentz):
        self._parstruct.lorentz = lorentz

    @property
    def downsample(self):
        return self._parstruct.downsample

    @downsample.setter
    def downsample(self, downsample):
        self._parstruct.downsample = downsample
