...
class BaseConfig(_FlaskConfig, _AppExtensionsConfig):
    AVAILABLE_MODULES = ['index', 'health', 'debug_api', 'auth']
...
class ProductionConfig(BaseConfig):
    ...
    ENABLED_MODULES = filter(lambda x: x not in {'debug', 'debug_api'}, BaseConfig.AVAILABLE_MODULES)
    ENABLED_EXTENSIONS = filter(lambda x: x not in {'debug_api_ext'}, BaseConfig.AVAILABLE_EXTENSIONS)
