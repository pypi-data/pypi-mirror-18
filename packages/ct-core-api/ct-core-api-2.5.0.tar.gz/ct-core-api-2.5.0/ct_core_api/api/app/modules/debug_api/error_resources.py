...
from ct_core_api.common import import_utils as iu
...
class ErrorExceptionResource(APIResource):
    class PostParameters(PostFormParameters):
        exception_cls = ma.String(description="Example: flask_principal.PermissionDenied")
    ...
    def post(self, args):
        ...
        if args.get('exception_cls'):
            exception_cls = iu.import_module_by_import_path(args['exception_cls'])
