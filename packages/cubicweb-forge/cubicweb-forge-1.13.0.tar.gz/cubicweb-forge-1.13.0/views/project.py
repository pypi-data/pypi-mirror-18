...
from cubicweb.web.views import tabs, baseviews, tableview, idownloadable, uicfg
...
class ProjetListItemView(baseviews.SameETypeListItemView):
    ...
    def cell_call(self, row, col, **kwargs):
        ...
        updated = entity.printable_value('modification_date')
        if entity.icon:
        ...
        self.w(u'<p>')
        self.w(_(u'updated on: %s') % updated)
        self.w(u'</p>')
        self.w(u'</div>')
        if entity.summary:
