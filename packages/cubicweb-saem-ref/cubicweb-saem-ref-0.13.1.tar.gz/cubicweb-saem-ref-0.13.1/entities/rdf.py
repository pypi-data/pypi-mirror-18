...
class OrganizationUnitRDFListAdapter(AbstractRDFAdapter):
    __regid__ = 'RDFList'
    __select__ = is_instance('OrganizationUnit')

    def register_rdf_mapping(self, reg):
        _base_rdf_mapping(reg, self.entity.cw_etype, 'org:OrganizationUnit')
...
class OrganizationUnitRDFPrimaryAdapter(OrganizationUnitRDFListAdapter):
    __regid__ = 'RDFPrimary'
    __select__ = is_instance('OrganizationUnit')
...
class OrganizationRDFPrimaryAdapter(AbstractRDFAdapter):
    __regid__ = 'RDFPrimary'
    ...
    def register_rdf_mapping(self, reg):
        ...
        reg.register_etype_equivalence('Organization', 'org:Organization')
        reg.register_attribute_equivalence('Organization', 'name', 'dc:title')
        reg.register_attribute_equivalence(
            'Organization', 'eid', 'dc:identifier')
        reg.register_relation_equivalence(
