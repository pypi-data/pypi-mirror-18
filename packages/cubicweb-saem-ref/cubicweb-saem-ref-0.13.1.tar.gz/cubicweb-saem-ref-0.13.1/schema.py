...
from cubes.seda.schema.seda2 import SEDAArchiveTransfer, originating_agency_originating_agency_to
...
originating_agency_originating_agency_to.object = 'AuthorityRecord'
