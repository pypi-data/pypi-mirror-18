    ...
    def test_organization_unit(self):
        with self.admin_access.client_cnx() as cnx:
            ...
            self.assertItemsIn([
                ...
                (permanent_url(ou), self.uri('foaf:name'), u'Acme Inc.'),
                (permanent_url(ou), self.uri('dc:identifier'), ou.ark),
                ...
                (permanent_url(agent), self.uri('dc:identifier'), agent.ark),
    ...
    def test_organization(self):
        ...
        with self.admin_access.client_cnx() as cnx:
            ...
            expected = [
                ...
                (permanent_url(org), self.uri('dc:identifier'), org.eid),
            ...
            for kind, rdfkind in ((u'authority', 'org:OrganizationUnit'),
                ...
                with self.subTest(kind=kind, rdfkind=rdfkind):
                    ...
                    self.assertItemsIn([
                        ...
                        (permanent_url(record), self.uri('dc:identifier'), record.ark),
                    ], triples)
