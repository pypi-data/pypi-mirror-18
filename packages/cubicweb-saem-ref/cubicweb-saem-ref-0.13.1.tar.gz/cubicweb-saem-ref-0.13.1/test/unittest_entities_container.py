...
class TreeTC(CubicWebTC):
    ...
    def test_seda_profile_clone(self):
        ...
        with self.admin_access.repo_cnx() as cnx:
            ...
            unit, unit_alt, unit_alt_seq = testutils.create_archive_unit(transfer, cnx=cnx)
            content = cnx.create_entity('SEDAContent', seda_content=unit_alt_seq)
            cnx.create_entity('SEDATitle', seda_title=content, title=u'hello')
            ...
            self.assertEqual(seq.contents[0].title.title, 'hello')
