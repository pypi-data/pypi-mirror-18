...
:copyright: 2006-2016 LOGILAB S.A. (Paris, FRANCE), license is LGPL.
...
class ProjectPrimaryView(tabs.TabbedPrimaryView):
    ...
    tabs = [_('projectinfo_tab'), _('projecttickets_tab')]
...
_pvs.tag_subject_of(('Project', 'owned_by', '*'), 'attributes')
...
class RelativeDateColRenderer(tableview.EntityTableColRenderer):
    ...
    def render_cell(self, w, rownum):
        ...
        value = now - getattr(self.entity(rownum), self.colid)
