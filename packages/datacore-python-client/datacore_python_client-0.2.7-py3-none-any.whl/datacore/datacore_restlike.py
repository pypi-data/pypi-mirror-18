...
class Access(object):
    ...
    def chunk(data, chunk_size=500):
        ...
        """
        data = data
        assert type(data) == list, "Data packages sent for bulk posting must be in list-of-dict format"
        assert type(data[0]) == dict, "Data packages sent for bulk posting must be in list-of-dict format"
