...
class PrimeModel(Model):
    ...
    def __init__(self, id=None, processes=None, featurelist_name=None, featurelist_id=None,
                 project_id=None, sample_pct=None, model_type=None, model_category=None,
                 is_frozen=None, blueprint_id=None, metrics=None, parent_model_id=None,
    ...
    def __repr__(self):
        return 'PrimeModel({})'.format(self.model_type or self.id)
...
class BlenderModel(Model):
    ...
    def __init__(self, id=None, processes=None, featurelist_name=None, featurelist_id=None,
                 project_id=None, sample_pct=None, model_type=None, model_category=None,
                 is_frozen=None, blueprint_id=None, metrics=None, model_ids=None,
                 blender_method=None):
...
class FrozenModel(Model):
    ...
    _path_template = 'projects/{}/frozenModels/'
    ...
    def __repr__(self):
        return 'FrozenModel({})'.format(self.model_type or self.id)  # pragma:no cover
