...
class mdk_Session_getEnvironment_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_getEnvironment_Method, self).__init__(u"quark.String", u"getEnvironment", _List([]));
...
class mdk_SessionImpl_getEnvironment_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_getEnvironment_Method, self).__init__(u"quark.String", u"getEnvironment", _List([]));
...
class mdk_SessionImpl(quark.reflect.Class):
    ...
    def construct(self, args):
        return mdk.SessionImpl(_cast((args)[0], lambda: mdk.MDKImpl), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode))
...
class mdk_discovery_ReplaceCluster(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.List<mdk_discovery.Node>", u"nodes"), quark.reflect.Field(u"quark.String", u"cluster"), quark.reflect.Field(u"quark.String", u"environment")])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_discovery.ReplaceCluster(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: _List))
...
class mdk_discovery_Discovery__getServices_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery__getServices_Method, self).__init__(u"quark.Map<quark.String,mdk_discovery.Cluster>", u"_getServices", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj)._getServices(_cast((args)[0], lambda: unicode))
...
class mdk_discovery_Discovery__getCluster_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery__getCluster_Method, self).__init__(u"mdk_discovery.Cluster", u"_getCluster", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj)._getCluster(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_discovery_Discovery_knownNodes_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery_knownNodes_Method, self).__init__(u"quark.List<mdk_discovery.Node>", u"knownNodes", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj).knownNodes(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_discovery_Discovery_resolve_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery_resolve_Method, self).__init__(u"mdk_runtime.promise.Promise", u"resolve", _List([u"quark.String", u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj).resolve(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode))
...
class mdk_discovery_Discovery__replace_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery__replace_Method, self).__init__(u"quark.void", u"_replace", _List([u"quark.String", u"quark.String", u"quark.List<mdk_discovery.Node>"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        (obj)._replace(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: _List));
        return None
...
class mdk_protocol_SharedContext(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"traceId"), quark.reflect.Field(u"mdk_protocol.LamportClock", u"clock"), quark.reflect.Field(u"quark.Map<quark.String,quark.Object>", u"properties"), quark.reflect.Field(u"quark.String", u"environment"), quark.reflect.Field(u"quark.int", u"_lastEntry")])
...
class mdk_protocol_Open(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_json_type"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.Map<quark.String,quark.String>", u"properties"), quark.reflect.Field(u"quark.String", u"nodeId"), quark.reflect.Field(u"quark.String", u"environment")])
...
class mdk_protocol_OpenCloseSubscriber(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"_dispatcher"), quark.reflect.Field(u"mdk_protocol.WSClient", u"_wsclient"), quark.reflect.Field(u"quark.String", u"_node_id"), quark.reflect.Field(u"quark.String", u"_environment")])
    ...
    def construct(self, args):
        return mdk_protocol.OpenCloseSubscriber(_cast((args)[0], lambda: mdk_protocol.WSClient), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode))
...
class mdk_discovery_synapse_Synapse(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_directory_path"), quark.reflect.Field(u"quark.String", u"_environment")])
        (self).methods = _List([mdk_discovery_synapse_Synapse_create_Method(), mdk_discovery_synapse_Synapse_isRegistrar_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_discovery.synapse.Synapse(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_discovery_synapse__SynapseSource(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors.Actor", u"subscriber"), quark.reflect.Field(u"quark.String", u"directory_path"), quark.reflect.Field(u"mdk_runtime.files.FileActor", u"files"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"quark.String", u"environment")])
    ...
    def construct(self, args):
        return mdk_discovery.synapse._SynapseSource(_cast((args)[0], lambda: mdk_runtime.actors.Actor), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: mdk_runtime.MDKRuntime), _cast((args)[3], lambda: unicode))
