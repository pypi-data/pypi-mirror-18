...
class mdk_discovery_Discovery(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.Map<quark.String,quark.Map<quark.String,mdk_discovery.Cluster>>", u"services"), quark.reflect.Field(u"quark.bool", u"started"), quark.reflect.Field(u"quark.concurrent.Lock", u"mutex"), quark.reflect.Field(u"mdk_runtime.MDKRuntime", u"runtime"), quark.reflect.Field(u"mdk_discovery.FailurePolicyFactory", u"_fpfactory")])
