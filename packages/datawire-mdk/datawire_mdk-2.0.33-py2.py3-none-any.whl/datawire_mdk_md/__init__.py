...
class mdk_discovery_Node(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"service"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.String", u"address"), quark.reflect.Field(u"quark.Map<quark.String,quark.Object>", u"properties"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment"), quark.reflect.Field(u"mdk_discovery.FailurePolicy", u"_policy")])
