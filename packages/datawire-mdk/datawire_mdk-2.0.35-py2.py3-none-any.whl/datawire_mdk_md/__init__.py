# Quark 1.0.452 run at 2016-11-17 17:07:48.071308
...
class mdk_protocol_Open(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_json_type"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.Map<quark.String,quark.String>", u"properties"), quark.reflect.Field(u"quark.String", u"nodeId"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment")])
