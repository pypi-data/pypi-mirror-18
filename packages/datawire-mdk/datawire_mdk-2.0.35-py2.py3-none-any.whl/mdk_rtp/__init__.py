...
def getRTPParser():
    ...
    (parser).register(u"interactionevent", quark.reflect.Class.get(u"mdk_metrics.InteractionEvent"));
    (parser).register(u"interactionack", quark.reflect.Class.get(u"mdk_metrics.InteractionAck"));
    return parser
