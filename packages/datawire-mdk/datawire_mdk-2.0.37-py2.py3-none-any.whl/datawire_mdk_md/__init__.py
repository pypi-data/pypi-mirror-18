...
class mdk_Session_critical_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_critical_Method, self).__init__(u"mdk.LoggedMessageId", u"critical", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.Session);
        return (obj).critical(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_Session_error_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_error_Method, self).__init__(u"mdk.LoggedMessageId", u"error", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.Session);
        return (obj).error(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_Session_warn_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_warn_Method, self).__init__(u"mdk.LoggedMessageId", u"warn", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.Session);
        return (obj).warn(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_Session_info_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_info_Method, self).__init__(u"mdk.LoggedMessageId", u"info", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.Session);
        return (obj).info(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_Session_debug_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_Session_debug_Method, self).__init__(u"mdk.LoggedMessageId", u"debug", _List([u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.Session);
        return (obj).debug(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode))
...
class mdk_Session_getEnvironment_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_Session_getEnvironment_Method, self).__init__(u"mdk_protocol.OperationalEnvironment", u"getEnvironment", _List([]));
...
class mdk_LoggedMessageId(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_LoggedMessageId, self).__init__(u"mdk.LoggedMessageId");
        (self).name = u"mdk.LoggedMessageId"
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"traceId"), quark.reflect.Field(u"quark.List<quark.int>", u"causalLevel"), quark.reflect.Field(u"quark.String", u"environment"), quark.reflect.Field(u"quark.String", u"environmentFallback")])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk.LoggedMessageId(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: _List), _cast((args)[2], lambda: unicode), _cast((args)[3], lambda: unicode))
    ...
    def _setField(self, name, value):
        pass
mdk_LoggedMessageId.singleton = mdk_LoggedMessageId()
class mdk_SessionImpl_getEnvironment_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_SessionImpl_getEnvironment_Method, self).__init__(u"mdk_protocol.OperationalEnvironment", u"getEnvironment", _List([]));
...
class mdk_SessionImpl__log_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl__log_Method, self).__init__(u"mdk.LoggedMessageId", u"_log", _List([u"quark.String", u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.SessionImpl);
        return (obj)._log(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode))
...
class mdk_SessionImpl_critical_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_critical_Method, self).__init__(u"mdk.LoggedMessageId", u"critical", _List([u"quark.String", u"quark.String"]));
...
class mdk_SessionImpl_error_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_error_Method, self).__init__(u"mdk.LoggedMessageId", u"error", _List([u"quark.String", u"quark.String"]));
...
class mdk_SessionImpl_warn_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_warn_Method, self).__init__(u"mdk.LoggedMessageId", u"warn", _List([u"quark.String", u"quark.String"]));
...
class mdk_SessionImpl_info_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_info_Method, self).__init__(u"mdk.LoggedMessageId", u"info", _List([u"quark.String", u"quark.String"]));
...
class mdk_SessionImpl_debug_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_SessionImpl_debug_Method, self).__init__(u"mdk.LoggedMessageId", u"debug", _List([u"quark.String", u"quark.String"]));
...
class mdk_SessionImpl__start_interaction_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_SessionImpl__start_interaction_Method, self).__init__(u"mdk_metrics.InteractionEvent", u"_start_interaction", _List([]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.SessionImpl);
        return (obj)._start_interaction()
...
class quark_List_quark_Task_(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(quark_List_quark_Task_, self).__init__(u"quark.List<quark.Task>");
        (self).name = u"quark.List"
        (self).parameters = _List([u"quark.Task"])
        (self).fields = _List([])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
quark_List_quark_Task_.singleton = quark_List_quark_Task_()
...
class quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster__(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster__, self).__init__(u"quark.Map<quark.String,quark.Map<quark.String,mdk_discovery.Cluster>>");
        (self).name = u"quark.Map"
        (self).parameters = _List([u"quark.String", u"quark.Map<quark.String,mdk_discovery.Cluster>"])
        (self).fields = _List([])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster__.singleton = quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster__()
...
class quark_Map_quark_long_mdk_protocol_AckableEvent_(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(quark_Map_quark_long_mdk_protocol_AckableEvent_, self).__init__(u"quark.Map<quark.long,mdk_protocol.AckableEvent>");
        (self).name = u"quark.Map"
        (self).parameters = _List([u"quark.long", u"mdk_protocol.AckableEvent"])
        (self).fields = _List([])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
quark_Map_quark_long_mdk_protocol_AckableEvent_.singleton = quark_Map_quark_long_mdk_protocol_AckableEvent_()
...
class mdk_runtime_actors__CallLater_schedule_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__CallLater_schedule_Method, self).__init__(u"quark.void", u"schedule", _List([u"quark.Task"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_runtime.actors._CallLater);
        (obj).schedule(_cast((args)[0], lambda: quark.Task));
        return None
...
class mdk_runtime_actors__CallLater_runAll_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__CallLater_runAll_Method, self).__init__(u"quark.void", u"runAll", _List([]));
...
class mdk_runtime_actors__CallLater(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_runtime_actors__CallLater, self).__init__(u"mdk_runtime.actors._CallLater");
        (self).name = u"mdk_runtime.actors._CallLater"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_runtime_actors__CallLater_schedule_Method(), mdk_runtime_actors__CallLater_runAll_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_runtime_actors__CallLater.singleton = mdk_runtime_actors__CallLater()
class mdk_runtime_actors__QuarkRuntimeLaterCaller_schedule_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__QuarkRuntimeLaterCaller_schedule_Method, self).__init__(u"quark.void", u"schedule", _List([u"quark.Task"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_runtime.actors._QuarkRuntimeLaterCaller);
        (obj).schedule(_cast((args)[0], lambda: quark.Task));
        return None
...
class mdk_runtime_actors__QuarkRuntimeLaterCaller_runAll_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__QuarkRuntimeLaterCaller_runAll_Method, self).__init__(u"quark.void", u"runAll", _List([]));
...
class mdk_runtime_actors__QuarkRuntimeLaterCaller(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_runtime_actors__QuarkRuntimeLaterCaller, self).__init__(u"mdk_runtime.actors._QuarkRuntimeLaterCaller");
        (self).name = u"mdk_runtime.actors._QuarkRuntimeLaterCaller"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_runtime_actors__QuarkRuntimeLaterCaller_schedule_Method(), mdk_runtime_actors__QuarkRuntimeLaterCaller_runAll_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_runtime_actors__QuarkRuntimeLaterCaller.singleton = mdk_runtime_actors__QuarkRuntimeLaterCaller()
class mdk_runtime_actors__ManualLaterCaller_schedule_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__ManualLaterCaller_schedule_Method, self).__init__(u"quark.void", u"schedule", _List([u"quark.Task"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_runtime.actors._ManualLaterCaller);
        (obj).schedule(_cast((args)[0], lambda: quark.Task));
        return None
...
class mdk_runtime_actors__ManualLaterCaller_doNext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__ManualLaterCaller_doNext_Method, self).__init__(u"quark.void", u"doNext", _List([]));
...
class mdk_runtime_actors__ManualLaterCaller_hasNext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__ManualLaterCaller_hasNext_Method, self).__init__(u"quark.bool", u"hasNext", _List([]));
...
class mdk_runtime_actors__ManualLaterCaller_runAll_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors__ManualLaterCaller_runAll_Method, self).__init__(u"quark.void", u"runAll", _List([]));
...
class mdk_runtime_actors__ManualLaterCaller(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_runtime_actors__ManualLaterCaller, self).__init__(u"mdk_runtime.actors._ManualLaterCaller");
        (self).name = u"mdk_runtime.actors._ManualLaterCaller"
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.List<quark.Task>", u"tasks")])
        (self).methods = _List([mdk_runtime_actors__ManualLaterCaller_schedule_Method(), mdk_runtime_actors__ManualLaterCaller_doNext_Method(), mdk_runtime_actors__ManualLaterCaller_hasNext_Method(), mdk_runtime_actors__ManualLaterCaller_runAll_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_runtime_actors__ManualLaterCaller.singleton = mdk_runtime_actors__ManualLaterCaller()
...
class mdk_runtime_actors_MessageDispatcher_queued_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors_MessageDispatcher_queued_Method, self).__init__(u"quark.bool", u"queued", _List([]));
...
class mdk_runtime_actors_MessageDispatcher_pump_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors_MessageDispatcher_pump_Method, self).__init__(u"quark.void", u"pump", _List([]));
...
class mdk_runtime_actors_MessageDispatcher_onExecute_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_runtime_actors_MessageDispatcher_onExecute_Method, self).__init__(u"quark.void", u"onExecute", _List([u"quark.Runtime"]));
...
class mdk_runtime_actors_MessageDispatcher(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors._CallLater", u"callLater"), quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.List<mdk_runtime.actors._QueuedMessage>", u"_queued"), quark.reflect.Field(u"quark.bool", u"_delivering"), quark.reflect.Field(u"quark.concurrent.Lock", u"_lock")])
        (self).methods = _List([mdk_runtime_actors_MessageDispatcher_tell_Method(), mdk_runtime_actors_MessageDispatcher_startActor_Method(), mdk_runtime_actors_MessageDispatcher_stopActor_Method(), mdk_runtime_actors_MessageDispatcher__callQueuedMessage_Method(), mdk_runtime_actors_MessageDispatcher__queue_Method(), mdk_runtime_actors_MessageDispatcher_queued_Method(), mdk_runtime_actors_MessageDispatcher_pump_Method(), mdk_runtime_actors_MessageDispatcher_onExecute_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_runtime.actors.MessageDispatcher(_cast((args)[0], lambda: mdk_runtime.actors._CallLater))
...
class mdk_discovery_ReplaceCluster(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.List<mdk_discovery.Node>", u"nodes"), quark.reflect.Field(u"quark.String", u"cluster"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment")])
        (self).methods = _List([])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_discovery.ReplaceCluster(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: mdk_protocol.OperationalEnvironment), _cast((args)[2], lambda: _List))
...
class mdk_discovery_Cluster_matchingVersionRegistered_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_Cluster_matchingVersionRegistered_Method, self).__init__(u"quark.bool", u"matchingVersionRegistered", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Cluster);
        return (obj).matchingVersionRegistered(_cast((args)[0], lambda: unicode))
...
class mdk_discovery_Node_getId_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_Node_getId_Method, self).__init__(u"quark.String", u"getId", _List([]));
...
class mdk_discovery_Node(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"id"), quark.reflect.Field(u"quark.String", u"service"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.String", u"address"), quark.reflect.Field(u"quark.Map<quark.String,quark.Object>", u"properties"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment"), quark.reflect.Field(u"mdk_discovery.FailurePolicy", u"_policy")])
        (self).methods = _List([mdk_discovery_Node_getId_Method(), mdk_discovery_Node_success_Method(), mdk_discovery_Node_failure_Method(), mdk_discovery_Node_available_Method(), mdk_discovery_Node_toString_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_discovery_Discovery__getServices_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_Discovery__getServices_Method, self).__init__(u"quark.Map<quark.String,mdk_discovery.Cluster>", u"_getServices", _List([u"mdk_protocol.OperationalEnvironment"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj)._getServices(_cast((args)[0], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_discovery_Discovery__getCluster_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_Discovery__getCluster_Method, self).__init__(u"mdk_discovery.Cluster", u"_getCluster", _List([u"quark.String", u"mdk_protocol.OperationalEnvironment"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj)._getCluster(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_discovery_Discovery_knownNodes_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery_knownNodes_Method, self).__init__(u"quark.List<mdk_discovery.Node>", u"knownNodes", _List([u"quark.String", u"mdk_protocol.OperationalEnvironment"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj).knownNodes(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_discovery_Discovery_resolve_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery_resolve_Method, self).__init__(u"mdk_runtime.promise.Promise", u"resolve", _List([u"quark.String", u"quark.String", u"mdk_protocol.OperationalEnvironment"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        return (obj).resolve(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_discovery_Discovery__replace_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_Discovery__replace_Method, self).__init__(u"quark.void", u"_replace", _List([u"quark.String", u"mdk_protocol.OperationalEnvironment", u"quark.List<mdk_discovery.Node>"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        (obj)._replace(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: mdk_protocol.OperationalEnvironment), _cast((args)[2], lambda: _List));
        return None
...
class mdk_discovery_Discovery_notify_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_Discovery_notify_Method, self).__init__(u"quark.void", u"notify", _List([u"quark.UnaryCallable"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.Discovery);
        (obj).notify(_cast((args)[0], lambda: quark.UnaryCallable));
        return None
...
class mdk_discovery_Discovery(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.Map<quark.String,quark.Map<quark.String,mdk_discovery.Cluster>>", u"services"), quark.reflect.Field(u"quark.bool", u"started"), quark.reflect.Field(u"quark.concurrent.Lock", u"mutex"), quark.reflect.Field(u"mdk_runtime.MDKRuntime", u"runtime"), quark.reflect.Field(u"mdk_discovery.FailurePolicyFactory", u"_fpfactory"), quark.reflect.Field(u"quark.UnaryCallable", u"_notificationCallback")])
        (self).methods = _List([mdk_discovery_Discovery__lock_Method(), mdk_discovery_Discovery__release_Method(), mdk_discovery_Discovery_onStart_Method(), mdk_discovery_Discovery_onStop_Method(), mdk_discovery_Discovery_register_Method(), mdk_discovery_Discovery__getServices_Method(), mdk_discovery_Discovery__getCluster_Method(), mdk_discovery_Discovery_knownNodes_Method(), mdk_discovery_Discovery_failurePolicy_Method(), mdk_discovery_Discovery_resolve_Method(), mdk_discovery_Discovery_onMessage_Method(), mdk_discovery_Discovery__replace_Method(), mdk_discovery_Discovery__active_Method(), mdk_discovery_Discovery__expire_Method(), mdk_discovery_Discovery_notify_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_protocol_OperationalEnvironment_getFallback_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_OperationalEnvironment_getFallback_Method, self).__init__(u"mdk_protocol.OperationalEnvironment", u"getFallback", _List([]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.OperationalEnvironment);
...
class mdk_protocol_OperationalEnvironment_decodeClassName_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_OperationalEnvironment_decodeClassName_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClassName", _List([u"quark.String", u"quark.String"]));
...
class mdk_protocol_OperationalEnvironment_encode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_OperationalEnvironment_encode_Method, self).__init__(u"quark.String", u"encode", _List([]));
...
class mdk_protocol_OperationalEnvironment(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_OperationalEnvironment, self).__init__(u"mdk_protocol.OperationalEnvironment");
        (self).name = u"mdk_protocol.OperationalEnvironment"
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"name"), quark.reflect.Field(u"quark.String", u"fallbackName")])
        (self).methods = _List([mdk_protocol_OperationalEnvironment_getFallback_Method(), mdk_protocol_OperationalEnvironment_decodeClassName_Method(), mdk_protocol_OperationalEnvironment_encode_Method()])
        (self).parents = _List([u"mdk_protocol.Serializable"])
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_OperationalEnvironment.singleton = mdk_protocol_OperationalEnvironment()
...
class mdk_protocol_SharedContext(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"traceId"), quark.reflect.Field(u"mdk_protocol.LamportClock", u"clock"), quark.reflect.Field(u"quark.Map<quark.String,quark.Object>", u"properties"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment"), quark.reflect.Field(u"quark.int", u"_lastEntry")])
...
class mdk_protocol_Open(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_json_type"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.String", u"mdkVersion"), quark.reflect.Field(u"quark.Map<quark.String,quark.String>", u"properties"), quark.reflect.Field(u"quark.String", u"nodeId"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment")])
...
class mdk_protocol_ProtocolError_toString_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolError_toString_Method, self).__init__(u"quark.String", u"toString", _List([]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.ProtocolError);
        return (obj).toString()
...
class mdk_protocol_ProtocolError(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).methods = _List([mdk_protocol_ProtocolError_toString_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_protocol_OpenCloseSubscriber(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"_dispatcher"), quark.reflect.Field(u"mdk_protocol.WSClient", u"_wsclient"), quark.reflect.Field(u"quark.String", u"_node_id"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"_environment")])
    ...
    def construct(self, args):
        return mdk_protocol.OpenCloseSubscriber(_cast((args)[0], lambda: mdk_protocol.WSClient), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_protocol_WSClient_onClose_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_protocol_WSClient_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.ProtocolError"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.WSClient);
        (obj).onClose(_cast((args)[0], lambda: mdk_protocol.ProtocolError));
        return None
...
class mdk_protocol_SendAckableEvent_send_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_SendAckableEvent_send_Method, self).__init__(u"quark.void", u"send", _List([u"mdk_protocol.AckableEvent"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.SendAckableEvent);
        (obj).send(_cast((args)[0], lambda: mdk_protocol.AckableEvent));
        return None
...
class mdk_protocol_SendAckableEvent(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_SendAckableEvent, self).__init__(u"mdk_protocol.SendAckableEvent");
        (self).name = u"mdk_protocol.SendAckableEvent"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_protocol_SendAckableEvent_send_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_SendAckableEvent.singleton = mdk_protocol_SendAckableEvent()
class mdk_protocol_WSSend_send_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSSend_send_Method, self).__init__(u"quark.void", u"send", _List([u"mdk_protocol.AckableEvent"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.WSSend);
        (obj).send(_cast((args)[0], lambda: mdk_protocol.AckableEvent));
        return None
...
class mdk_protocol_WSSend_toString_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSSend_toString_Method, self).__init__(u"quark.String", u"toString", _List([]));
...
class mdk_protocol_WSSend(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_WSSend, self).__init__(u"mdk_protocol.WSSend");
        (self).name = u"mdk_protocol.WSSend"
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors.Actor", u"origin"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"sock")])
        (self).methods = _List([mdk_protocol_WSSend_send_Method(), mdk_protocol_WSSend_toString_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_protocol.WSSend(_cast((args)[0], lambda: mdk_runtime.actors.Actor), _cast((args)[1], lambda: mdk_runtime.actors.MessageDispatcher), _cast((args)[2], lambda: mdk_runtime.actors.Actor))
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_WSSend.singleton = mdk_protocol_WSSend()
...
class mdk_protocol_SendWithAcks_onConnected_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_protocol_SendWithAcks_onConnected_Method, self).__init__(u"quark.void", u"onConnected", _List([u"mdk_protocol.SendAckableEvent"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.SendWithAcks);
        (obj).onConnected(_cast((args)[0], lambda: mdk_protocol.SendAckableEvent));
        return None
...
class mdk_protocol_SendWithAcks_onPump_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_protocol_SendWithAcks_onPump_Method, self).__init__(u"quark.void", u"onPump", _List([u"mdk_protocol.SendAckableEvent"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.SendWithAcks);
        (obj).onPump(_cast((args)[0], lambda: mdk_protocol.SendAckableEvent));
        return None
...
class mdk_protocol_SendWithAcks(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Map<quark.long,mdk_protocol.AckableEvent>", u"_buffered"), quark.reflect.Field(u"quark.Map<quark.long,mdk_protocol.AckableEvent>", u"_inFlight"), quark.reflect.Field(u"quark.long", u"_added"), quark.reflect.Field(u"quark.long", u"_sent"), quark.reflect.Field(u"quark.long", u"_recorded"), quark.reflect.Field(u"quark.Logger", u"_myLog")])
...
class mdk_discovery_synapse_Synapse(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_directory_path"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"_environment")])
        (self).methods = _List([mdk_discovery_synapse_Synapse_create_Method(), mdk_discovery_synapse_Synapse_isRegistrar_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_discovery.synapse.Synapse(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_discovery_synapse__SynapseSource(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_runtime.actors.Actor", u"subscriber"), quark.reflect.Field(u"quark.String", u"directory_path"), quark.reflect.Field(u"mdk_runtime.files.FileActor", u"files"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment")])
    ...
    def construct(self, args):
        return mdk_discovery.synapse._SynapseSource(_cast((args)[0], lambda: mdk_runtime.actors.Actor), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: mdk_runtime.MDKRuntime), _cast((args)[3], lambda: mdk_protocol.OperationalEnvironment))
...
class mdk_tracing_TracingDestination_log_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_tracing_TracingDestination_log_Method, self).__init__(u"quark.void", u"log", _List([u"mdk_tracing.protocol.LogEvent"]));
...
class mdk_tracing_FakeTracer_log_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_tracing_FakeTracer_log_Method, self).__init__(u"quark.void", u"log", _List([u"mdk_tracing.protocol.LogEvent"]));
...
class mdk_tracing_Tracer_log_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_tracing_Tracer_log_Method, self).__init__(u"quark.void", u"log", _List([u"mdk_tracing.protocol.LogEvent"]));
...
class mdk_metrics_InteractionEvent(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"_json_type"), quark.reflect.Field(u"quark.long", u"startTimestamp"), quark.reflect.Field(u"quark.long", u"endTimestamp"), quark.reflect.Field(u"mdk_protocol.OperationalEnvironment", u"environment"), quark.reflect.Field(u"quark.String", u"uuid"), quark.reflect.Field(u"quark.String", u"session"), quark.reflect.Field(u"quark.String", u"node"), quark.reflect.Field(u"quark.Map<quark.String,quark.int>", u"results"), quark.reflect.Field(u"quark.List<quark.int>", u"startClock"), quark.reflect.Field(u"quark.List<quark.int>", u"endClock")])
...
Root.mdk_LoggedMessageId_md = mdk_LoggedMessageId.singleton
...
Root.quark_List_quark_Task__md = quark_List_quark_Task_.singleton
...
Root.quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster___md = quark_Map_quark_String_quark_Map_quark_String_mdk_discovery_Cluster__.singleton
Root.quark_Map_quark_String_mdk_discovery_Cluster__md = quark_Map_quark_String_mdk_discovery_Cluster_.singleton
Root.quark_Map_quark_long_mdk_protocol_AckableEvent__md = quark_Map_quark_long_mdk_protocol_AckableEvent_.singleton
...
Root.mdk_runtime_actors__CallLater_md = mdk_runtime_actors__CallLater.singleton
Root.mdk_runtime_actors__QuarkRuntimeLaterCaller_md = mdk_runtime_actors__QuarkRuntimeLaterCaller.singleton
Root.mdk_runtime_actors__ManualLaterCaller_md = mdk_runtime_actors__ManualLaterCaller.singleton
...
Root.mdk_protocol_OperationalEnvironment_md = mdk_protocol_OperationalEnvironment.singleton
...
Root.mdk_protocol_SendAckableEvent_md = mdk_protocol_SendAckableEvent.singleton
Root.mdk_protocol_WSSend_md = mdk_protocol_WSSend.singleton
