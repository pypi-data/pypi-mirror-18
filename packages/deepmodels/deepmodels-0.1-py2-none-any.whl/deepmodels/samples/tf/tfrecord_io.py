...
def write_tfrecord(save_fn):
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      'view1/image/encoded': tf.train.Feature(bytes_list=tf.train.BytesList(value=[png1])),
      'view1/image/height': tf.train.Feature(int64_list=tf.train.Int64List(value=[4])),
      'view1/image/width': tf.train.Feature(int64_list=tf.train.Int64List(value=[5])),
      'view1/image/format': tf.train.Feature(bytes_list=tf.train.BytesList(value=['png'])),
      'view2/image/encoded': tf.train.Feature(bytes_list=tf.train.BytesList(value=[png2])),
      'view2/image/height': tf.train.Feature(int64_list=tf.train.Int64List(value=[4])),
      'view2/image/width': tf.train.Feature(int64_list=tf.train.Int64List(value=[5])),
      'view2/image/format': tf.train.Feature(bytes_list=tf.train.BytesList(value=['png'])),
      'image/encoded': tf.train.Feature(bytes_list=tf.train.BytesList(value=[png1, png2])),
      'same_object': tf.train.Feature(int64_list=tf.train.Int64List(value=[1])),
      'relative_pos': tf.train.Feature(float_list=tf.train.FloatList(value=[1.2, 0.4, -0.9]))}))
  # write examples.
  examples = [example]
