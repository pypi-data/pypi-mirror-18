...
=======
    meta_fn = "/mnt/DataHouse/Fashion/EyeStyle/deepmodels_tf_data/eyestyle_092416__test.csv"
    # meta_fn = "/home/jiefeng/datasets/fashion/dm_data/eyestyle__test.csv"
>>>>>>> a138a06ee45527bd3541390394f9a20e046adc67
    batch_size = 12
    ...
    with self.test_session() as sess:
      ...
      for i in range(20):
        ...
        print cur_fn
        print cur_label
        print "max/min pixel values: {} {}".format(max_pixel_val.eval(), min_pixel_val.eval())
        print "max/min label values: {} {}".format(max_label_val.eval(), min_label_val.eval())
      coord.request_stop()
      coord.join(threads)
