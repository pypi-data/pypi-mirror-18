...
SOURCES_1 = {'Internet Radio': 'IRP', 'Tuner': 'TUNER', 'TV Audio': 'TV',
             ...
             'AUX': 'AUX1', 'Bluetooth': 'BT', 'CBL/SAT': 'SAT/CBL',
...
SOURCES_2 = {'Internet Radio': 'IRP', 'Tuner': 'TUNER', 'TV Audio': 'TV',
             ...
             'AUX2': 'AUX2', 'AUX': 'AUX1', 'Bluetooth': 'BT',
...
SOURCES_4 = {'Internet Radio': 'IRP', 'Online Music': 'NETHOME',
             ...
             'iPod/USB': 'USB/IPOD', 'AUX': 'AUX1', 'Bluetooth': 'BT',
...
SOURCES_5 = {'Internet Radio': 'IRP', 'Online Music': 'NETHOME',
             ...
             'HD Radio': 'HDRADIO', 'AUX': 'AUX1', 'Bluetooth': 'BT',
...
class DenonAVR(object):
    ...
    def get_status_xml(cls, host, command):
        """Get status XML via HTTP and return it as dict."""
    ...
    def update(self):
        ...
        # and power status
        if self._power == STATE_ON and self._input_func in PLAYING_SOURCES:
            if self._update_media_data():
                pass
            else:
                _LOGGER.error("Update of media data for source %s failed",
                              self._input_func)
        elif self._power == STATE_ON:
    ...
    def volume(self):
        """
        Return volume of Denon AVR.

        Volume is send in a format like -50.0.
        Minimum is around -80.0, maximum at 18.0
        """
        if self._volume == "--":
            return -80.0
        else:
