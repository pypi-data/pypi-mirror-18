...
setup(
  ...
  packages = ['dreamjub.providers.oauth'], # this must be the same as the name above
  version = '0.1.2',
  ...
  download_url = 'https://github.com/kuboschek/allauth-testbed/tarball/0.1', # I'll explain this in a second
