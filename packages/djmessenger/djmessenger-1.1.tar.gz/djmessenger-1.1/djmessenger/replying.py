...
class CommonReplier(Serializable):
    ...
    @staticmethod
    def preprocess_outgoing_string(psid, localized_text, add_prefix=True):
        """
        ...
        try:
            ...
            text = localized_text.base_string.strip()
        if add_prefix:
            text = (DJM_BOT_PREFIX + text).strip()
        return text
