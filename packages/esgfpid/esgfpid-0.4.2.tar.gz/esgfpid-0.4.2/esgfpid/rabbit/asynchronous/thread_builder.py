...
class ConnectionBuilder(object):
    ...
    def __store_settings_for_rabbit(self, args):
        ...
        self.__current_rabbitmq_params =  esgfpid.rabbit.connparams.get_connection_parameters(
            copy.copy(args['url_preferred']),
            copy.copy(args['credentials'])
        )

    def __set_rabbitmq_params(self):
        self.__current_rabbitmq_params = esgfpid.rabbit.connparams.get_connection_parameters(
    ...
    def __please_open_connection(self):
        ...
        #    self.__rabbitmq_credentials,
        #    self.__current_rabbitmq_host)
        params = self.__current_rabbitmq_params
