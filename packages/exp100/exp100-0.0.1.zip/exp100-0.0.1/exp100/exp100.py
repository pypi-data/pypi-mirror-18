...
def express_query(code, output=None, quite=False, company=None):
...
def main():
    ...
    parser.add_argument('-q', '--quite', help='be quite',
    ...
    express_query(express_code, args.output, args.quite, args.company)
