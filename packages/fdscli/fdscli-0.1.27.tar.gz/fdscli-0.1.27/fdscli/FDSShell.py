...
class FDSShell( cmd.Cmd ):
    ...
    def loadmodules(self):
        ...
        self.parser = ArgumentParser( add_help=True, description="By default it will attempt to use connection details found in ~/.fdscli.conf.  " +
            "If you would like to use a different configuration files please use -conf_file=<path and filename> as your first argument")
    ...
    def default(self, line):
        ...
        try:
            ...
            if not self.__session.is_authenticated() and not line.endswith( "-h" ):
                try:
