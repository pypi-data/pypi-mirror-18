...
class ZoneTest(BaseCliTest):
    ...
    def test_create_parser_positive(self, listNodes):
        ...
        args[AbstractPlugin.zone_iface] = None
    ...
    @patch("plugins.zone_plugin.ZonePlugin.get_node_list", side_effect=mock_functions.listNodesForZone)
    def test_create_parser_invalid_iface(self, listNodes):
        '''
        testing parser - negative test case:
        zone create -name test -vip 192.168.0.1 -service_ids 2,3 -iface deadbeefIface
        '''
        args = {}
        args[AbstractPlugin.zone_id] = None
        args[AbstractPlugin.zone_name] = "tempName"
        args[AbstractPlugin.zone_type] = "vamg"
        args[AbstractPlugin.zone_iface] = "deadbeefIface"
        args[AbstractPlugin.zone_vip] = "192.168.0.1"
        args[AbstractPlugin.zone_service_ids] = "2,3"
        zonePlugin = ZonePlugin()
        zoneObj = zonePlugin.generate_zone_obj(args)
    ...
    @patch( "netifaces.ifaddresses", return_value=[netifaces.AF_INET] )
    @patch("plugins.zone_plugin.ZonePlugin.get_node_list", side_effect=mock_functions.listNodesForZone)
    def test_create_parser_valid_iface(self, listNodes, mockNeti ):
        '''
        testing parser - positive test case:
        zone create -name test -vip 192.168.0.1 -service_ids 2,3 -iface eth0
        '''
        args = {}
        args[AbstractPlugin.zone_id] = None
        args[AbstractPlugin.zone_name] = "tempName"
