...
class NfsSettings(ObjectSettings):
    ...
    @author: nate
    '''
    def __init__(self, use_acls=False, use_root_squash=False, synchronous=False, clients="*", max_object_size=Size(1048576, "B"), capacity=Size( 1, "TB" ), encryption=False, compression=False):
        self.type = "NFS"
