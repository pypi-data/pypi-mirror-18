...
#         __editParser.add_argument( "-media_policy", help="The policy that will determine where the data will live over time.", choices=["HYBRID_ONLY", "SSD_ONLY", "HDD_ONLY"], default=None)
    ...
    def create_import_command(self, subparser):
        ...
        __parserForImport.add_argument("EXPORT_NAME", nargs='?', default="", help=("The export name, obtained "
            "using \'exports list\' for a bucket."))
        __parserForImport.add_argument("VOLUME_NAME", type=str, help=("The name of the resulting new volume."))
    ...
    def create_safeguard_command(self, subparser):
        ...
        msg = ("Volumes can optionally subscribe to one or many SafeGuard policies. "
            ...
            "of data migration tasks. Available sub-commands are add, list, and remove.")
        ...
        groupForAdd.add_argument(self.arg_str + AbstractPlugin.credential_str, help=("A credential name "
            "or unique identifier. See \'credential list\' command for values."), default=None, required=True)
        ...
        msgForList = ("List all SafeGuard subscriptions for a volume.")
        ...
        msgForRemove = ("Remove SafeGuard subscription(s) for a volume.")
        __parserForRemove = safeguardSubParser.add_parser("remove", description=msgForRemove,
            help=msgForRemove)
    ...
    def import_volume(self, args):
        ...
        if credential_key is None:
            ...
            if isinstance(named_credential, NamedCredential):
                if named_credential.s3credentials is None:
                    print("Not an S3 named credential: \'{}\'.\n".format(credential_key))
                    return
