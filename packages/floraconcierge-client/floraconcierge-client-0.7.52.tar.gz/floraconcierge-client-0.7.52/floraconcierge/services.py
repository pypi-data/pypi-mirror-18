...
class Shop(Service):
    ...
    def get_order_by_key(self, order_id, order_key):
        """
        :rtype : Order
        """
        return self._callapi(
    ...
    def update_order(self, postObject):
        """
        :rtype : bool
        """
        return self._callapi("shop/order/update", post=postObject)
    ...
    def get_products_archive(self, invert=None):
        """
        :rtype : list
        """
        return self._callapi("shop/products/archive", get={"invert": invert})
...
class System(Service):
    ...
    def get_site_map(self, key=None, data=None):
        """
        :rtype : list
        """
        return self._callapi("system/sitemap", get={"key": key, "data": data})
