...
def flux_partition(fname, meas_wue=None, hfd_options=None, wue_options=None,
                   partition_options=None, label=None):
    ...
    partition_options : dict, optional
    ...
    wue_options['leaf_temper_corr'] : float
        ...
        See: :func:`~fluxpart.wue.water_use_efficiency`.
    partition_options['adjusting_fluxes'] : bool
    ...
    hfd_options = hfd_options or {}
    wue_options = wue_options or {}
    partition_options = partition_options or {}

    # py3.5 dictionary merge/update
    hfd_options = {**DEFAULT_HFD_OPTIONS, **hfd_options}
    wue_options = {**DEFAULT_WUE_OPTIONS, **wue_options}
    partition_options = {**DEFAULT_PARTITION_OPTIONS, **partition_options}
    ...
    adjusting_fluxes = partition_options['adjusting_fluxes']
