...
#endif
{
  ...
  __pyx_ptype_5fwdpy_7fitness_SpopFitness = __Pyx_ImportType("fwdpy.fitness", "SpopFitness", sizeof(struct __pyx_obj_5fwdpy_7fitness_SpopFitness), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_SpopFitness)) __PYX_ERR(2, 108, __pyx_L1_error)
  __pyx_ptype_5fwdpy_7fitness_SpopAdditive = __Pyx_ImportType("fwdpy.fitness", "SpopAdditive", sizeof(struct __pyx_obj_5fwdpy_7fitness_SpopAdditive), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_SpopAdditive)) __PYX_ERR(2, 114, __pyx_L1_error)
  __pyx_ptype_5fwdpy_7fitness_SpopMult = __Pyx_ImportType("fwdpy.fitness", "SpopMult", sizeof(struct __pyx_obj_5fwdpy_7fitness_SpopMult), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_SpopMult)) __PYX_ERR(2, 117, __pyx_L1_error)
  __pyx_ptype_5fwdpy_7fitness_MlocusFitness = __Pyx_ImportType("fwdpy.fitness", "MlocusFitness", sizeof(struct __pyx_obj_5fwdpy_7fitness_MlocusFitness), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_MlocusFitness)) __PYX_ERR(2, 120, __pyx_L1_error)
  __pyx_ptype_5fwdpy_7fitness_MlocusAdditive = __Pyx_ImportType("fwdpy.fitness", "MlocusAdditive", sizeof(struct __pyx_obj_5fwdpy_7fitness_MlocusAdditive), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_MlocusAdditive)) __PYX_ERR(2, 126, __pyx_L1_error)
  __pyx_ptype_5fwdpy_7fitness_MlocusMult = __Pyx_ImportType("fwdpy.fitness", "MlocusMult", sizeof(struct __pyx_obj_5fwdpy_7fitness_MlocusMult), 1); if (unlikely(!__pyx_ptype_5fwdpy_7fitness_MlocusMult)) __PYX_ERR(2, 129, __pyx_L1_error)
