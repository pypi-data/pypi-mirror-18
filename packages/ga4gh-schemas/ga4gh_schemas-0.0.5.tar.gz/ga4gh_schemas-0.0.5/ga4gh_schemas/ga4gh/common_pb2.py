...
# source: ga4gh_schemas/ga4gh/common.proto
...
_GAEXCEPTION = _descriptor.Descriptor(
  name='GAException',
  full_name='ga4gh_schemas.ga4gh.GAException',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error_code', full_name='ga4gh_schemas.ga4gh.GAException.error_code', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='ga4gh_schemas.ga4gh.GAException.message', index=1,
...
_POSITION = _descriptor.Descriptor(
  name='Position',
  full_name='ga4gh_schemas.ga4gh.Position',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='reference_name', full_name='ga4gh_schemas.ga4gh.Position.reference_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='position', full_name='ga4gh_schemas.ga4gh.Position.position', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='strand', full_name='ga4gh_schemas.ga4gh.Position.strand', index=2,
...
_EXTERNALIDENTIFIER = _descriptor.Descriptor(
  ...
  full_name='ga4gh_schemas.ga4gh.ExternalIdentifier',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='database', full_name='ga4gh_schemas.ga4gh.ExternalIdentifier.database', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='identifier', full_name='ga4gh_schemas.ga4gh.ExternalIdentifier.identifier', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='ga4gh_schemas.ga4gh.ExternalIdentifier.version', index=2,
...
GAException = _reflection.GeneratedProtocolMessageType('GAException', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh_schemas.ga4gh.common_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh_schemas.ga4gh.GAException)
  ))
...
Position = _reflection.GeneratedProtocolMessageType('Position', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh_schemas.ga4gh.common_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh_schemas.ga4gh.Position)
  ))
...
ExternalIdentifier = _reflection.GeneratedProtocolMessageType('ExternalIdentifier', (_message.Message,), dict(
  ...
  __module__ = 'ga4gh_schemas.ga4gh.common_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh_schemas.ga4gh.ExternalIdentifier)
  ))
