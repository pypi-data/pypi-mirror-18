...
# get log file
set logfile = /home/simon/LOGS/gomo-log
...
ln -s /home/simon/db/gomo_databases gomo_dbs
...
# Run AMA
set start_time = `/home/simon/etc/timer.sh`
...
set time_msg = `/home/simon/etc/timer.sh $start_time`
