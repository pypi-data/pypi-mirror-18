...
#                      GtkCairo backend for Ginga and embedded in a Gtk program.
#
...
"""
Usage:
   example2_mpl_gtk.py [fits file]

You need Gtk with python bindings installed to run this example.
"""
...
from ginga.mplw.FigureCanvasGtk import FigureCanvas
