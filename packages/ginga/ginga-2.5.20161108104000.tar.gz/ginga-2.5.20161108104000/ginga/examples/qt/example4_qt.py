#! /usr/bin/env python
#
# example4_qt.py -- Simple, configurable FITS viewer.
#
...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        hbox.setContentsMargins(QtCore.QMargins(2, 2, 2, 2))
        hbox.setSpacing(4)

        # Make viewer 1
        v1 = CanvasView(logger, render='widget')
        ...
        v2 = CanvasView(logger, render='widget')
        ...
        self.drawtypes = list(self.dc.keys())
        self.drawtypes.sort()
