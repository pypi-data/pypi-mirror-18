...
LIST_DESCRIPTION = 'Gitman - List: list the repositories of the user'
LIST_USER_HELP = 'Targets a user in Github. Default: user configured by setup'
SETUP_HELP = 'Setup user credentials.'
CLONE_HELP = 'Clones the specified repository.'
CLONE_DESCRIPTION = 'Gitman - Clone: clones the specified repository.'
CLONE_REPO_HELP = 'Repository to clone in the format <user>/<repo>. Defaults \
to the authenticated user if no <user> specified.'
