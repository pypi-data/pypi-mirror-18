...
class GolosWalletRPC(SteemWalletRPC):
    """ GOLOS JSON-HTTP-RPC API
        ...
        in the class ``GolosWalletRPC``. Once an instance of GolosWalletRPC is
        created with host, port, username, and password, e.g.,

        .. code-block:: python

            from golosrpc import GolosRPC
            rpc = GolosRPC("localhost", 8092, "", "")
    ...
    def __init__(self, *args, **kwargs):
        super(GolosWalletRPC, self).__init__(*args, **kwargs)
