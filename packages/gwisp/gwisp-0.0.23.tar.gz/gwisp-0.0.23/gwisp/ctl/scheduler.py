...
from ..cmodel.scheduler import validate_post, validate_put
...
class SchedulerItemCtl(object):
    ...
    def on_put(self, req, res, id):
        ...
        if old_item['author']['_id'] != str(auth.account_id):
            raise HTTPForbidden(
                title='403 Forbidden',
    ...
    def on_delete(self, req, res, id):
        ...
        if item['author']['_id'] != str(auth.account_id):
            raise HTTPForbidden(
                title='403 Forbidden',
