    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE,
                                           related_name='user_behaviors', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'httplog',
            },
