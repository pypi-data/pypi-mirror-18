...
class AWS4_SigningKey_Test(unittest.TestCase):
    ...
    def test_store_secret_key(self):
        obj = AWS4SigningKey(
            'secret_key', 'region', 'service', store_secret_key=True)
        self.assertEqual(obj.secret_key, 'secret_key')

    def test_no_store_secret_key(self):
        obj = AWS4SigningKey(
            'secret_key', 'region', 'service', store_secret_key=False)
    ...
    def test_sign_sha256_unicode_msg(self):
        ...
        msg = ('Forsaking monastic tradition, twelve jovial friars gave up '
               ...
               'trapeze')
        expected = [250, 103, 254, 220, 118, 118, 37, 81, 166, 41, 65, 14, 142,
                    77, 204, 122, 185, 19, 38, 15, 145, 249, 113, 69, 178, 30,
                    131, 244, 230, 190, 246, 23]
    ...
    def test_generate_key(self):
        ...
        expected = [152, 241, 216, 137, 254, 196, 244, 66, 26, 220, 82, 43,
                    171, 12, 225, 248, 46, 105, 41, 194, 98, 237, 21, 229, 169,
                    76, 144, 239, 209, 227, 176, 231]
...
class AWS4Auth_Regenerate_Signing_Key_Test(unittest.TestCase):
    def setUp(self):
        ...
        self.sig_key_no_secret = AWS4SigningKey(self.secret_key, self.region,
                                                self.service, self.date, False)
...
class AWS4Auth_GetCanonicalHeaders_Test(unittest.TestCase):
    def test_headers_amz_example(self):
        ...
        req = requests.Request(
            'GET', 'http://iam.amazonaws.com', headers=headers)
        req = req.prepare()
...
class AWS4Auth_RequestSign_Test(unittest.TestCase):
    ...
    def _test_amz_test_suite_item(self, group_name):
        ...
        key = AWS4SigningKey(
            amz_aws4_testsuite.secret_key, amz_aws4_testsuite.region,
            amz_aws4_testsuite.service, amz_aws4_testsuite.date)
        auth = AWS4Auth(
            amz_aws4_testsuite.access_id, key, include_hdrs=include_hdrs)
        sreq = auth(req)
...
class AWS4Auth_LiveService_Test(unittest.TestCase):
    ...
    services = {
        ...
        'Auto-Scaling':
        'autoscaling.us-east-1.amazonaws.com/?Action=DescribeAutoScalingInstances&Version=2011-01-01',
        'CloudFormation':
        'cloudformation.us-east-1.amazonaws.com?Action=ListStacks',
        'CloudFront':
        'cloudfront.amazonaws.com/2014-11-06/distribution?MaxItems=1',
        'CloudHSM': {
            'method': 'POST',
        ...
        'CloudSearch':
        'cloudsearch.us-east-1.amazonaws.com?Action=ListDomainNames&Version=2013-01-01',
        'CloudTrail':
        'cloudtrail.us-east-1.amazonaws.com?Action=DescribeTrails',
        ...
        'Cognito Sync': {
            ...
            'headers': {'Content-Type': 'application/json',
                        'X-Amz_Target':
                        'AWSCognitoSyncService.ListIdentityPoolUsage'},
            'body': json.dumps({
                'Operation':
        ...
        'Elastic Beanstalk':
        'elasticbeanstalk.us-east-1.amazonaws.com/?Action=ListAvailableSolutionStacks&Version=2010-12-01',
        'ElastiCache':
        'elasticache.us-east-1.amazonaws.com/?Action=DescribeCacheClusters&Version=2014-07-15',
        'EC2':
        'ec2.us-east-1.amazonaws.com/?Action=DescribeRegions&Version=2014-06-15',
        'EC2 Container Service':
        'ecs.us-east-1.amazonaws.com/?Action=ListClusters&Version=2014-11-13',
        'Elastic Load Balancing':
        'elasticloadbalancing.us-east-1.amazonaws.com/?Action=DescribeLoadBalancers&Version=2012-06-01',
        'Elastic MapReduce':
        'elasticmapreduce.us-east-1.amazonaws.com/?Action=ListClusters&Version=2009-03-31',
        'Elastic Transcoder':
        ...
        'Redshift':
        'redshift.us-east-1.amazonaws.com/?Action=DescribeClusters&Version=2012-12-01',
        ...
        'sqs.us-east-1.amazonaws.com/?Action=ListQueues',
        'Storage Gateway': {
            'method': 'POST',
            'req': 'storagegateway.us-east-1.amazonaws.com',
            'headers': {'Content-Type': 'application/x-amz-json-1.1',
                        'X-Amz-Target':
                        'StorageGateway_20120630.ListGateways'},
            'body': '{}'
        },
    ...
    def _test_live_service(self, service_name, params):
        ...
        response = requests.request(
            method, url, auth=auth, data=body, headers=headers)
