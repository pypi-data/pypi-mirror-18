# -*- coding: utf-8 -*-
#
# tile_gpio documentation build configuration file, created by
# sphinx-quickstart on Sat Jul 30 16:50:37 2016.
#
...
def configure_iotile_specific(iotile, namespace):
  ...
  texinfo_documents = [
    (master_doc, iotile.short_name, u'%s Documentation' % iotile.short_name,
     namespace['author'], iotile.short_name, iotile.full_name,
     'Miscellaneous'),
  ]
...
breathe_projects = {'firmware': '../build/doc/doxygen/xml'}
...
copyright = u'2016, Arch Systems Inc.'
...
htmlhelp_basename = 'tile_gpiodoc'
...
latex_documents = [
  (master_doc, 'tile_gpio.tex', u'tile\\_gpio Documentation',
   u'Tim Burke', 'manual'),
]
