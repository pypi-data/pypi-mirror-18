...
def init(provider_settings=None, **kwargs):
    """
    ...
    :param dict provider_settings: Provider details (if None, will default to ITculate Rest API with local credentials)
    :param kwargs: Another way to provide settings
    """
