...
def time_period_value(value, unit=None, label=None, description=None, visible=True, importance=12):
    data_type = TimePeriodDataType(label=label,
                                   unit=unit,
                                   description=description,
                                   visible=visible,
                                   importance=importance)
...
def latency_value(value, unit=Units.MS, label=None, description=None, visible=True, importance=11):
    data_type = LatencyDataType(label=label, description=description, visible=visible, importance=importance)
    return RealTypedValueWithUnit(data_type=data_type, value=value, unit=unit)
...
def memory_value(value, unit=Units.GB, label=None, description=None, visible=True, importance=14):
    data_type = MemoryDataType(label=label, description=description, visible=visible, importance=importance)
    return RealTypedValueWithUnit(data_type=data_type, value=value, unit=unit)
