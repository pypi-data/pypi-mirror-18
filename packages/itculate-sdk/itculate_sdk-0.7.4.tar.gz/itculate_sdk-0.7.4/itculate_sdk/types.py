...
class DataType(object):
    ...
    def __init__(self, **kwargs):
        ...
        """
        self._label = kwargs.get("label") or self.default_label
        self._importance = kwargs.get("importance") or self.default_importance
        self._description = kwargs.get("description") or self.default_description
        self._visible = kwargs.get("visible", True) or self.default_visible
...
def throughput_value(value, unit=None, label=None, **kwargs):
