...
def add_samples_for_non_vertex_keys(non_vertex_keys, samples, default_vertex_key=None):
    ...
    vertex_counter_mappings = _mappings.lookup(non_vertex_keys, default_vertex_key=default_vertex_key)
...
def map_counter(non_vertex_keys, vertex=None, counter=None, vertex_type=None, data_type=None, vertex_counters=None):
    """
    ...
    The 'vertex_counters' attribute is mutually exclusive with ('vertex', 'counter', 'vertex_type', 'data_type')
    ...
    if vertex_counters is None:
        ...
        assert (vertex == counter == vertex_type == data_type == None), \
            "When 'vertex_counters' is provided, 'vertex', 'counter', 'vertex_type', 'data_type' should not be"
