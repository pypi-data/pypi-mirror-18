...
def cache(orig_func=None, db=None, key=lambda params: str(sorted(params.iteritems()))):
    """
    ...
    if orig_func is None:
        ...
        return functools.partial(cache, db_path=db, key=key)
    ...
    def decorated(*args, **kwargs):
        ...
        key_ = orig_func.__name__ + '__' + key(params)
        info['last_key'] = key_
