...
"""Usage: kaptl init <name> (<rules> | --rules-file=RULESFILE) --license=KEY [--build] [--recipe=RECIPENAME] [--backend=STACK] [--frontend=STACK] [--recipe-version=VERSION] [--skip-ssl-check]
       kaptl update [--build] [--license=KEY] [--recipe=RECIPENAME] [--mode=full|partial] [--recipe-version=VERSION] [--skip-ssl-check]
       kaptl add <rule> [--build] [--license=KEY] [--recipe=RECIPENAME]
       kaptl parse (<rules> | --rules-file=RULESFILE) [--license=KEY] [--recipe=RECIPENAME] [--recipe-version=VERSION] [--skip-ssl-check]
       kaptl project schema (<rules> | --rules-file=RULESFILE) [--license=KEY] [--recipe=RECIPENAME] [--recipe-version=VERSION] [--output=OUTPUT] [--skip-ssl-check]
       kaptl recipe versions [--license=KEY] [--recipe=RECIPENAME] [--skip-ssl-check]
       kaptl show
       kaptl status
       kaptl -h | --help
