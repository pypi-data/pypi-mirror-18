...
.. rst-class:: sphx-glr-script-out
 ...
 Out::
    ...
    ============================================================
    ============================================================
    501 cycles drained in 5.67s (CPU 5.62s). Memory peak: 322.41 MB
    Statistics are based on the last 500 cycles.
      wall  mean: 0.01s  medi: 0.01s  min: 0.01s  max: 0.14s  std: 0.01s
      CPU   mean: 0.01s  medi: 0.01s  min: 0.01s  max: 0.13s  std: 0.01s
