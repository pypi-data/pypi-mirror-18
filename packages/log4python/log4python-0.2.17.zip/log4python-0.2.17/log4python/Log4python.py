...
class log():
    ...
    def critical(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("critical:Module[%s]: %s" % ex)
    ...
    def error(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("error:Module[%s]: %s" % ex)
    ...
    def warning(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("warning:Module[%s]: %s" % ex)
    ...
    def info(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("info:Module[%s]: %s" % ex)
    ...
    def debug(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("debug:Module[%s]: %s" % ex)
