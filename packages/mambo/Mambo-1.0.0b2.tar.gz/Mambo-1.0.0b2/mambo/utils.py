...
class dot_notation_dict(object):
    """
    To access a dict via a dot notation, obj.get('key.key2.0.keyx')
    my_dict = {...}
    d = dot_notation_dict(my_dict)
    d.get("key1")
    d.get("key1.key2")
    ...
    def get(self, name, default=None):
        ...
        :param name: string dot notation. ie: key1.key2.0.keyx
