...
def getDefaultConfig():
    ...
    if getfqdn().endswith(".broadinstitute.org"):
        Database = 'firebrowse'
        Server = 'fbdev'
        Port = '27017'

    #print "BEFORE rcfile: Database=%s Server=%s" % (Database, Server)
    ...
    #print "AFTER rcfile: Database=%s Server=%s" % (Database, Server)FTER
