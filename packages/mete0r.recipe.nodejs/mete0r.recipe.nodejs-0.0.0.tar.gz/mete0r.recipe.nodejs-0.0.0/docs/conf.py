...
project = u'mete0r.recipe.nodejs'
...
htmlhelp_basename = 'mete0r.recipe.nodejs'
...
latex_documents = [
    (
        master_doc,
        'mete0r.recipe.nodejs.tex',
        u'mete0r.recipe.nodejs Documentation',
        u'mete0r',
        'manual'
    ),
]
