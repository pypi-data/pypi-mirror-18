...
@setup_dir
def get_version():
    from mete0r_recipe_nodejs import __version__
    return __version__
...
setup_info = {
    ...
    'version': get_version(),
    'description': 'a buildout recipe to install node.js',
    ...
    'url': 'https://github.com/mete0r/mete0r.recipe.nodejs',

    'packages': [
        'mete0r_recipe_nodejs',
        'mete0r_recipe_nodejs.recipe',
        'mete0r_recipe_nodejs.tests',
    ],
    ...
    'entry_points': {
        ...
        'zc.buildout': [
            'default = mete0r_recipe_nodejs.recipe:Recipe',
        ],
