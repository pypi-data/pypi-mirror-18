...
@setup_dir
def get_version():
    from mete0r_recipe_sshtunnel import __version__
    return __version__
...
setup_info = {
    ...
    'version': get_version(),
    'description': 'a zc.buildout recipe to make on-demand ssh tunnel',
    ...
    'url': 'https://github.com/mete0r/mete0r.recipe.sshtunnel',

    'packages': [
        'mete0r_recipe_sshtunnel',
        'mete0r_recipe_sshtunnel.recipe',
        'mete0r_recipe_sshtunnel.tests',
    ],
    ...
    'entry_points': {
        ...
        'zc.buildout': [
            'default = mete0r_recipe_sshtunnel.recipe:default',
        ],
        'zc.buildout.uninstall': [
            'default = mete0r_recipe_sshtunnel.recipe:default_uninstall',
        ],
        'paste.app_factory': [
        ],
    },
