...
project = u'mete0r.recipe.sshtunnel'
...
locale_dirs = [
    'locale/',
    '../mete0r_recipe_sshtunnel/locale/',
]
...
htmlhelp_basename = 'mete0r.recipe.sshtunnel'
...
latex_documents = [
    (
        master_doc,
        'mete0r.recipe.sshtunnel.tex',
        u'mete0r.recipe.sshtunnel Documentation',
        u'mete0r',
        'manual'
    ),
]
