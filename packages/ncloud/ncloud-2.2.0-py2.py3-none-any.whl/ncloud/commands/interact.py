...
from ncloud.commands.command import SHOW, START, STOP, LS
    ...
    def call(config, id, console_log=False, console_log_follow=False):
        ...
        while True:
            try:
                ...
                if status_code == 202 or not console_log_follow:
                    break
                time.sleep(2.5)
                vals['offset'] = offset
...
parser = partial(
    build_subparser, 'interact', ['i'], __doc__, (Start, List, Stop, Show)
)
