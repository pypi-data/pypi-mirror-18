...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-file',
                        help='full path to a valid NetMagus NetworkOperation form JSON output '
                             'file', required=True)
    parser.add_argument('--token',
                        help='hash key sent by NetMagus to indicate the instance of this recipe '
                             'execution.  Used by recipe to generate RPC targets and/or file names for '
