...
import nodewox.mqtt.client as nxcli
import nodewox.mqtt as nxmqtt
...
def _on_connect(c, userdata, flags, rc):
    ...
    if rc == 0:
        ...
        raise nxmqtt.MQTTException(nxcli.connack_string(rc))
...
def multiple(msgs, hostname="localhost", port=1883, client_id="", keepalive=60,
             will=None, auth=None, tls=None, protocol=nxcli.MQTTv311, transport="tcp"):
    ...
    tls : a dict containing TLS configuration parameters for the client:
          ...
          the default behaviour - see the nodewox.mqtt.client documentation.
    ...
    client = nxcli.Client(client_id=client_id,
...
def single(topic, payload=None, qos=0, retain=False, hostname="localhost",
           ...
           tls=None, protocol=nxcli.MQTTv311, transport="tcp"):
