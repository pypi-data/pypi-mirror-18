...
class RewardServerClient(websocket.WebSocketClientProtocol, object):
    ...
    def onMessage(self, msg, isBinary):
        ...
        #     # "headers":{"sent_at":1473126129.231828928,"request_id":207},
        #     # "method":"env.reward"}
...
class RewardProxyServer(websocket.WebSocketServerProtocol, object):
    ...
    def begin_recording(self):
        ...
        Version 0 can be seen here: https://github.com/openai/gym-vnc/blob/f85a7779c3847fa86ec7bb513a1da0d3158dda78/bin/recording_agent.py
        """
