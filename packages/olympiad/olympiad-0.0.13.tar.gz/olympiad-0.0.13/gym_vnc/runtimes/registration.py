...
class DockerRuntime(object):
    ...
    def __init__(self, id=id, image=None, command=None, host_config=None, environment=None, server_registry_file=None):
        """
        Args:
            ...
            environment: A list of environment variables that this environment accepts
    ...
    def _cli_flags(self):
        ...
        for api_key, api_value in self.host_config.items():
            if isinstance(api_value, six.string_types):
...
class WindowsRuntime(object):
    ...
    def __init__(self, id=id, environment=None):
        """
        Args:
            id: The short identifier for this runtime
        """
...
class Registry(object):
    ...
    def runtime_spec(self, id):
        """
        id is a string describing the runtime, e.g 'vnc-flashgames
