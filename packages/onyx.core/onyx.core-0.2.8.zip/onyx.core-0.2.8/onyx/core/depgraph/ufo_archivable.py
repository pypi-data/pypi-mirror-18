...
from .graph_api import ValueType, GetVal
...
class MktIndirectionFactory(object):
    ...
    Inputs:
        ...
        obj        - name of the object exposing value types with the current
                     ...
                     "Database").
        mdd_vt     - name of the value type for market data date (default
                     is "MktDataDate").
        fs_vt      - name of the value type for force strict flag (default
                     is "ForceStrict").
    ...
    def __init__(self, field_type,
                 obj="Database", mdd_vt="MktDataDate", fs_vt="ForceStrict"):
    ...
    def __call__(self, func):
        ...
        def getter(instance, graph):
            mdd = graph(self.obj, self.mdd_vt)  # market data date
            fs = graph(self.obj, self.fs_vt)  # force strict
            _, value = instance.get_dated(vt_name, mdd, fs)
            return value
