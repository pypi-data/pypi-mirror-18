...
try:
    import Onyx
    if os.path.exists(str(Onyx.__path__[0]) + "/onyx/install") and os.path.exists(str(Onyx.__path__[0]) + "/onyx/installOld"):
        shutil.rmtree(str(Onyx.__path__[0]) + "/onyx/install")
except:
    if os.path.exists(os.path.dirname(os.path.dirname(__file__)) + '/installOld') and os.path.exists(os.path.dirname(os.path.dirname(__file__)) + '/installOld'):
        shutil.rmtree(os.path.dirname(os.path.dirname(__file__)) + '/install')
