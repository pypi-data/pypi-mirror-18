...
class GraphicsConsoleService(Service):
    ...
    def get(
        self,
        current=None,
        populate_remote_viewer_connection_file=None,
    ):
        """
        ...
        `populate_remote_viewer_connection_file`:: Specify if the API should return the attribute `remote_viewer_connection_file`, which contains the content
        ...
        Service._check_types([
            ...
            ('populate_remote_viewer_connection_file', populate_remote_viewer_connection_file, bool),
        ])
        ...
        if populate_remote_viewer_connection_file is not None:
            populate_remote_viewer_connection_file = Writer.render_boolean(populate_remote_viewer_connection_file)
            query['populate_remote_viewer_connection_file'] = populate_remote_viewer_connection_file
