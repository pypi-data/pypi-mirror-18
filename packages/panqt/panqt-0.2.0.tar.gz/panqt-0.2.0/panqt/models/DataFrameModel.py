...
from panqt.compat import Qt, QtCore, QtGui, Slot, Signal
...
from panqt.models.ColumnDtypeModel import ColumnDtypeModel
from panqt.models.DataSearch import DataSearch
...
class DataFrameModel(QtCore.QAbstractTableModel):
    ...
    def setFilter(self, search):
        ...
        Args:
            search(panqt.DataSearch): data search object to use.
        ...
        if not isinstance(search, DataSearch):
            raise TypeError('The given parameter must an `panqt.DataSearch` object')
