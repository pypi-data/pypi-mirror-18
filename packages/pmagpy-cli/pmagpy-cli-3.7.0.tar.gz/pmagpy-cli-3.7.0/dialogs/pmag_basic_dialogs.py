...
from programs import cit_magic3 as cit_magic
...
class convert_CIT_files_to_MagIC(convert_files_to_MagIC):
    ...
    def InitUI(self):
        self.data_model_num = self.parent.parent.data_model_num
        pnl = self.panel
    ...
    def on_okButton(self, event):
        ...
        if replicate:
            ...
            options_dict['avg'] = 1
            replicate = '-A'
        options_dict['data_model'] = 2 #self.data_model_num

        COMMAND = "cit_magic.py -WD {} -f {} -F {} {} {} {} {} -ncn {} {} {} -Fsp {} -Fsi {} -Fsa {} {} -dm {}".format(wd, CIT_file, outfile, particulars, spec_num, loc_name, user, ncn, peak_AF, ID, spec_outfile, site_outfile, samp_outfile, replicate, 2)
        # to run as module:
