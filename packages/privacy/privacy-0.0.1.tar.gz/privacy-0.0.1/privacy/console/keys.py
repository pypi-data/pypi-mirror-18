...
from privacy.core import KeyAlreadyExists
from privacy.core import InvalidKeyError
from privacy.util import ensure_unicode

from privacy.console.ui import get_bool
...
def execute_command_create():
    from privacy.console.parsers.generate_key import parser
...
def execute_command_list():
    from privacy.console.parsers.list_keys import parser
...
def execute_command_import():
    from privacy.console.parsers.import_key import parser
...
def execute_command_show_public():
    from privacy.console.parsers.show_public import parser
...
def execute_command_show_private():
    from privacy.console.parsers.show_private import parser
...
def execute_command_show_passphrase():
    from privacy.console.parsers.show_passphrase import parser
...
def execute_command_show():
    from privacy.console.parsers.show import parser
...
def execute_command_delete():
    from privacy.console.parsers.delete_key import parser
