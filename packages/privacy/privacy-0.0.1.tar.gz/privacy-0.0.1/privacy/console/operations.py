...
from privacy.util import BackupManager
from privacy.util import get_all_keyring_nodes
from privacy.util import initialize_key_home
...
def execute_command_generate_backup():
    from privacy.console.parsers.backup import parser
...
def execute_command_recover_from_backup():
    from privacy.console.parsers.recover import parser
...
def execute_command_quickstart():
    from privacy.console.parsers.quickstart import parser
    ...
    print "export PRIVACY_CONFIG_PATH='{0}'".format(path)
    print


def execute_command_wipe():
    from privacy.console.parsers.wipe import parser
