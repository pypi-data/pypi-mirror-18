...
class BWRS(object):
    ...
    def parametros(T,componente):
        from config_BWRS import R,A,B
        Tc,Pc,Vc,w = BdD.get_dados(componente,ret=[1,2,3,6])
...
class VDW(object):
    ...
    def TP(self,T,P,componente):
        ...
        from config_VDW import Omega_a, Omega_b, R
        Tc,Pc = BdD.get_dados(componente,ret=[1,2])
    ...
    def Tboyle(self,componente):
        from config_VDW import Omega_a, Omega_b
...
class RK_MOD(object):
    ...
    def baseTP(T,P,componente,Alpha_r):
        from config_RK_MOD import Omega_a,Omega_b,R
        Tc,Pc,w = BdD.get_dados(componente,ret=[1,2,6])
    ...
    def wilson_TP(self,T,P,componente):
        # propriededades físicas da substância
        Tc,w= BdD.get_dados(componente,ret=[1,6])
...
if __name__ == '__main__':
    ...
    print('WILSON: Z:{0:.4f}  V:{1:.4f}  ln_Phi:{2:.4f}'.format(resultado3['Z'],resultado3['V'],resultado3['lncf']))
