...
def run_ericscript(job, fastqs, univ_options, ericscript_options):
    ...
    export_results(job, filtered_fusions, output_path, univ_options,
                   subfolder='mutations/ericscript')
...
def reformat_ericscript_output(job, fusion_file, univ_options):
    ...
    reformatted_file = job.fileStore.writeGlobalFile(output_path)
    export_results(job, reformatted_file, output_path, univ_options,
                   subfolder='mutations/ericscript')
