...
setup(
    ...
    version=version,
    description=("An easy solution to transform "
                 "libreoffice/openoffice documents to supported formats"),
    ...
    entry_points=dict(
        # -*- Entry points: -*-
        console_scripts=[
            'start-py3o-renderserver = py3o.renderserver.server:cli_server',
