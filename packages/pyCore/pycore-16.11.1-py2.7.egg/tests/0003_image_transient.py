...
def test_create():
    ...
    image = api.image_create("test image", "image description", 1024*1024*10, image_types[0], disk_controllers[0], 'private')
...
def test_create_default_image():
    ...
    image_types = api.supported_image_types()
    disk_controllers = api.supported_disk_controllers()
    image = api.image_create("default image", "image description", 1024*1024*10, image_types[0], disk_controllers[0], 'private')
