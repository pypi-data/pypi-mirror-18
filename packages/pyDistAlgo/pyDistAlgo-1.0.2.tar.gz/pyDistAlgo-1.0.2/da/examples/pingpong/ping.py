...
class Pong(da.DistProcess):
    ...
    def setup(self, total_pings, **rest_344):
        super().setup(total_pings=total_pings, **rest_344)
...
class Ping(da.DistProcess):
    ...
    def setup(self, p, nrounds, **rest_344):
        super().setup(p=p, nrounds=nrounds, **rest_344)
        self._state.p = p
