...
from pynlple.processing.dictionary import DictionaryLookUp, DictionaryBasedTagger, FileFolderTokenMapping
from pynlple.processing.stopwords import DictionaryStopwordsFilter
from pynlple.processing.text import ClassTokenFilter


class DictionaryStopwordsFilterTest(unittest.TestCase):
