...
class GLineTranslator(Translator):
    ...
    def translate(self, file_path):
        ...
        pos_inds, pos_vals = self.__buildpositiondatasets([self.num_rows, self.num_cols])
        ...
        ds_pos_ind = MicroDataset('Position_Indices', pos_inds)
        ds_pos_ind.attrs['labels'] = pos_slices
        ds_pos_val = MicroDataset('Position_Values', pos_vals)
