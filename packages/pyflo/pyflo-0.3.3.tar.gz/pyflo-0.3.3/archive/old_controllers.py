...
from pyflo.models import write

from pyflo import build, models, system, views
...
class PipeManager(BaseManager):
    ...
    def set_entries(self, instance):
        ...
        self.view.diameter_frame.set(instance.diameter)
    ...
    def set_model(self, instance):
        ...
        instance.diameter = float(self.view.diameter_frame.entry.get())
    ...
    def show_view(self):
        ...
        values = models.Node.get_all_display_names()
        self.view.node_1_frame.options(values)
        self.view.node_2_frame.options(values)
...
class AnalysisManager(BaseManager):
    ...
    def show_view(self):
        ...
        self.view.node_frame.options(models.Node.get_all_display_names())
        self.view.intensity_polynomial_frame.options(models.IntensityPolynomial.get_all_display_names())
...
class Controller:
    ...
    def create_database(self):
        ...
        try:
            ...
            db.connect()
            db.database.create_tables([models.Node, models.Pipe, models.Basin, 
    ...
    def update_canvas(self):
        if not db.database.is_closed():
            ...
            if node_query.exists():
                ...
                results = None
                analysis_name = self.view.analysis_frame.cb.get()
                analysis_query = models.Analysis.select().where(models.Analysis.name == analysis_name)
