...
from pyflo.views.render import PipesRenderer, ResultsRenderer
from pyflo.views.widgets import PropertyFrame, CustomListBox, SelectFrame
...
class PipeView(CustomToplevel):
    ...
    def __init__(self, master):
        ...
        self.diameter_frame = PropertyFrame(self.data_frame, 'Diameter (in)')
        self.diameter_frame.pack(padx=10, pady=10, side=tk.TOP, fill=tk.X)
