...
class Installer(object):
    ...
    def install_requirements(self):
        ...
        if platform.dist()[0] in ['Ubuntu', 'LinuxMint', 'debian']:
            command = 'sudo apt-get -y install python3-dev python3-pip python3-setuptools vcftools samtools tabix zlib1g-dev libpq-dev build-essential zlib1g-dev liblocal-lib-perl cpanminus curl unzip wget'  # lamp-server^
            ...
            try:
                ...
                command = """echo "deb http://ppa.launchpad.net/webupd8team/java/ubuntu xenial main" | sudo tee /etc/apt/sources.list.d/webupd8team-java.list
