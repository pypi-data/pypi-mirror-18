...
class QSPIInitParams(object):
    ...
    """
    def __init__(self, read_mode=QSPIReadMode.FASTREAD, write_mode=QSPIWriteMode.PP, address_mode=QSPIAddressMode.BIT24, frequency=QSPIFrequency.M2):
...
class API(object):
    ...
    def qspi_init(self, retain_ram=False, init_params=None):
        ...
        class _CtypesQSPIInitParams(ctypes.Structure):
            _fields_ = [("read_mode", ctypes.c_int), ("write_mode", ctypes.c_int), ("address_mode", ctypes.c_int), ("frequency", ctypes.c_int)]
        ...
        qspi_init_params = _CtypesQSPIInitParams(init_params.read_mode, init_params.write_mode, init_params.address_mode, init_params.frequency)
