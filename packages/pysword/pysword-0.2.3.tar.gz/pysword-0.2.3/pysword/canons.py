...
# Auto-generated by canon-parser.py
...
canons = {
    ...
    u'calvin': {
        u'ot': [
            ...
            (u'Job', u'Job', u'Job',
             [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23,
              28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 38, 38, 28, 25, 17]),
            (u'Psalms', u'Ps', u'Ps',
             [6, 12, 9, 9, 13, 11, 18, 10, 21, 18, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11,
              13, 25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5, 27, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 14,
              12, 12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19,
              13, 14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10,
              10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 8,
    ...
    u'catolic': {
        u'ot': [
            ...
            (u'Psalms', u'Ps', u'Ps',
             [6, 12, 9, 9, 13, 11, 18, 10, 21, 18, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11,
              13, 25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5, 27, 18, 12, 10, 15, 21, 24, 21, 11, 7, 9, 24, 14,
              12, 12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19,
              13, 14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 9, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10,
              10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 8,
              12, 15, 21, 10, 20, 14, 9, 6]),
            (u'Proverbs', u'Prov', u'Prov',
             [33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28, 25, 35, 33, 33, 28, 24, 29, 30, 31, 29, 35, 34, 28, 28,
            ...
            (u'Isaiah', u'Isa', u'Isa',
             [31, 22, 26, 6, 30, 13, 25, 24, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29,
              24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13,
    ...
    u'darbyfr': {
        u'ot': [
            ...
            (u'Job', u'Job', u'Job',
             [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23,
              28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 38, 38, 27, 25, 17]),
            (u'Psalms', u'Ps', u'Ps',
    ...
    u'lxx': {
        u'ot': [
            ...
            (u'I Chronicles', u'1Chr', u'1Chr',
             [54, 55, 24, 43, 41, 81, 40, 40, 44, 14, 47, 41, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34,
              21, 30]),
            (u'II Chronicles', u'2Chr', u'2Chr',
             [18, 18, 17, 23, 14, 42, 22, 18, 31, 19, 23, 16, 23, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9,
              27, 36, 27, 21, 33, 25, 33, 31, 31]),
            (u'I Esdras', u'1Esd', u'1Esd', [58, 30, 24, 63, 73, 34, 15, 96, 55]),
            (u'Ezra', u'Ezra', u'Ezra', [11, 70, 13, 24, 17, 22, 28, 36, 15, 44]),
            ...
            (u'Psalms', u'Ps', u'Ps',
             [6, 13, 9, 9, 13, 11, 18, 10, 40, 8, 9, 6, 7, 6, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11, 13,
              25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 6, 27, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 14, 12,
              12, 19, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 7, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13,
              14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 36, 45, 48, 43, 14, 31, 7, 10, 10,
              9, 26, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 7, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 15, 10, 8, 12,
              15, 22, 10, 11, 20, 14, 9, 6, 7]),
            ...
            (u'Job', u'Job', u'Job',
             [22, 18, 26, 21, 27, 30, 22, 22, 35, 22, 20, 25, 28, 22, 35, 23, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23,
              28, 25, 31, 40, 22, 33, 37, 16, 34, 24, 41, 35, 32, 34, 22]),
            ...
            (u'Isaiah', u'Isa', u'Isa',
             [31, 22, 26, 6, 30, 13, 25, 23, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29,
              24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 26, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13,
              12, 21, 14, 21, 22, 11, 12, 20, 12, 25, 24]),
            (u'Jeremiah', u'Jer', u'Jer',
            ...
            (u'Ezekiel', u'Ezek', u'Ezek',
             [28, 13, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 49, 37, 31, 49, 27, 17, 21, 36,
              26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20, 27, 31, 25, 24, 23, 35]),
            (u'Prayer of Azariah', u'PrAzar', u'PrAzar', [68]),
            (u'Susanna', u'Sus', u'Sus', [64]),
            ...
            (u'I Enoch', u'1En', u'1En',
             [9, 3, 1, 1, 10, 8, 6, 4, 11, 22, 2, 6, 10, 25, 12, 4, 8, 16, 3, 8, 10, 14, 4, 6, 7, 6, 5, 3, 2, 3, 3, 6,
              4, 3, 1, 4, 6, 6, 14, 10, 9, 3, 4, 1, 6, 8, 4, 10, 4, 5, 5, 9, 7, 10, 4, 8, 3, 6, 3, 25, 13, 16, 12, 2,
              12, 3, 13, 5, 30, 4, 17, 37, 8, 17, 9, 14, 9, 17, 6, 8, 10, 20, 11, 6, 10, 6, 4, 3, 77, 43, 19, 17, 14,
              11, 7, 8, 10, 16, 16, 13, 9, 11, 15, 13, 2, 19, 3, 15]),
        ...
        u'ot': [
            ...
            (u'I Chronicles', u'1Chr', u'1Chr',
             [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34,
              21, 30]),
            (u'II Chronicles', u'2Chr', u'2Chr',
             [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 14, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9,
              27, 36, 27, 21, 33, 25, 33, 27, 23]),
            (u'Ezra', u'Ezra', u'Ezra', [11, 70, 13, 24, 17, 22, 28, 36, 15, 44]),
            (u'Nehemiah', u'Neh', u'Neh', [11, 20, 32, 23, 19, 19, 73, 18, 38, 39, 36, 47, 31]),
            (u'Esther', u'Esth', u'Esth', [22, 23, 15, 17, 14, 14, 10, 17, 32, 3]),
    ...
    u'synodal': {
        u'ot': [
            ...
            (u'Job', u'Job', u'Job',
             [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23,
              28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 35, 27, 26, 17]),
            (u'Psalms', u'Ps', u'Ps',
             [6, 12, 9, 9, 13, 11, 18, 10, 39, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11, 13,
              25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5, 27, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 14, 12,
              12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13,
              14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10,
              9, 26, 9, 10, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 7, 12,
              15, 21, 10, 11, 9, 14, 9, 6, 7]),
            (u'Proverbs', u'Prov', u'Prov',
            ...
            (u'Isaiah', u'Isa', u'Isa',
             [31, 22, 25, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29,
              24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13,
              12, 21, 14, 21, 22, 11, 12, 19, 12, 25, 24]),
            (u'Jeremiah', u'Jer', u'Jer',
             [19, 37, 25, 31, 31, 30, 34, 22, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 24,
    ...
    u'vulg': {
        u'ot': [
            ...
            (u'II Kings', u'2Kgs', u'2Kgs',
             [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30]),
            (u'I Chronicles', u'1Chr', u'1Chr',
             [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 46, 40, 14, 17, 29, 43, 27, 17, 19, 7, 30, 19, 32, 31, 31, 32, 34,
              21, 30]),
            (u'II Chronicles', u'2Chr', u'2Chr',
             [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9,
              27, 36, 27, 21, 33, 25, 33, 27, 23]),
            ...
            (u'Esther', u'Esth', u'Esth', [22, 23, 15, 17, 14, 14, 10, 17, 32, 13, 12, 6, 18, 19, 19, 24]),
            (u'Job', u'Job', u'Job',
             [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 23, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23,
              28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 35, 28, 25, 16]),
            (u'Psalms', u'Ps', u'Ps',
             [6, 13, 9, 10, 13, 11, 18, 10, 39, 8, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11, 13,
              25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 6, 26, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 13, 12,
              12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13,
              14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10,
              9, 26, 9, 10, 2, 29, 176, 7, 8, 9, 4, 8, 5, 7, 5, 6, 8, 8, 3, 18, 3, 3, 21, 27, 9, 8, 24, 14, 10, 8, 12,
              15, 21, 10, 11, 9, 14, 9, 6]),
            (u'Proverbs', u'Prov', u'Prov',
             [33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28, 25, 35, 33, 33, 28, 24, 29, 30, 31, 29, 35, 34, 28, 28,
              27, 28, 27, 33, 31]),
            ...
            (u'Baruch', u'Bar', u'Bar', [22, 35, 38, 37, 9, 72]),
            (u'Ezekiel', u'Ezek', u'Ezek',
             [28, 9, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 49, 32, 31, 49, 27, 17, 21, 36,
              26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20, 27, 31, 25, 24, 23, 35]),
