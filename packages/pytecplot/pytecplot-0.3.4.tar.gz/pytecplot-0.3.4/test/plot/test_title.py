...
class _TestAxisTitle(object):
    ...
    def test_font(self):
        self.assertIsInstance(self.title.font, Font)
...
class _TestDataAxisTitle(_TestAxisTitle):
    def test_text(self):
        ...
        self.assertEqual(self.title.text, None)
        self.title.text = AxisTitleMode.UseVarName
        self.assertEqual(self.title.text, AxisTitleMode.UseVarName)
