...
class TestClient(testtools.TestCase):
    ...
    def test_connection_timeout(self):
        ...
        comm_err = self.assertRaises(gaiaclient.exc.InvalidEndpoint,
                                     self.client.get,
                                     '/v1/images')
    ...
    def test_connection_refused(self):
        ...
        comm_err = self.assertRaises(gaiaclient.exc.CommunicationError,
                                     self.client.get,
    ...
    @original_only
    @mock.patch('gaiaclient.common.http.LOG.debug')
