...
class TestHTTPSVerifyCert(testtools.TestCase):
    ...
    def test_requests_cert_verification(self, __):
    ...
    @mock.patch('sys.stderr')
    def test_requests_cert_verification_no_compression(self, __):
        """v1 regression test for bug 115260."""
    ...
    @mock.patch('sys.stderr')
    def test_requests_valid_cert_verification(self, __):
    ...
    @mock.patch('sys.stderr')
    def test_requests_valid_cert_verification_no_compression(self, __):
    ...
    @mock.patch('sys.stderr')
    def test_requests_valid_cert_no_key(self, __):
        """Test VerifiedHTTPSConnection: absence of SSL key file."""
        port = self.port
        url = 'https://0.0.0.0:%d' % port
        cert_file = os.path.join(TEST_VAR_DIR, 'certificate.crt')
    ...
    @mock.patch('sys.stderr')
    def test_requests_bad_cert(self, __):
        """Test VerifiedHTTPSConnection: absence of SSL key file."""
        port = self.port
        url = 'https://0.0.0.0:%d' % port
    ...
    @mock.patch('sys.stderr')
    def test_requests_bad_ca(self, __):
        """Test VerifiedHTTPSConnection: absence of SSL key file."""
        port = self.port
        url = 'https://0.0.0.0:%d' % port
