...
class NetworkShellTest(utils.TestCase):

    def setUp(self):
        super(NetworkShellTest, self).setUp()
    ...
    def test_shell_list_network(self):
        self.run_command('net-list')
        self.assert_called('GET', '/v1/networks/')

    def test_shell_list_subnet(self):
        self.run_command('subnet-list')
