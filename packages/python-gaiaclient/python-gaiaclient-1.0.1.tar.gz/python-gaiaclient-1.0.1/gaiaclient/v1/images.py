...
class ImageManager(base.ManagerWithDcId):
    ...
    def get(self, image, **kwargs):
        ...
        return self._get('/v1/images/%s'
                               % urlparse.quote(str(image_id)), 'image')
    ...
    def list(self, **kwargs):
        ...
        url = '/v1/images/?%s' % urlparse.urlencode(params)
        images = self._list(url, "images")

        if return_request_id is not None:
            return_request_id.append(images.request_ids)
    ...
    def create(self, **kwargs):
        ...
        if copy_from is not None:
            hdrs['x-gaia-api-copy-from'] = copy_from
