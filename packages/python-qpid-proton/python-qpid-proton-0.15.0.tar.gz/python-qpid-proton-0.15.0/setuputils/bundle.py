...
_tar = "%s.tar.gz" % bundled_version_str
libqpid_proton_url = "https://github.com/apache/qpid-proton/archive/%s" % _tar
...
def fetch_libqpid_proton(savedir):
    ...
    if os.path.exists(dest):
        ...
        return
    fname = fetch_archive(savedir, libqpid_proton_url, _tar)
