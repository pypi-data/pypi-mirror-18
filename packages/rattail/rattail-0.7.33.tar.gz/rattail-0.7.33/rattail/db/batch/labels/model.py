...
from rattail.db.model import Base, LabelProfile
from rattail.db.batch.model import BatchMixin, ProductBatchRowMixin
...
class LabelBatchRow(ProductBatchRowMixin, Base):
    ...
    STATUS = {
        ...
        STATUS_PRODUCT_APPEARS_INACTIVE : "product appears active",
    }
