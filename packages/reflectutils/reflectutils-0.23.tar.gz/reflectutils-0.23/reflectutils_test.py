...
class TypeutilsTest(unittest.TestCase):
	...
	def test_isboundmethod(self):
		...
		self.assertTrue(reflectutils.isboundmethod(os.confstr_names.items))
		self.assertFalse(reflectutils.isboundmethod(dict.update))
		self.assertFalse(reflectutils.isboundmethod(Color.rgb))
		self.assertTrue(reflectutils.isboundmethod(Color().rgb))
		self.assertFalse(reflectutils.isboundmethod(unittest.TestCase.assertEqual))

	def test_getboundinstance(self):
		x = "hello"
		self.assertEqual(reflectutils.getboundinstance(x.format), x)