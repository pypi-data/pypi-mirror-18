...
sys.path.append('interpret')
import lr, hmm, mlp, gru, gruhmm
from rnn_tree import train_decision_tree

from nn_util import (reverse_sigmoid, init_hmm_ffbs_weights,
                     init_hmm_out_weights, init_vanilla_gru_weights)
from common_util import (safe_log, flatten_to_2d, wrapper_func, map_3d_to_2d)
from scores import get_accuracy, get_mean_squared_error
...
def train_hmm_sgd(
    ...
    outputs, loglike_fun, num_weights = hmm.build(
        obs_count, hmm_state_count, out_count)
