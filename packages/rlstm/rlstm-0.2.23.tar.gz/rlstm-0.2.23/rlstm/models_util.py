...
import sys
sys.path.append('/Users/mikewu/Desktop/Research/interpretable-models/rlstm/')
from optimize import adam
from rlstm import create_toy_data

import sys
sys.path.append('/Users/mikewu/Desktop/Research/interpretable-models/rlstm/models/')
...
def train_by_sgd(
    ...
    weights = adam(grad_fun,
                   ...
                   va_ll_fun=lambda x: regularized_loss(x, va_obs_set, va_fence_set, va_out_set) if va_obs_set is not None else None,
                   va_err_fun=lambda x: error_func(va_out_set, np.exp(logpred_fun(x, batch_obs_set, batch_fence_set))) if va_obs_set is not None else None,
