...
class RLSTMNode(object):
    ...
    def default_params(self):
        ...
        params['l1_lambda'] = 0
        params['l2_lambda'] = 0
        params['obs_only'] = False

        if self.type in ['hmm', 'gru-hmm']:
            params['emission_type'] = 'bernoulli'
        ...
        if self.type in ['gru-hmm-tree']:
            params['mlp_min_epoch'] = 1
            params['mlp_max_epoch'] = 1000
    ...
    def eval(self, tr_x, tr_fcpt, tr_y, te_x, te_fcpt, te_y):
        ...
        # loglikelihoods
        if self.type in ['lr', 'hmm-sgd', 'gru-hmm']:
