...
def train_decision_tree(func, model_weights, input_set, fence_set):
    ...
    '''
    output_set = func(model_weights, input_set, fence_set)
    tree = _train_decision_tree_from_inputs(input_set, output_set)
    return tree


def _train_decision_tree_from_inputs(input_set, output_set):
    tree = DecisionTreeClassifier()

    input_set = np_safe_to_int(input_set)
    output_set = np_safe_to_int(output_set)

    tree.fit(input_set.T, output_set.T)
    return tree
