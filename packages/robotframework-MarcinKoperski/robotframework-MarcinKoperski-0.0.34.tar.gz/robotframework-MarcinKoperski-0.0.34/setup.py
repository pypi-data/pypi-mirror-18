...
setup(
    ...
    install_requires=[
        'robotframework>=3.0',
        'robotframework-databaselibrary', 'robotframework-imaplibrary', 'robotframework-pabot',
        'robotframework-ride>=1.5.2.1',
        'robotframework-selenium2library', u'robotframework-testmanagement',  # u'robotframework-sshlibrary>=2.1.1','robotframework-archivelibrary'
