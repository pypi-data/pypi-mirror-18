...
the `Marvin Software <https://zenodo.org/record/167359>`__ (BibTeX). We
...
.. |PyPI download| image:: https://img.shields.io/pypi/dm/sdss-marvin.svg
   :target: https://pypi.python.org/pypi/sdss-marvin
.. |DOI| image:: https://zenodo.org/badge/DOI/10.5281/zenodo.167359.svg
   :target: https://doi.org/10.5281/zenodo.167359
