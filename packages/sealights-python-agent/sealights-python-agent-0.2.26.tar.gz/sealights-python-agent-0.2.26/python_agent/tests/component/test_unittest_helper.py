...
if sys.version_info >= (2, 7):
    unittest_helper = "unittest_helper"
    from python_agent.tests.component.data.unittest_helper import SanityTestCase, PassSkipTestCase, AllSkipTestCase, \
        PassErrorTestCase
else:
    from python_agent.tests.component.data.unittest_26_helper import SanityTestCase, PassErrorTestCase
    unittest_helper = "unittest_26_helper"
...
class OrchestratorTestCase(unittest.TestCase):
    ...
    @patch("python_agent.packages.requests.get", spec=True)
    @patch("python_agent.packages.requests.post", spec=True)
    @pytest.mark.skipif(PYTHON_26, reason="requires python 2.7")
    ...
    def test_unittest_vs_unittest2(self, mock_post, mock_get, mock_response, mock_upgrade, mock_get_distribution,
        ...
        unittest_helper_module = __import__("python_agent.test_listener.integrations.%s" % unittest_helper,
