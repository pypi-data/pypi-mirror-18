...
@click.option("--env", default=config.DEFAULT_ENV, help="The environment used for the current build")
...
@click.pass_context
def cli(ctx, customer_id, app_name, server, build, branch, labid, env, proxy, source, include, omit):
