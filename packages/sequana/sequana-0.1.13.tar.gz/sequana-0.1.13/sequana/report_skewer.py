...
class SkewerReport(AdapterRemovalReport):

    def __init__(self, output_filename="skewer.html",
        ...
        """
        super(SkewerReport, self).__init__(
            output_filename=output_filename,
            directory=directory, **kargs)
        self.jinja['title'] = "Skewer Report Summary"
    ...
    def get_histogram_data(self):
        """In skewer logs, an adapter section contains 
