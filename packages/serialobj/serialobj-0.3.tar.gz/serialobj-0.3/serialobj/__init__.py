...
class _SerialObjectMeta(type):
    ...
    def __new__(mcs, name, bases, attrs):
        ...
        for base in bases:
            if isinstance(base, _SerialObjectMeta):
        ...
        if six.PY2:
            sup = super(_SerialObjectMeta, mcs)
        else:
            sup = super()
        return sup.__new__(mcs, name, bases, attrs)


@six.add_metaclass(_SerialObjectMeta)
