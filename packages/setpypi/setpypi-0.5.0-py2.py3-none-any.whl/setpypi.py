...
class SetPyPi(object):
    ...
    def save_pipconf(self, server_alias='pypi'):
    ...
    def handle_args(self, args=None, **defaults):
        ...
        self.set(options.repository, options.username, options.password,
                 options.server, options.write_pypirc, options.write_pipconf)


    def set(self, repository, username=None, password=None, server_alias='pypi',
            write_pypirc=False, write_pipconf=False):
        ...
        if server_alias:
            ...
            if write_pipconf:
                self.save_pipconf(server_alias)
