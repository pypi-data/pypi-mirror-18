...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages/cysignals/pxi.h", 
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages/cysignals/struct_signals.h"
        ], 
        "extra_link_args": [
            "-lpari"
        ], 
        "include_dirs": [
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages/cysignals", 
            "/Users/slabbe/Applications/sage-git/local/include", 
            "/Users/slabbe/Applications/sage-git/local/include/python2.7", 
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages/numpy/core/include", 
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages", 
            "/Users/slabbe/Applications/sage-git/local/lib/python2.7/site-packages/sage/ext"
        ]
    }, 
...
static const char __pyx_k_Users_slabbe_GitBox_slabbe_slab[] = "/Users/slabbe/GitBox/slabbe/slabbe/diophantine_approx_pyx.pyx";
...
static PyObject *__pyx_kp_s_Users_slabbe_GitBox_slabbe_slab;
...
/* "slabbe/diophantine_approx_pyx.pyx":45
...
static PyObject *__pyx_pw_6slabbe_22diophantine_approx_pyx_1good_simultaneous_convergents_upto(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("good_simultaneous_convergents_upto (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Q)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("good_simultaneous_convergents_upto", 0, 2, 4, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "good_simultaneous_convergents_upto") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_v = values[0];
    __pyx_v_Q = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_Q == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    if (values[2]) {
    ...
    if (values[3]) {
      __pyx_v_step = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_step == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    } else {
      __pyx_v_step = ((int)1);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("good_simultaneous_convergents_upto", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_6slabbe_22diophantine_approx_pyx_good_simultaneous_convergents_upto(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_v, double __pyx_v_Q, int __pyx_v_start, int __pyx_v_step) {
  ...
  /* "slabbe/diophantine_approx_pyx.pyx":136
 * 
 *     """
 *     if not Q > 1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "slabbe/diophantine_approx_pyx.pyx":137
 *     """
 *     if not Q > 1:
 *         raise ValueError("argument Q(={}) must be > 1".format(Q))             # <<<<<<<<<<<<<<
 *     cdef int d = len(v)
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_argument_Q_must_be_1, __pyx_n_s_format); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 137, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyFloat_FromDouble(__pyx_v_Q); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 137, __pyx_L1_error)
    ...
    __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 137, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  __pyx_t_7 = PyObject_Length(__pyx_v_v); if (unlikely(__pyx_t_7 == -1)) __PYX_ERR(0, 138, __pyx_L1_error)
  __pyx_v_d = __pyx_t_7;
 ...
 */
  ...
  /* "slabbe/diophantine_approx_pyx.pyx":143
 *     cdef double a
 *     cdef list L
 ...
 *     cdef long q
 */
  __pyx_t_8 = __pyx_f_9cysignals_6memory_check_allocarray(__pyx_v_d, (sizeof(double))); if (unlikely(__pyx_t_8 == NULL && PyErr_Occurred())) __PYX_ERR(0, 143, __pyx_L1_error)
  __pyx_v_vdouble = ((double *)__pyx_t_8);

  /* "slabbe/diophantine_approx_pyx.pyx":146
 *     cdef int i
 *     cdef long q
 ...
 *         vdouble[i] = v[i]
 */
  __pyx_t_2 = __Pyx_PyInt_FromDouble(floor(pow(__pyx_v_Q, ((double)__pyx_v_d)))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 146, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_AddObjC(__pyx_t_2, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 146, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_9 = __Pyx_PyInt_As_long(__pyx_t_3); if (unlikely((__pyx_t_9 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 146, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_stop = __pyx_t_9;

  /* "slabbe/diophantine_approx_pyx.pyx":147
 *     cdef long q
 *     cdef long stop = int(floor(Q**d)) + 1
 *     for i in range(d):             # <<<<<<<<<<<<<<
 *         vdouble[i] = v[i]
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_v, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 148, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_12 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 148, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    (__pyx_v_vdouble[__pyx_v_i]) = __pyx_t_12;
  }

  /* "slabbe/diophantine_approx_pyx.pyx":152
 *     # because of the use of step, the range is not translated into a C for-loop
 ...
 */
  ...
  /* "slabbe/diophantine_approx_pyx.pyx":153
 *     # http://stackoverflow.com/questions/21382180/cython-pure-c-loop-optimization
 *     L = []
 *     for q from start <= q < stop by step:             # <<<<<<<<<<<<<<
 *         sig_check() # Check for Keyboard interupt
 ...
 *             a = q*vdouble[i]
 */
    __pyx_t_11 = sig_check(); if (unlikely(__pyx_t_11 == 0)) __PYX_ERR(0, 154, __pyx_L1_error)
 ...
 *         else:
 */
      __pyx_t_14 = ((__pyx_v_a <= __pyx_v_Qinv) != 0);
      if (!__pyx_t_14) {
      } else {
        __pyx_t_1 = __pyx_t_14;
        goto __pyx_L11_bool_binop_done;
      }
      __pyx_t_14 = ((__pyx_v_un_moins_Qinv <= __pyx_v_a) != 0);
      __pyx_t_1 = __pyx_t_14;
 ...
 *     return L
 */
      __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_q); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 161, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_15 = __Pyx_PyList_Append(__pyx_v_L, __pyx_t_3); if (unlikely(__pyx_t_15 == -1)) __PYX_ERR(0, 161, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    }
    __pyx_L9_break:;
  }

  /* "slabbe/diophantine_approx_pyx.pyx":162
 *         else:
 *             L.append(q)
 *     sig_free(vdouble)             # <<<<<<<<<<<<<<
 *     return L
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_slabbe_GitBox_slabbe_slab, __pyx_k_Users_slabbe_GitBox_slabbe_slab, sizeof(__pyx_k_Users_slabbe_GitBox_slabbe_slab), 0, 0, 1, 0},
 ...
 *     Return a list of potential best simultaneous diophantine approximation of
 */
  __pyx_tuple_ = PyTuple_Pack(13, __pyx_n_s_v, __pyx_n_s_Q, __pyx_n_s_start, __pyx_n_s_step, __pyx_n_s_d, __pyx_n_s_Qinv, __pyx_n_s_un_moins_Qinv, __pyx_n_s_a, __pyx_n_s_L, __pyx_n_s_vdouble, __pyx_n_s_i, __pyx_n_s_q, __pyx_n_s_stop); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(4, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_slabbe_GitBox_slabbe_slab, __pyx_n_s_good_simultaneous_convergents_up, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initdiophantine_approx_pyx(void); /*proto*/
PyMODINIT_FUNC initdiophantine_approx_pyx(void)
#else
PyMODINIT_FUNC PyInit_diophantine_approx_pyx(void); /*proto*/
PyMODINIT_FUNC PyInit_diophantine_approx_pyx(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_diophantine_approx_pyx(void)", 0);
  ...
  /* "../../Applications/sage-git/local/lib/python2.7/site-packages/cysignals/signals.pxi":24
 ...
 */
  __pyx_t_2 = import_cysignals__signals(); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(2, 24, __pyx_L1_error)

  /* "../../Applications/sage-git/local/lib/python2.7/site-packages/cysignals/signals.pxi":19
 ...
 *     Return a list of potential best simultaneous diophantine approximation of
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_6slabbe_22diophantine_approx_pyx_1good_simultaneous_convergents_upto, NULL, __pyx_n_s_slabbe_diophantine_approx_pyx); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_good_simultaneous_convergents_up, __pyx_t_3) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
