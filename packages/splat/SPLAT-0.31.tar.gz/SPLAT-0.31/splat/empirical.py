...
from .splat import classifyByIndex
...
#Convert spectral type string to number
    if isinstance(spt,str):
        spt = sputil.typeToNum(spt, uncertainty=unc)
    else:
...
# convert spectral type string to number
    if (type(inp) == str):
        spt = sputil.typeToNum(inp,uncertainty=unc)
    else:
