...
class RNAShapesException(Exception):
    def __init__(self):
        Exception.__init__(self,"Something went wrong with executing RNAshapes.") 
...
def calculate_rna_shapes_from_file(output, fastaFileName):
    ...
    try:
        ...
        print>>sys.stderr, 'ERROR: Could not calculate RNAshapes. Is RNAshapes installed? The following command failed: \'RNAshapes -r -o 1 -f ' + fastaFileName
        raise RNAShapesException
