...
setup(
    name='tapioca-rocketchat',
    version=get_version(package),
    description='Rocket.Chat API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/eliostvs/tapioca-rocketchat',
    packages=[
        'tapioca_rocketchat',
    ],
    package_dir={'tapioca_rocketchat': 'tapioca_rocketchat'},
