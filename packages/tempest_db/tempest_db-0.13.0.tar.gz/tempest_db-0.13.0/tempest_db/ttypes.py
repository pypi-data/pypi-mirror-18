...
class MonteCarloPageRankParams:
  ...
  thrift_spec = (
    ...
    (6, TType.BOOL, 'alternatingWalk', None, True, ), # 6
  )

  def __init__(self, numSteps=None, resetProbability=None, maxIntermediateNodeDegree=thrift_spec[3][4], minReportedVisits=None, maxResultCount=None, alternatingWalk=thrift_spec[6][4],):
    ...
    self.alternatingWalk = alternatingWalk
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.alternatingWalk = iprot.readBool()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.maxResultCount is not None:
      ...
      oprot.writeFieldEnd()
    if self.alternatingWalk is not None:
      oprot.writeFieldBegin('alternatingWalk', TType.BOOL, 6)
      oprot.writeBool(self.alternatingWalk)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.alternatingWalk)
    return value
