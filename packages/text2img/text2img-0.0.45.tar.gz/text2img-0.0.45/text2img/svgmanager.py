...
#  'inkscape':'http://www.inkscape.org/namespaces/inkscape'}
  ...
  def setImg (self, id, image, mode=None):
    ...
    if os.path.isfile(absimg):
      ...
      eImage.set('{http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd}width', newWidth)
      eImage.set('{http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd}height', newHeight)
