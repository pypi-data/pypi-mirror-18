...
class TerraformRunException(TerraformLockBaseException):
    """
    An exception occured when trying to run a Terraform command
    """

    fmt = 'Terraform subprocess returned an error.'
