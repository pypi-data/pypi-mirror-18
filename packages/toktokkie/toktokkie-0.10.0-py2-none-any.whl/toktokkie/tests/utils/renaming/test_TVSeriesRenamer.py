...
class TVSeriesRenamerUnitTests(unittest.TestCase):
    ...
    def setUp(self):
        shutil.copytree(u"toktokkie/tests/resources/directories", u"temp_testing")
    ...
    def test_constructors(self):
        ...
        non_rec_show = TVSeriesRenamer(os.path.join(u"temp_testing", u"Game of Thrones"), PlexTvdbScheme)
        rec_root = TVSeriesRenamer(u"temp_testing", PlexTvdbScheme, recursive=True)
        rec_show = TVSeriesRenamer(os.path.join(u"temp_testing", u"Game of Thrones"), PlexTvdbScheme, recursive=True)
    ...
    def test_renaming(self):
        expected_results = {u"Season 1": [u"Game of Thrones - S01E01 - Winter Is Coming",
        ...
        game_of_thrones = TVSeriesRenamer(os.path.join(u"temp_testing", u"Game of Thrones"), PlexTvdbScheme)
        ...
        for result in expected_results:
            for episode in expected_results[result]:
                self.assertTrue(os.path.isfile(os.path.join(
                    u"temp_testing", u"Game of Thrones", result, episode) + u".mkv"))

    def test_confirmationless_renaming(self):
        expected_results = {u"Season 1": [u"The Big Bang Theory - S01E01 - Pilot",
                                         u"The Big Bang Theory - S01E14 - The Nerdvana Annihilation"],
                            u"Season 2": [u"The Big Bang Theory - S02E05 - The Euclid Alternative",
                                         u"The Big Bang Theory - S02E13 - The Friendship Algorithm"],
                            u"Season 3": [u"The Big Bang Theory - S03E07 - The Guitarist Amplification",
                                         u"The Big Bang Theory - S03E10 - The Gorilla Experiment"],
                            u"Season 4": [u"The Big Bang Theory - S04E01 - The Robotic Manipulation",
                                         u"The Big Bang Theory - S04E06 - The Irish Pub Formulation"],
                            u"Season 5": [u"The Big Bang Theory - S05E08 - The Isolation Permutation",
                                         u"The Big Bang Theory - S05E13 - The Recombination Hypothesis"]}

        big_bang = TVSeriesRenamer(os.path.join(u"temp_testing", u"The Big Bang Theory"), PlexTvdbScheme)
        ...
        for result in expected_results:
            for episode in expected_results[result]:
                self.assertTrue(os.path.isfile(os.path.join(
                    u"temp_testing", u"The Big Bang Theory", result, episode) + u".mkv"))

    def test_recursive_renamer_renaming(self):
        expected_game_of_thrones_results = {u"Season 1": [u"Game of Thrones - S01E01 - Winter Is Coming",
                                                         u"Game of Thrones - S01E02 - The Kingsroad",
                                                         u"Game of Thrones - S01E05 - The Wolf and the Lion",
                                                         u"Game of Thrones - S01E10 - Fire and Blood",
                                                         u"Game of Thrones - S01E11 - Episode 11"],
                                            ...
                                            u"Specials": [u"Game of Thrones - S00E01 - Inside Game of Thrones",
                                                         u"Game of Thrones - S00E02 - 15-Minute Preview"]}
        expected_big_bang_theory_results = {u"Season 1": [u"The Big Bang Theory - S01E01 - Pilot",
                                                         u"The Big Bang Theory - S01E14 - The Nerdvana Annihilation"],
                                            u"Season 2": [u"The Big Bang Theory - S02E05 - The Euclid Alternative",
                                                         u"The Big Bang Theory - S02E13 - The Friendship Algorithm"],
                                            u"Season 3": [u"The Big Bang Theory - S03E07 - The Guitarist Amplification",
        ...
        recursive_root = TVSeriesRenamer(u"temp_testing", PlexTvdbScheme, recursive=True)
