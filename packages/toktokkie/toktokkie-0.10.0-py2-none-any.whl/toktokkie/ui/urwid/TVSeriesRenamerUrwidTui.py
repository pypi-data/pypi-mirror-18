...
class TVSeriesRenamerUrwidTui(object):
    ...
    def __init__(self):
        ...
        for scheme in SchemeManager.get_scheme_names() + [u"Test"]:
            urwid.RadioButton(group=self.renaming_schemes, label=scheme)

        self.dir_entry_text = urwid.Text(u"Directory:")
    ...
    def lay_out(self):
        ...
        self.confirm_button = urwid.AttrMap(self.confirm_button, None, focus_map=u'reversed')
        self.start_search_button = urwid.AttrMap(self.start_search_button, None, focus_map=u'reversed')

        dir_entry_formatted = urwid.AttrMap(self.dir_entry, None, focus_map=u'reversed')
