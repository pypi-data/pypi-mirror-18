...
class TVSeriesRenamer(object):
    ...
    def __init__(self, directory, naming_scheme, recursive = False):
        u"""
        ...
        if recursive:
            directories = MetaDataManager.find_recursive_media_directories(directory, media_type=u"tv_series")
        elif MetaDataManager.is_media_directory(directory, media_type=u"tv_series"):
    ...
    def __add_directory_contents__(self, directories):
        u"""
        ...
        for directory in directories:
            ...
            for season in seasons:
                ...
                if season == u".meta" or not os.path.isdir(season_path):
                    continue
    ...
    def __add_season_to_episodes__(self, season_directory, season_number, show_name):
        u"""
    ...
    def __add_specials_to_episodes__(self, list_of_special_directories, show_name):
        u"""
