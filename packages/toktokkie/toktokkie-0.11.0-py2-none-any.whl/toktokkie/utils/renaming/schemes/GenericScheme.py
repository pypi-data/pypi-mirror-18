...
class GenericScheme(object):
    ...
    @staticmethod
    def get_tvdb_episode_name(series_name, season_number, episode_number):
        u"""
        ...
        except (tvdb_episodenotfound, tvdb_seasonnotfound, tvdb_shownotfound, ConnectionError, KeyError), e:
