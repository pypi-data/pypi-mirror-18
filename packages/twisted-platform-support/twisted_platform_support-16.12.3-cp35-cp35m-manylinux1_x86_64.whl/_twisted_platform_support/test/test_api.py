...
class NoAPITestCase(TestCase):
    ...
    def test_sendmsg(self):
        ...
        """
        from _twisted_platform_support import sendmsg
        sendmsg
    ...
    def test_raiser(self):
        ...
        """
        from _twisted_platform_support import raiser
        raiser
    ...
    def test_portmap(self):
        ...
        Sendmsg can be imported.
        """
        from _twisted_platform_support import portmap
        portmap
    ...
    def test_iocp(self):
        ...
        """
        from _twisted_platform_support import iocp
        iocp
