...
"""This filter will modify entities in the tweet with according html structure"""
...
class TwitterWall(object):
    """Class that will create all connection to twitter regarding to hashtag and print him"""
    ...
    """This method will generate session needing api key and api secret to the twitter api"""
    ...
    def getMeSession(self, api_key, api_secret):
        ...
        """This function will get tweet from the API"""

    def get_tweet(self, session, hashtag, count, rt, since_id):
        q = session.get('https://api.twitter.com/1.1/search/tweets.json',
                        params={'q': hashtag, 'count': count, 'since_id': since_id})
        return q.json()['statuses']

        """This method will print the content of the tweet to the console"""
