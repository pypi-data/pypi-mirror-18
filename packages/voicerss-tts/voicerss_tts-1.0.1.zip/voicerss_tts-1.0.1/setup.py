...
setup(
    ...
    url=u'https://bitbucket.org/daycoder/voicerss_tts.git',  # Use the url to the git repo
    download_url=u'https://bitbucket.org/daycoder/'
                 u'voicerss_tts/get/{version}.tar'.format(version=VERSION),
    ...
    description=u"Access the http://www.voicerss.org/api/ Text to Voice API.",
