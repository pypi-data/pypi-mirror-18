...
`Documentation(HTML) <https://docs.namibsun.net/html_docs/xdcc-downloader/index.html>`__

`Documentation(PDF) <https://docs.namibsun.net/pdf_docs/xdcc-downloader.pdf>`__

`Python Package Index Site <https://pypi.python.org/pypi/xdcc_dl>`__

`Git Statistics
(gitstats) <https://gitstats.namibsun.net/gitstats/xdcc-downloader/index.html>`__

`Git Statistics
(git\_stats) <https://gitstats.namibsun.net/git_stats/xdcc-downloader/index.html>`__
