...
def create_event_printer(event, formatting, show_tag = False):
    ...
    if show_tag:
        method_definition += u"    self.logger.log(\"on_" + event + u"\", LOG.EVENT)\n"
...
class IrcEventPrinter(BaseIrclient):
    ...
    for event in [u"welcome", u"yourhost", u"created", u"myinfo", u"featurelist", u"luserclient", u"luserop",
                  u"luserunknown", u"luserchannels", u"luserme", u"n_local", u"n_global", u"modstart"]:
    ...
    def on_privmsg(self, connection, event):
        ...
        :return:           None
        """
        self.logger.log(event.source + u": " + event.arguments[0], LOG.PRIVATE_MESSAGE)
    ...
    def on_pubnotice(self, connection, event):
        ...
        :return:           None
        """
        self.logger.log(event.source + u": " + event.arguments[0], LOG.PUBLIC_NOTICE)
    ...
    def on_pubmsg(self, connection, event):
        ...
        :return:           None
        """
        self.logger.log(event.source + u": " + event.arguments[0], LOG.PUBLIC_MESSAGE)
