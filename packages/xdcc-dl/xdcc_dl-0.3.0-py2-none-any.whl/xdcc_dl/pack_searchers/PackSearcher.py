...
class PackSearcher(object):
    ...
    procedure_map = {u"nibl": find_nibl_packs,
                     u"ixirc": find_ixirc_packs,
                     u"intel_haruhichan": find_intel_haruhichan_packs}

    @staticmethod
    def get_available_pack_searchers():
        u"""
    ...
    def __init__(self, procedures = list(procedure_map.keys())):
        u"""
