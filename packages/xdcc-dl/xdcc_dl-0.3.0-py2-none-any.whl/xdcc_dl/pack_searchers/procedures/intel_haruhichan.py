...
def find_intel_haruhichan_packs(search_phrase):
    u"""
    ...
    url = u"http://intel.haruhichan.com/?s=" + prepared_search_term
    ...
    for i, line in enumerate(packs):
        ...
        if i % 5 == 0:
            ...
            result = XDCCPack(IrcServer(u"irc.rizon.net"), bot, packnumber)
