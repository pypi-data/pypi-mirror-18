...
class UnitTests(unittest.TestCase):
        ...
        class Tester(BotFinder):
            ...
            def on_join(self, conn, event):
                if event.source.startswith(self.user.get_name()):
                    self.joined_correct_channel = event.target.lower() == u"#bots"
    ...
    def test_invalid_whois_query(self):
        ...
        class Tester(BotFinder):
            ...
            def on_welcome(self, conn, event):
                self.current_pack = XDCCPack(IrcServer(u"irc.namibsun.net"), u"notexistingbot", 1)
    ...
    def test_stray_whois(self):
        ...
        class Tester(BotFinder):
            ...
            def on_welcome(self, conn, event):
                self.current_pack = XDCCPack(IrcServer(u"irc.namibsun.net"), u"xdcc_servbot", 1)
                self.connection.whois(u"notexistingbot")
    ...
    def test_channel_less_whois_query(self):
        ...
        class Tester(BotFinder):
            ...
            def on_welcome(self, conn, event):
                self.connection.whois(u"channelless_bot")
