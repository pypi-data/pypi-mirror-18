...
class UnitTests(unittest.TestCase):
    ...
    def test_getters(self):
        ...
        self.assertEqual(self.pack.get_server().get_address(), u"irc.namibsun.net")
    ...
    def test_setting_filename(self):
        ...
        self.assertEqual(self.pack.get_filepath(), os.path.join(os.getcwdu(), u"test"))
        ...
        self.assertEqual(self.pack.get_filepath(), os.path.join(os.getcwdu(), u"something"))

        self.pack.set_filename(u"something_else.txt")
        self.assertEqual(self.pack.get_filename(), u"something.txt")
        self.assertEqual(self.pack.get_filepath(), os.path.join(os.getcwdu(), u"something.txt"))
        ...
        self.assertEqual(self.pack.get_filepath(), os.path.join(os.getcwdu(), u"something.txt.mkv"))

        self.pack.set_directory(os.path.join(os.getcwdu(), u"test"))
        self.assertEqual(self.pack.get_filename(), u"something.txt.mkv")
        self.assertEqual(self.pack.get_filepath(), os.path.join(os.getcwdu(), u"test", u"something.txt.mkv"))
    ...
    def test_request_message(self):
        self.assertEqual(self.pack.get_request_message(), u"xdcc send #1")
        self.assertEqual(self.pack.get_request_message(full=True), u"/msg xdcc_servbot xdcc send #1")

    def test_generating_from_xdcc_message_single(self):

        packs = xdcc_packs_from_xdcc_message(u"/msg xdcc_servbot xdcc send #1", u"testdir", u"irc.namibsun.net")
        ...
        self.assertTrue(pack.get_request_message() in u"/msg xdcc_servbot xdcc send #1")

    def test_generating_from_xdcc_message_range(self):

        packs = xdcc_packs_from_xdcc_message(u"/msg xdcc_servbot xdcc send #1-100")
    ...
    def test_generating_from_xdcc_message_range_with_jumps(self):
        ...
        packs = xdcc_packs_from_xdcc_message(u"/msg xdcc_servbot xdcc send #1-100,2")
