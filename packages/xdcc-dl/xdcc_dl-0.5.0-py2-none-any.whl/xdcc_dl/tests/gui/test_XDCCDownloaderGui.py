...
class UnitTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if QApplication is None or sys.version_info[0] < 3:
            raise unittest.SkipTest(u"Skipping on python 2 or import error")
    ...
    def test_default_values(self):
        self.assertEqual(os.getcwdu(), self.form.destination_edit.text())
        self.assertEqual(u"irc.rizon.net", self.form.server_edit.text())

    def test_searching(self):
        self.form.search_term_edit.setText(u"1_test.txt")
        self.assertEqual(self.form.search_term_edit.text(), u"1_test.txt")
        self.form.search_engine_combo_box.setCurrentText(u"namibsun")
        self.assertEqual(self.form.search_engine_combo_box.currentText(), u"namibsun")
        ...
        self.assertEqual(self.form.search_results[0].get_bot(), u"xdcc_servbot")
    ...
    def test_removing_pack_from_queue(self):
        self.form.download_queue = [XDCCPack(IrcServer(u"irc.namibsun.net"), u"xdcc_servbot", 1)]
    ...
    def test_adding_manual_pack(self):
        self.form.message_edit.setText(u"/msg xdcc_servbot xdcc send #1")
        self.form.server_edit.setText(u"irc.namibsun.net")
        self.assertEqual(self.form.message_edit.text(), u"/msg xdcc_servbot xdcc send #1")
        self.assertEqual(self.form.server_edit.text(), u"irc.namibsun.net")
    ...
    def test_download_packs(self):
        ...
        self.assertEqual(self.form.destination_edit.text(), os.getcwdu())
        ...
        self.form.show_download_complete_message_signal.emit(u"")
    ...
    def test_download_while_downloading(self):
        ...
        self.form.download_queue = [XDCCPack(IrcServer(u"irc.namibsun.net"), u"xdcc_servbot", 2)]
        self.form.refresh_download_queue()
        QTest.mouseClick(self.form.download_button, Qt.LeftButton)
    ...
    def test_search_while_searching(self):
        ...
        self.assertEqual(self.form.search_engine_combo_box.currentText(), u"All")

        QTest.mouseClick(self.form.search_button, Qt.LeftButton)

        self.form.search_term_edit.setText(u"2_test.txt")
        self.assertEqual(self.form.search_term_edit.text(), u"2_test.txt")
        self.form.search_engine_combo_box.setCurrentText(u"namibsun")
        self.assertEqual(self.form.search_engine_combo_box.currentText(), u"namibsun")
    ...
    def test_spinner(self):
        ...
        self.form.spinner_start_signal.emit(u"download")
        self.form.searching = True
        self.form.spinner_start_signal.emit(u"search")
        time.sleep(1)
        self.form.downloading = False
        self.form.searching = False
        time.sleep(1)
    ...
    def test_spin_update(self):
        self.assertEqual(self.form.download_button.text(), u"Download")
        self.form.spinner_updater_signal.emit(self.form.download_button, u"NotDownload")
        self.assertEqual(self.form.download_button.text(), u"NotDownload")

    def test_invalid_download_directory(self):
        self.form.destination_edit.setText(u"")
        QTest.mouseClick(self.form.download_button, Qt.LeftButton)
