...
class UnitTests(unittest.TestCase):
    ...
    def test_empty_query(self):
        packs = find_horriblesubs_packs(u"")
        self.assertEqual(len(packs), 0)

    def test_gin_txt(self):
        packs = find_horriblesubs_packs(u"Gin.txt")
    ...
    def test_larger_result(self):
        packs = find_horriblesubs_packs(u"One Punch Man")
        self.assertLess(10, len(packs))

    def test_non_result_query(self):
        self.assertEqual(0, len(find_horriblesubs_packs(u"sdgyfdhkdashsahdqhdsadlsajdhsaohdsausahoashdsahdlahdsah")))