...
目前版本是 0.0.28，没更新的快更新一下，更新说明在[这里][changelog]。

上次更新简要说明：修复 Collection 的 answer 属性不可用的问题，增加了 contents 和 articles 属性。
上上次更新简要说明：修复 Python 3.4 和 2.7.x 及之前版本因为 dict unpacking 之后不能有 trailing comma 造成的语法错误。
