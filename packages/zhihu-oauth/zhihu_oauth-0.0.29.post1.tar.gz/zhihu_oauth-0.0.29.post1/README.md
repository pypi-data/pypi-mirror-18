...
目前版本是 0.0.29.post1，没更新的快更新一下，更新说明在[这里][changelog]。

上次更新简要说明：修复/增加了用户动态中的「参加 Live」，「创建分享」，「点赞分享」三种动作，暂时使用 `StreamingJSON` 做个兼容

上上次更新简要说明：增加了 `Question.created_time` 属性。
...
通过 支付宝 捐款：
 - 网址：`https://shenghuo.alipay.com/send/payment/fill.htm`
 - 账户：`7seconddream(AT)gmail.com`
