...
# source: zsearch_definitions/hoststore.proto
...
_RECORD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alexa_rank', full_name='zsearch.Record.alexa_rank', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='public_location', full_name='zsearch.Record.public_location', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='zsearch.Record.version', index=17,
...
_PROTOCOLATOM.fields_by_name['metadata'].message_type = zsearch__definitions_dot_common__pb2._METADATUM
_RECORD.fields_by_name['atom'].message_type = _PROTOCOLATOM
_RECORD.fields_by_name['private_location'].message_type = _LOCATIONATOM
_RECORD.fields_by_name['as_atom'].message_type = zsearch__definitions_dot_common__pb2._ASATOM
_RECORD.fields_by_name['whois'].message_type = _WHOISATOM
_RECORD.fields_by_name['userdata'].message_type = zsearch__definitions_dot_common__pb2._USERDATAATOM
...
_DELTA.fields_by_name['delta_type'].enum_type = zsearch__definitions_dot_common__pb2._DELTATYPE
...
WHOISAtom = _reflection.GeneratedProtocolMessageType('WHOISAtom', (_message.Message,), dict(
  ...
  __module__ = 'zsearch_definitions.hoststore_pb2'
